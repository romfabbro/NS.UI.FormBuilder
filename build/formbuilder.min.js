...
if (function(global) {
    ...
    function mixin(t, e, i, n) {
        return e && eachProp(e, function(e, s) {
            (i || !hasProp(t, s)) && (!n || "object" != typeof e || !e || isArray(e) || isFunction(e) || e instanceof RegExp ? t[s] = e : (t[s] || (t[s] = {}), 
            mixin(t[s], e, i, n)));
        }), t;
    }
    function bind(t, e) {
    ...
    function makeError(t, e, i, n) {
        ...
        return s.requireType = t, s.requireModules = n, i && (s.originalError = i), s;
    }
    function newContext(t) {
        function e(t) {
            var e, i;
            for (e = 0; e < t.length; e++) if (i = t[e], "." === i) t.splice(e, 1), e -= 1; else if (".." === i) {
                if (0 === e || 1 == e && ".." === t[2] || ".." === t[e - 1]) continue;
                e > 0 && (t.splice(e - 1, 2), e -= 2);
            }
        }
        function i(t, i, n) {
            var s, r, o, a, l, u, c, h, d, p, f, m, g = i && i.split("/"), v = k.map, b = v && v["*"];
            if (t && (t = t.split("/"), c = t.length - 1, k.nodeIdCompat && jsSuffixRegExp.test(t[c]) && (t[c] = t[c].replace(jsSuffixRegExp, "")), 
            "." === t[0].charAt(0) && g && (m = g.slice(0, g.length - 1), t = m.concat(t)), 
            e(t), t = t.join("/")), n && v && (g || b)) {
                o = t.split("/");
                t: for (a = o.length; a > 0; a -= 1) {
                    if (u = o.slice(0, a).join("/"), g) for (l = g.length; l > 0; l -= 1) if (r = getOwn(v, g.slice(0, l).join("/")), 
                    r && (r = getOwn(r, u))) {
                        h = r, d = a;
                        break t;
                    }
                    !p && b && getOwn(b, u) && (p = getOwn(b, u), f = a);
                }
                !h && p && (h = p, d = f), h && (o.splice(0, d, h), t = o.join("/"));
            }
            return s = getOwn(k.pkgs, t), s ? s : t;
        }
        function n(t) {
        ...
        function s(t) {
            ...
            return e && isArray(e) && e.length > 1 ? (e.shift(), _.require.undef(t), _.makeRequire(null, {
                skipMap: !0
            })([ t ]), !0) : void 0;
        }
        function r(t) {
        ...
        function o(t, e, n, s) {
            var o, a, l, u, c = null, h = e ? e.name : null, d = t, p = !0, f = "";
            return t || (p = !1, t = "_@r" + (P += 1)), u = r(t), c = u[0], t = u[1], c && (c = i(c, h, s), 
            a = getOwn(D, c)), t && (c ? f = a && a.normalize ? a.normalize(t, function(t) {
                return i(t, h, s);
            }) : -1 === t.indexOf("!") ? i(t, h, s) : t : (f = i(t, h, s), u = r(f), c = u[0], 
            f = u[1], n = !0, o = _.nameToUrl(f))), l = !c || a || n ? "" : "_unnormalized" + (A += 1), 
            {
                prefix: c,
                name: f,
                parentMap: e,
        ...
        function a(t) {
            var e = t.id, i = getOwn(C, e);
            return i || (i = C[e] = new _.Module(t)), i;
        }
        function l(t, e, i) {
            var n = t.id, s = getOwn(C, n);
            !hasProp(D, n) || s && !s.defineEmitComplete ? (s = a(t), s.error && "error" === e ? i(s.error) : s.on(e, i)) : "defined" === e && i(D[n]);
        }
        function u(t, e) {
        ...
        function c() {
            globalDefQueue.length && (apsp.apply(N, [ N.length, 0 ].concat(globalDefQueue)), 
            globalDefQueue = []);
        }
        function h(t) {
        ...
        function d(t, e, i) {
            var n = t.map.id;
            t.error ? t.emit("error", t.error) : (e[n] = !0, each(t.depMaps, function(n, s) {
                var r = n.id, o = getOwn(C, r);
                !o || t.depMatched[s] || i[r] || (getOwn(e, r) ? (t.defineDep(s, D[r]), t.check()) : d(o, e, i));
            }), i[n] = !0);
        }
        function p() {
            var t, e, i = 1e3 * k.waitSeconds, r = i && _.startTime + i < new Date().getTime(), o = [], a = [], l = !1, c = !0;
            if (!b) {
                if (b = !0, eachProp(T, function(t) {
                    var i = t.map, u = i.id;
                    if (t.enabled && (i.isDefine || a.push(t), !t.error)) if (!t.inited && r) s(u) ? (e = !0, 
                    l = !0) : (o.push(u), n(u)); else if (!t.inited && t.fetched && i.isDefine && (l = !0, 
                    !i.prefix)) return c = !1;
                }), r && o.length) return t = makeError("timeout", "Load timeout for modules: " + o, null, o), 
                t.contextName = _.contextName, u(t);
                c && each(a, function(t) {
                    d(t, {}, {});
        ...
        function f(t) {
            hasProp(D, t[0]) || a(o(t[0], null, !0)).init(t[1], t[2]);
        }
        function m(t, e, i, n) {
        ...
        function v() {
            var t;
            for (c(); N.length; ) {
                if (t = N.shift(), null === t[0]) return u(makeError("mismatch", "Mismatched anonymous define() module: " + t[t.length - 1]));
                f(t);
            }
        }
        var b, y, _, w, x, k = {
            ...
            shim: {},
            config: {}
        }, C = {}, T = {}, S = {}, N = [], D = {}, E = {}, M = {}, P = 1, A = 1;
        return w = {
            require: function(t) {
                return t.require ? t.require : t.require = _.makeRequire(t.map);
            },
            exports: function(t) {
                return t.usingExports = !0, t.map.isDefine ? t.exports ? D[t.map.id] = t.exports : t.exports = D[t.map.id] = {} : void 0;
            },
            module: function(t) {
            ...
            this.events = getOwn(S, t.id) || {}, this.map = t, this.shim = getOwn(k.shim, t.id), 
            ...
            init: function(t, e, i, n) {
                n = n || {}, this.inited || (this.factory = e, i ? this.on("error", i) : this.events.error && (i = bind(this, function(t) {
                    this.emit("error", t);
                })), this.depMaps = t && t.slice(0), this.errback = i, this.inited = !0, this.ignore = n.ignore, 
            ...
            load: function() {
                var t = this.map.url;
                E[t] || (E[t] = !0, _.load(this.map.id, t));
            },
            check: function() {
                if (this.enabled && !this.enabling) {
                    var t, e, i = this.map.id, n = this.depExports, s = this.exports, r = this.factory;
                    if (this.inited) {
                            ...
                            if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                if (isFunction(r)) {
                                    if (this.events.error && this.map.isDefine || req.onError !== defaultOnError) try {
                                        ...
                                        t = o;
                                    } else s = _.execCb(i, r, n, s);
                                    if (this.map.isDefine && void 0 === s && (e = this.module, e ? s = e.exports : this.usingExports && (s = this.exports)), 
                                    t) return t.requireMap = this.map, t.requireModules = this.map.isDefine ? [ this.map.id ] : null, 
                                    t.requireType = this.map.isDefine ? "define" : "require", u(this.error = t);
                                } else s = r;
                                this.exports = s, this.map.isDefine && !this.ignore && (D[i] = s, req.onResourceLoad && req.onResourceLoad(_, this.map, this.depMaps)), 
                                h(i), this.defined = !0;
                            }
            ...
            callPlugin: function() {
                var t = this.map, e = t.id, n = o(t.prefix);
                this.depMaps.push(n), l(n, "defined", bind(this, function(n) {
                    var s, r, c, d = getOwn(M, this.map.id), p = this.map.name, f = this.map.parentMap ? this.map.parentMap.name : null, m = _.makeRequire(t.parentMap, {
                        enableBuildCallback: !0
                    });
                    return this.map.unnormalized ? (n.normalize && (p = n.normalize(p, function(t) {
                        return i(t, f, !0);
                    }) || ""), r = o(t.prefix + "!" + p, this.map.parentMap), l(r, "defined", bind(this, function(t) {
                        this.init([], function() {
                            return t;
                        }, null, {
                            enabled: !0,
                    ...
                    })), c = getOwn(C, r.id), void (c && (this.depMaps.push(r), this.events.error && c.on("error", bind(this, function(t) {
                        this.emit("error", t);
                    })), c.enable()))) : d ? (this.map.url = _.nameToUrl(d), void this.load()) : (s = bind(this, function(t) {
                        this.init([], function() {
                            return t;
                        }, null, {
                            enabled: !0
                        });
                    }), s.error = bind(this, function(t) {
                        this.inited = !0, this.error = t, t.requireModules = [ e ], eachProp(C, function(t) {
                            0 === t.map.id.indexOf(e + "_unnormalized") && h(t.map.id);
                        }), u(t);
                    }), s.fromText = bind(this, function(i, n) {
                        var r = t.name, l = o(r), c = useInteractive;
                        n && (i = n), c && (useInteractive = !1), a(l), hasProp(k.config, e) && (k.config[r] = k.config[e]);
                        try {
                            req.exec(i);
                        } catch (h) {
                            return u(makeError("fromtexteval", "fromText eval for " + e + " failed: " + h, h, [ e ]));
                        }
                        c && (useInteractive = !0), this.depMaps.push(l), _.completeLoad(r), m([ r ], s);
                    }), void n.load(t.name, m, s, k));
            ...
            enable: function() {
                T[this.map.id] = this, this.enabled = !0, this.enabling = !0, each(this.depMaps, bind(this, function(t, e) {
                    ...
                    if ("string" == typeof t) {
                        ...
                        this.depMaps[e] = t, s = getOwn(w, t.id)) return void (this.depExports[e] = s(this));
                    ...
                    i = t.id, n = C[i], hasProp(w, i) || !n || n.enabled || _.enable(t, this);
            ...
            configure: function(t) {
                ...
                eachProp(t, function(t, e) {
                    i[e] ? (k[e] || (k[e] = {}), mixin(k[e], t, !0, !0)) : k[e] = t;
                    ...
                    e[i] = t;
                }), k.shim = e), t.packages && each(t.packages, function(t) {
                    var e, i;
                    t = "string" == typeof t ? {
                        name: t
                    } : t, i = t.name, e = t.location, e && (k.paths[i] = t.location), k.pkgs[i] = t.name + "/" + (t.main || "main").replace(currDirRegExp, "").replace(jsSuffixRegExp, "");
            ...
            makeRequire: function(e, s) {
                function r(i, n, l) {
                    ...
                    "string" == typeof i ? isFunction(n) ? u(makeError("requireargs", "Invalid require call"), l) : e && hasProp(w, i) ? w[i](C[e.id]) : req.get ? req.get(_, i, e, r) : (h = o(i, e, !1, !0), 
                    c = h.id, hasProp(D, c) ? D[c] : u(makeError("notloaded", 'Module name "' + c + '" has not been loaded yet for context: ' + t + (e ? "" : ". Use require([])")))) : (v(), 
                    _.nextTick(function() {
                        v(), d = a(o(null, e)), d.skipMap = s.skipMap, d.init(i, n, l, {
                            enabled: !0
                        }), p();
                    }), r);
                }
                return s = s || {}, mixin(r, {
                    isBrowser: isBrowser,
                    toUrl: function(t) {
                        var n, s = t.lastIndexOf("."), r = t.split("/")[0], o = "." === r || ".." === r;
                        return -1 !== s && (!o || s > 1) && (n = t.substring(s, t.length), t = t.substring(0, s)), 
                        _.nameToUrl(i(t, e && e.id, !0), n, !0);
                    },
                    defined: function(t) {
                        return hasProp(D, o(t, e, !1, !0).id);
                    },
                    specified: function(t) {
                        return t = o(t, e, !1, !0).id, hasProp(D, t) || hasProp(C, t);
                    }
                }), e || (r.undef = function(t) {
                    c();
                    var i = o(t, e, !0), s = getOwn(C, t);
                    n(t), delete D[t], delete E[i.url], delete S[t], eachReverse(N, function(e, i) {
                        e[0] === t && N.splice(i, 1);
                    }), s && (s.events.defined && (S[t] = s.events), h(t));
                }), r;
            },
            enable: function(t) {
                var e = getOwn(C, t.id);
            ...
            completeLoad: function(t) {
                var e, i, n, r = getOwn(k.shim, t) || {}, o = r.exports;
                for (c(); N.length; ) {
                ...
                if (n = getOwn(C, t), !e && !hasProp(D, t) && n && !n.inited) {
                    if (!(!k.enforceDefine || o && getGlobal(o))) return s(t) ? void 0 : u(makeError("nodefine", "No define call for " + t, null, [ t ]));
                    f([ t, r.deps || [], r.exportsFn ]);
                }
                p();
            },
            nameToUrl: function(t, e, i) {
                var n, s, r, o, a, l, u, c = getOwn(k.pkgs, t);
                if (c && (t = c), u = getOwn(M, t)) return _.nameToUrl(u, e, i);
                if (req.jsExtRegExp.test(t)) a = t + (e || ""); else {
                    for (n = k.paths, s = t.split("/"), r = s.length; r > 0; r -= 1) if (o = s.slice(0, r).join("/"), 
                    l = getOwn(n, o)) {
                        isArray(l) && (l = l[0]), s.splice(0, r, l);
                        break;
                    }
                    a = s.join("/"), a += e || (/^data\:|\?/.test(a) || i ? "" : ".js"), a = ("/" === a.charAt(0) || a.match(/^[\w\+\.\-]+:/) ? "" : k.baseUrl) + a;
                }
            ...
            onScriptError: function(t) {
                var e = g(t);
                return s(e.id) ? void 0 : u(makeError("scripterror", "Script error for: " + e.id, t, [ e.id ]));
            }
    ...
    if ("undefined" == typeof define) {
        ...
        req = requirejs = function(t, e, i, n) {
            ...
            return isArray(t) || "string" == typeof t || (r = t, isArray(e) ? (t = e, e = i, 
            i = n) : t = []), r && r.context && (o = r.context), s = getOwn(contexts, o), s || (s = contexts[o] = req.s.newContext(o)), 
            r && s.configure(r), s.require(t, e, i);
        ...
        req.createNode = function(t) {
            var e = t.xhtml ? document.createElementNS("http://www.w3.org/1999/xhtml", "html:script") : document.createElement("script");
            return e.type = t.scriptType || "text/javascript", e.charset = "utf-8", e.async = !0, 
            e;
        }, req.load = function(t, e, i) {
            var n, s = t && t.config || {};
            if (isBrowser) return n = req.createNode(s, e, i), n.setAttribute("data-requirecontext", t.contextName), 
            n.setAttribute("data-requiremodule", e), !n.attachEvent || n.attachEvent.toString && n.attachEvent.toString().indexOf("[native code") < 0 || isOpera ? (n.addEventListener("load", t.onScriptLoad, !1), 
            n.addEventListener("error", t.onScriptError, !1)) : (useInteractive = !0, n.attachEvent("onreadystatechange", t.onScriptLoad)), 
            n.src = i, currentlyAddingScript = n, baseElement ? head.insertBefore(n, baseElement) : head.appendChild(n), 
            ...
            return head || (head = t.parentNode), dataMain = t.getAttribute("data-main"), dataMain ? (mainScript = dataMain, 
            ...
            var n, s;
            "string" != typeof t && (i = e, e = t, t = null), isArray(e) || (i = e, e = null), 
            !e && isFunction(i) && (e = [], i.length && (i.toString().replace(commentRegExp, "").replace(cjsRequireRegExp, function(t, i) {
                e.push(i);
            }), e = (1 === i.length ? [ "require" ] : [ "require", "exports", "module" ]).concat(e))), 
            useInteractive && (n = currentlyAddingScript || getInteractiveScript(), n && (t || (t = n.getAttribute("data-requiremodule")), 
            s = contexts[n.getAttribute("data-requirecontext")])), (s ? s.defQueue : globalDefQueue).push([ t, e, i ]);
        }, define.amd = {
            jQuery: !0
...
}(this), define("requirejs", function() {}), function() {
    var t = this, e = t._, i = Array.prototype, n = Object.prototype, s = Function.prototype, r = i.push, o = i.slice, a = i.concat, l = n.toString, u = n.hasOwnProperty, c = Array.isArray, h = Object.keys, d = s.bind, p = function(t) {
    ...
    exports._ = p) : t._ = p, p.VERSION = "1.7.0";
    ...
    p.iteratee = function(t, e, i) {
        ...
        if (null == t) return [];
        e = p.iteratee(e, i);
        for (var n, s = t.length !== +t.length && p.keys(t), r = (s || t).length, o = Array(r), a = 0; r > a; a++) n = s ? s[a] : a, 
        o[a] = e(t[n], n, t);
        return o;
    };
    ...
    p.reduce = p.foldl = p.inject = function(t, e, i, n) {
        null == t && (t = []), e = f(e, n, 4);
        var s, r = t.length !== +t.length && p.keys(t), o = (r || t).length, a = 0;
        if (arguments.length < 3) {
            if (!o) throw new TypeError(m);
            i = t[r ? r[a++] : a++];
        }
        for (;o > a; a++) s = r ? r[a] : a, i = e(i, t[s], s, t);
        return i;
    }, p.reduceRight = p.foldr = function(t, e, i, n) {
        null == t && (t = []), e = f(e, n, 4);
        var s, r = t.length !== +t.length && p.keys(t), o = (r || t).length;
        if (arguments.length < 3) {
            if (!o) throw new TypeError(m);
            i = t[r ? r[--o] : --o];
        }
        for (;o--; ) s = r ? r[o] : o, i = e(i, t[s], s, t);
        return i;
        ...
        if (null == t) return !0;
        e = p.iteratee(e, i);
        var n, s, r = t.length !== +t.length && p.keys(t), o = (r || t).length;
        for (n = 0; o > n; n++) if (s = r ? r[n] : n, !e(t[s], s, t)) return !1;
        return !0;
    }, p.some = p.any = function(t, e, i) {
        if (null == t) return !1;
        e = p.iteratee(e, i);
        var n, s, r = t.length !== +t.length && p.keys(t), o = (r || t).length;
        for (n = 0; o > n; n++) if (s = r ? r[n] : n, e(t[s], s, t)) return !0;
        return !1;
    }, p.contains = p.include = function(t, e) {
        return null == t ? !1 : (t.length !== +t.length && (t = p.values(t)), p.indexOf(t, e) >= 0);
    }, p.invoke = function(t, e) {
        var i = o.call(arguments, 2), n = p.isFunction(e);
        ...
        for (var e, i = t && t.length === +t.length ? t : p.values(t), n = i.length, s = Array(n), r = 0; n > r; r++) e = p.random(0, r), 
        e !== r && (s[r] = s[e]), s[e] = i[r];
        return s;
    ...
    p.groupBy = g(function(t, e, i) {
        ...
        i = p.iteratee(i, n, 1);
        for (var s = i(e), r = 0, o = t.length; o > r; ) {
            var a = r + o >>> 1;
            i(t[a]) < s ? r = a + 1 : o = a;
        }
        return r;
        ...
        return null == t ? void 0 : null == e || i ? t[0] : 0 > e ? [] : o.call(t, 0, e);
    }, p.initial = function(t, e, i) {
        return o.call(t, 0, Math.max(0, t.length - (null == e || i ? 1 : e)));
    }, p.last = function(t, e, i) {
        return null == t ? void 0 : null == e || i ? t[t.length - 1] : o.call(t, Math.max(t.length - e, 0));
    }, p.rest = p.tail = p.drop = function(t, e, i) {
        return o.call(t, null == e || i ? 1 : e);
    ...
    p.flatten = function(t, e) {
        ...
        for (var s = [], r = [], o = 0, a = t.length; a > o; o++) {
            var l = t[o];
            if (e) o && r === l || s.push(l), r = l; else if (i) {
                var u = i(l, o, t);
                p.indexOf(r, u) < 0 && (r.push(u), s.push(l));
        ...
        for (var e = [], i = arguments.length, n = 0, s = t.length; s > n; n++) {
            var r = t[n];
            if (!p.contains(e, r)) {
                for (var o = 1; i > o && p.contains(arguments[o], r); o++) ;
                o === i && e.push(r);
            }
        }
        return e;
        ...
        for (var n = Math.max(Math.ceil((e - t) / i), 0), s = Array(n), r = 0; n > r; r++, 
        t += i) s[r] = t;
        return s;
    };
    var b = function() {};
    p.bind = function(t, e) {
        var i, n;
        if (d && t.bind === d) return d.apply(t, o.call(arguments, 1));
        ...
        return i = o.call(arguments, 2), n = function() {
            ...
            var s = new b();
            b.prototype = null;
            var r = t.apply(s, i.concat(o.call(arguments)));
        ...
        var i = function(n) {
            var s = i.cache, r = e ? e.apply(this, arguments) : n;
        ...
        i || (i = {});
        var l = function() {
            a = i.leading === !1 ? 0 : p.now(), o = null, r = t.apply(n, s), o || (n = s = null);
        };
        return function() {
            var u = p.now();
            a || i.leading !== !1 || (a = u);
            var c = e - (u - a);
            return n = this, s = arguments, 0 >= c || c > e ? (clearTimeout(o), o = null, a = u, 
            r = t.apply(n, s), o || (n = s = null)) : o || i.trailing === !1 || (o = setTimeout(l, c)), 
            r;
        };
    }, p.debounce = function(t, e, i) {
        var n, s, r, o, a, l = function() {
            var u = p.now() - o;
            e > u && u > 0 ? n = setTimeout(l, e - u) : (n = null, i || (a = t.apply(r, s), 
            n || (r = s = null)));
        };
        return function() {
            r = this, s = arguments, o = p.now();
            var u = i && !n;
        ...
        if (p.isFunction(e)) {
            ...
            t = new Object(t);
            for (var u = 0, c = l.length; c > u; u++) n = l[u], n in t && (s[n] = t[n]);
        }
        return s;
    }, p.omit = function(t, e, i) {
        if (p.isFunction(e)) e = p.negate(e); else {
            var n = p.map(a.apply([], o.call(arguments, 1)), String);
            e = function(t, e) {
    ...
    var y = function(t, e, i, n) {
        ...
        if (o !== a && "constructor" in t && "constructor" in e && !(p.isFunction(o) && o instanceof o && p.isFunction(a) && a instanceof a)) return !1;
        i.push(t), n.push(e);
        var u, c;
        if ("[object Array]" === s) {
            if (u = t.length, c = u === e.length) for (;u-- && (c = y(t[u], e[u], i, n)); ) ;
        } else {
            var h, d = p.keys(t);
            if (u = d.length, c = p.keys(e).length === u) for (;u-- && (h = d[u], c = p.has(e, h) && y(t[h], e[h], i, n)); ) ;
        }
    ...
    p.escape = x(_), p.unescape = x(w), p.result = function(t, e) {
    ...
    p.template = function(t, e, i) {
        ...
        var n = RegExp([ (e.escape || C).source, (e.interpolate || C).source, (e.evaluate || C).source ].join("|") + "|$", "g"), s = 0, r = "__p+='";
        t.replace(n, function(e, i, n, o, a) {
            return r += t.slice(s, a).replace(S, N), s = a + e.length, i ? r += "'+\n((__t=(" + i + "))==null?'':_.escape(__t))+\n'" : n ? r += "'+\n((__t=(" + n + "))==null?'':__t)+\n'" : o && (r += "';\n" + o + "\n__p+='"), 
            e;
    ...
    p.mixin = function(t) {
        p.each(p.functions(t), function(e) {
            ...
            p.prototype[e] = function() {
                var t = [ this._wrapped ];
                return r.apply(t, arguments), D.call(this, i.apply(p, t));
            };
        });
    ...
    function o() {
        fe.addEventListener ? (fe.removeEventListener("DOMContentLoaded", a, !1), t.removeEventListener("load", a, !1)) : (fe.detachEvent("onreadystatechange", a), 
    ...
    function c(t, e, i, n) {
        if (se.acceptData(t)) {
            var s, r, o = se.expando, a = t.nodeType, l = a ? se.cache : t, u = a ? t[o] : t[o] && o;
            if (u && l[u] && (n || l[u].data) || void 0 !== i || "string" != typeof e) return u || (u = a ? t[o] = Y.pop() || se.guid++ : o), 
            l[u] || (l[u] = a ? {} : {
                toJSON: se.noop
            }), ("object" == typeof e || "function" == typeof e) && (n ? l[u] = se.extend(l[u], e) : l[u].data = se.extend(l[u].data, e)), 
            r = l[u], n || (r.data || (r.data = {}), r = r.data), void 0 !== i && (r[se.camelCase(e)] = i), 
            "string" == typeof e ? (s = r[e], null == s && (s = r[se.camelCase(e)])) : s = r, 
            s;
        }
    }
    function h(t, e, i) {
        if (se.acceptData(t)) {
            var n, s, r = t.nodeType, o = r ? se.cache : t, a = r ? t[se.expando] : se.expando;
            if (o[a]) {
                if (e && (n = i ? o[a] : o[a].data)) {
                    se.isArray(e) ? e = e.concat(se.map(e, se.camelCase)) : e in n ? e = [ e ] : (e = se.camelCase(e), 
                    e = e in n ? [ e ] : e.split(" ")), s = e.length;
                    for (;s--; ) delete n[e[s]];
                    if (i ? !u(n) : !se.isEmptyObject(n)) return;
                }
                (i || (delete o[a].data, u(o[a]))) && (r ? se.cleanData([ t ], !0) : ie.deleteExpando || o != o.window ? delete o[a] : o[a] = null);
            }
        }
    }
    function d() {
    ...
    function g(t, e) {
        var i, n, s = 0, r = typeof t.getElementsByTagName !== ke ? t.getElementsByTagName(e || "*") : typeof t.querySelectorAll !== ke ? t.querySelectorAll(e || "*") : void 0;
        if (!r) for (r = [], i = t.childNodes || t; null != (n = i[s]); s++) !e || se.nodeName(n, e) ? r.push(n) : se.merge(r, g(n, e));
    ...
    function x(t, e) {
        if (1 === e.nodeType && se.hasData(t)) {
            var i, n, s, r = se._data(t), o = se._data(e, r), a = r.events;
            if (a) {
    ...
    function k(t, e) {
        ...
        if (1 === e.nodeType) {
            ...
            ie.html5Clone && t.innerHTML && !se.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === i && Me.test(t.type) ? (e.defaultChecked = e.checked = t.checked, 
    ...
    function C(e, i) {
        var n, s = se(i.createElement(e)).appendTo(i.body), r = t.getDefaultComputedStyle && (n = t.getDefaultComputedStyle(s[0])) ? n.display : se.css(s[0], "display");
        return s.detach(), r;
    }
    function T(t) {
        var e = fe, i = Ze[t];
        return i || (i = C(t, e), "none" !== i && i || (Qe = (Qe || se("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), 
        e = (Qe[0].contentWindow || Qe[0].contentDocument).document, e.write(), e.close(), 
        i = C(t, e), Qe.detach()), Ze[t] = i), i;
    }
    function S(t, e) {
        return {
            get: function() {
    ...
    function N(t, e) {
        if (e in t) return e;
        for (var i = e.charAt(0).toUpperCase() + e.slice(1), n = e, s = di.length; s--; ) if (e = di[s] + i, 
        e in t) return e;
        return n;
    }
    function D(t, e) {
        for (var i, n, s, r = [], o = 0, a = t.length; a > o; o++) n = t[o], n.style && (r[o] = se._data(n, "olddisplay"), 
        i = n.style.display, e ? (r[o] || "none" !== i || (n.style.display = ""), "" === n.style.display && De(n) && (r[o] = se._data(n, "olddisplay", T(n.nodeName)))) : (s = De(n), 
        (i && "none" !== i || !s) && se._data(n, "olddisplay", s ? i : se.css(n, "display"))));
    ...
    function M(t, e, i, n, s) {
        for (var r = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, o = 0; 4 > r; r += 2) "margin" === i && (o += se.css(t, i + Ne[r], !0, s)), 
        n ? ("content" === i && (o -= se.css(t, "padding" + Ne[r], !0, s)), "margin" !== i && (o -= se.css(t, "border" + Ne[r] + "Width", !0, s))) : (o += se.css(t, "padding" + Ne[r], !0, s), 
        "padding" !== i && (o += se.css(t, "border" + Ne[r] + "Width", !0, s)));
        return o;
    }
    function P(t, e, i) {
        var n = !0, s = "width" === e ? t.offsetWidth : t.offsetHeight, r = ti(t), o = ie.boxSizing && "border-box" === se.css(t, "boxSizing", !1, r);
        if (0 >= s || null == s) {
    ...
    function O(t, e) {
        ...
        for (e = e ? 1 : 0; 4 > s; s += 2 - e) i = Ne[s], n["margin" + i] = n["padding" + i] = t;
        return e && (n.opacity = n.width = t), n;
    }
    function F(t, e, i) {
        for (var n, s = (yi[e] || []).concat(yi["*"]), r = 0, o = s.length; o > r; r++) if (n = s[r].call(i, e, t)) return n;
    }
    function L(t, e, i) {
        var n, s, r, o, a, l, u, c, h = this, d = {}, p = t.style, f = t.nodeType && De(t), m = se._data(t, "fxshow");
        i.queue || (a = se._queueHooks(t, "fx"), null == a.unqueued && (a.unqueued = 0, 
        ...
        u = se.css(t, "display"), c = "none" === u ? se._data(t, "olddisplay") || T(t.nodeName) : u, 
        "inline" === c && "none" === se.css(t, "float") && (ie.inlineBlockNeedsLayout && "inline" !== T(t.nodeName) ? p.zoom = 1 : p.display = "inline-block")), 
        ...
        if (se.isEmptyObject(d)) "inline" === ("none" === u ? T(t.nodeName) : u) && (p.display = u); else {
            m ? "hidden" in m && (f = m.hidden) : m = se._data(t, "fxshow", {}), r && (m.hidden = !f), 
            f ? se(t).show() : h.done(function() {
                se(t).hide();
            }), h.done(function() {
                var e;
            ...
            for (n in d) o = F(f ? m[n] : 0, n, h), n in m || (m[n] = o.start, f && (o.end = o.start, 
            o.start = "width" === n || "height" === n ? 1 : 0));
        }
    }
    function H(t, e) {
        var i, n, s, r, o;
        for (i in t) if (n = se.camelCase(i), s = e[n], r = t[i], se.isArray(r) && (s = r[1], 
        r = t[i] = r[0]), i !== n && (t[n] = r, delete t[i]), o = se.cssHooks[n], o && "expand" in o) {
            r = o.expand(r), delete t[n];
            for (i in r) i in t || (t[i] = r[i], e[i] = s);
        } else e[n] = s;
    }
    function $(t, e, i) {
        var n, s, r = 0, o = bi.length, a = se.Deferred().always(function() {
            delete l.elem;
        }), l = function() {
            if (s) return !1;
            for (var e = pi || I(), i = Math.max(0, u.startTime + u.duration - e), n = i / u.duration || 0, r = 1 - n, o = 0, l = u.tweens.length; l > o; o++) u.tweens[o].run(r);
            return a.notifyWith(t, [ u, r, i ]), 1 > r && l ? i : (a.resolveWith(t, [ u ]), 
            !1);
        }, u = a.promise({
            elem: t,
            props: se.extend({}, e),
            ...
            createTween: function(e, i) {
                var n = se.Tween(t, u.opts, e, i, u.opts.specialEasing[e] || u.opts.easing);
        ...
        for (H(c, u.opts.specialEasing); o > r; r++) if (n = bi[r].call(u, t, c, u.opts)) return n;
        return se.map(c, F, u), se.isFunction(u.opts.start) && u.opts.start.call(t, u), 
    ...
    function z(t) {
        return function(e, i) {
            ...
            var n, s = 0, r = e.toLowerCase().match(ye) || [];
            if (se.isFunction(i)) for (;n = r[s++]; ) "+" === n.charAt(0) ? (n = n.slice(1) || "*", 
    ...
    function W(t, e, i) {
        for (var n, s, r, o, a = t.contents, l = t.dataTypes; "*" === l[0]; ) l.shift(), 
    ...
    function q(t, e, i, n) {
        var s, r, o, a, l, u = {}, c = t.dataTypes.slice();
        if (c[1]) for (o in t.converters) u[o.toLowerCase()] = t.converters[o];
        for (r = c.shift(); r; ) if (t.responseFields[r] && (i[t.responseFields[r]] = e), 
        !l && n && t.dataFilter && (e = t.dataFilter(e, t.dataType)), l = r, r = c.shift()) if ("*" === r) r = l; else if ("*" !== l && l !== r) {
            if (o = u[l + " " + r] || u["* " + r], !o) for (s in u) if (a = s.split(" "), a[1] === r && (o = u[l + " " + a[0]] || u["* " + a[0]])) {
    ...
    function B(t, e, i, n) {
        ...
        }); else if (i || "object" !== se.type(e)) n(t, e); else for (s in e) B(t + "[" + s + "]", e[s], i, n);
    }
    function V() {
        try {
    ...
    var Y = [], K = Y.slice, J = Y.concat, G = Y.push, Q = Y.indexOf, Z = {}, te = Z.toString, ee = Z.hasOwnProperty, ie = {}, ne = "1.11.1", se = function(t, e) {
        return new se.fn.init(t, e);
    }, re = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, oe = /^-ms-/, ae = /-([\da-z])/gi, le = function(t, e) {
    ...
    se.fn = se.prototype = {
        ...
        var t, e, i, n, s, r, o = arguments[0] || {}, a = 1, l = arguments.length, u = !1;
        for ("boolean" == typeof o && (u = o, o = arguments[a] || {}, a++), "object" == typeof o || se.isFunction(o) || (o = {}), 
        a === l && (o = this, a--); l > a; a++) if (null != (s = arguments[a])) for (n in s) t = o[n], 
        i = s[n], o !== i && (u && i && (se.isPlainObject(i) || (e = se.isArray(i))) ? (e ? (e = !1, 
        r = t && se.isArray(t) ? t : []) : r = t && se.isPlainObject(t) ? t : {}, o[n] = se.extend(u, r, i)) : void 0 !== i && (o[n] = i));
        return o;
    }, se.extend({
        ...
        each: function(t, e, n) {
            ...
            if (n) {
                if (a) for (;o > r && (s = e.apply(t[r], n), s !== !1); r++) ; else for (r in t) if (s = e.apply(t[r], n), 
                s === !1) break;
            } else if (a) for (;o > r && (s = e.call(t[r], r, t[r]), s !== !1); r++) ; else for (r in t) if (s = e.call(t[r], r, t[r]), 
            s === !1) break;
            return t;
        },
        trim: function(t) {
        ...
        makeArray: function(t, e) {
            var n = e || [];
            return null != t && (i(Object(t)) ? se.merge(n, "string" == typeof t ? [ t ] : t) : G.call(n, t)), 
            n;
        },
        ...
        map: function(t, e, n) {
            ...
            if (a) for (;o > r; r++) s = e(t[r], r, n), null != s && l.push(s); else for (r in t) s = e(t[r], r, n), 
            null != s && l.push(s);
            return J.apply([], l);
        },
        guid: 1,
        proxy: function(t, e) {
            var i, n, s;
            return "string" == typeof e && (s = t[e], e = t, t = s), se.isFunction(t) ? (i = K.call(arguments, 2), 
            n = function() {
    ...
    var ue = function(t) {
        function e(t, e, i, n) {
            var s, r, o, a, l, u, h, p, f, m;
            if ((e ? e.ownerDocument || e : j) !== A && P(e), e = e || A, i = i || [], !t || "string" != typeof t) return i;
            if (1 !== (a = e.nodeType) && 9 !== a) return [];
            if (O && !n) {
                if (s = be.exec(t)) if (o = s[1]) {
                    if (9 === a) {
                        if (r = e.getElementById(o), !r || !r.parentNode) return i;
                        if (r.id === o) return i.push(r), i;
                    } else if (e.ownerDocument && (r = e.ownerDocument.getElementById(o)) && $(e, r) && r.id === o) return i.push(r), 
                    i;
                } else {
                    if (s[2]) return Z.apply(i, e.getElementsByTagName(t)), i;
                    if ((o = s[3]) && w.getElementsByClassName && e.getElementsByClassName) return Z.apply(i, e.getElementsByClassName(o)), 
                    i;
                }
                if (w.qsa && (!F || !F.test(t))) {
                    if (p = h = z, f = e, m = 9 === a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                        for (u = T(t), (h = e.getAttribute("id")) ? p = h.replace(_e, "\\$&") : e.setAttribute("id", p), 
                        p = "[id='" + p + "'] ", l = u.length; l--; ) u[l] = p + d(u[l]);
        ...
        function p(t, e, i) {
            ...
            return e.first ? function(e, i, r) {
                ...
                if (o) {
                    ...
                    if (l = e[z] || (e[z] = {}), (a = l[n]) && a[0] === R && a[1] === r) return u[2] = a[2];
        ...
        function g(t, e, i, n, s) {
            for (var r, o = [], a = 0, l = t.length, u = null != e; l > a; a++) (r = t[a]) && (!i || i(r, n, s)) && (o.push(r), 
            u && e.push(a));
            return o;
        }
        function v(t, e, i, s, r, o) {
            return s && !s[z] && (s = v(s)), r && !r[z] && (r = v(r, o)), n(function(n, o, a, l) {
                var u, c, h, d = [], p = [], f = o.length, v = n || m(e || "*", a.nodeType ? [ a ] : a, []), b = !t || !n && e ? v : g(v, d, t, a, l), y = i ? r || (n ? t : f || s) ? [] : o : b;
                if (i && i(b, y, a, l), s) for (u = g(y, p), s(u, [], a, l), c = u.length; c--; ) (h = u[c]) && (y[p[c]] = !(b[p[c]] = h));
                if (n) {
                    if (r || t) {
                        if (r) {
                            for (u = [], c = y.length; c--; ) (h = y[c]) && u.push(b[c] = h);
                            r(null, y = [], u, l);
                        }
        ...
        function b(t) {
            ...
            } ]; s > a; a++) if (i = x.relative[t[a].type]) c = [ p(f(c), i) ]; else {
        ...
        function y(t, i) {
            var s = i.length > 0, r = t.length > 0, o = function(n, o, a, l, u) {
                var c, h, d, p = 0, f = "0", m = n && [], v = [], b = D, y = n || r && x.find.TAG("*", u), _ = R += null == b ? 1 : Math.random() || .1, w = y.length;
                for (u && (D = o !== A && o); f !== w && null != (c = y[f]); f++) {
                    if (r && c) {
        ...
        var _, w, x, k, C, T, S, N, D, E, M, P, A, I, O, F, L, H, $, z = "sizzle" + -new Date(), j = t.document, R = 0, W = 0, q = i(), B = i(), V = i(), U = function(t, e) {
            return t === e && (M = !0), 0;
        }, X = "undefined", Y = 1 << 31, K = {}.hasOwnProperty, J = [], G = J.pop, Q = J.push, Z = J.push, te = J.slice, ee = J.indexOf || function(t) {
            for (var e = 0, i = this.length; i > e; e++) if (this[e] === t) return e;
            return -1;
        }, ie = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", ne = "[\\x20\\t\\r\\n\\f]", se = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", re = se.replace("w", "w#"), oe = "\\[" + ne + "*(" + se + ")(?:" + ne + "*([*^$|!~]?=)" + ne + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + re + "))|)" + ne + "*\\]", ae = ":(" + se + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + oe + ")*)|.*)\\)|)", le = new RegExp("^" + ne + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ne + "+$", "g"), ue = new RegExp("^" + ne + "*," + ne + "*"), ce = new RegExp("^" + ne + "*([>+~]|" + ne + ")" + ne + "*"), he = new RegExp("=" + ne + "*([^\\]'\"]*?)" + ne + "*\\]", "g"), de = new RegExp(ae), pe = new RegExp("^" + re + "$"), fe = {
            ID: new RegExp("^#(" + se + ")"),
            CLASS: new RegExp("^\\.(" + se + ")"),
        ...
        }, me = /^(?:input|select|textarea|button)$/i, ge = /^h\d$/i, ve = /^[^{]+\{\s*\[native \w/, be = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ye = /[+~]/, _e = /'|\\/g, we = new RegExp("\\\\([\\da-f]{1,6}" + ne + "?|(" + ne + ")|.)", "ig"), xe = function(t, e, i) {
            var n = "0x" + e - 65536;
            return n !== n || i ? e : 0 > n ? String.fromCharCode(n + 65536) : String.fromCharCode(n >> 10 | 55296, 1023 & n | 56320);
        };
        try {
            Z.apply(J = te.call(j.childNodes), j.childNodes), J[j.childNodes.length].nodeType;
        } catch (ke) {
            Z = {
        ...
        w = e.support = {}, C = e.isXML = function(t) {
            ...
            O = !C(i), n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", function() {
                P();
                ...
                return I.appendChild(t).id = z, !i.getElementsByName || !i.getElementsByName(z).length;
            ...
            }, L = [], F = [], (w.qsa = ve.test(i.querySelectorAll)) && (s(function(t) {
                t.innerHTML = "<select msallowclip=''><option selected=''></option></select>", t.querySelectorAll("[msallowclip^='']").length && F.push("[*^$]=" + ne + "*(?:''|\"\")"), 
                t.querySelectorAll("[selected]").length || F.push("\\[" + ne + "*(?:value|" + ie + ")"), 
                t.querySelectorAll(":checked").length || F.push(":checked");
            }), s(function(t) {
                var e = i.createElement("input");
                e.setAttribute("type", "hidden"), t.appendChild(e).setAttribute("name", "D"), t.querySelectorAll("[name=d]").length && F.push("name" + ne + "*[*^$|!~]?="), 
                t.querySelectorAll(":enabled").length || F.push(":enabled", ":disabled"), t.querySelectorAll("*,:x"), 
                F.push(",.*:");
            })), (w.matchesSelector = ve.test(H = I.matches || I.webkitMatchesSelector || I.mozMatchesSelector || I.oMatchesSelector || I.msMatchesSelector)) && s(function(t) {
                w.disconnectedMatch = H.call(t, "div"), H.call(t, "[s!='']:x"), L.push("!=", ae);
            }), F = F.length && new RegExp(F.join("|")), L = L.length && new RegExp(L.join("|")), 
            e = ve.test(I.compareDocumentPosition), $ = e || ve.test(I.contains) ? function(t, e) {
                ...
                1 & n || !w.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === j && $(j, t) ? -1 : e === i || e.ownerDocument === j && $(j, e) ? 1 : E ? ee.call(E, t) - ee.call(E, e) : 0 : 4 & n ? -1 : 1);
            } : function(t, e) {
                if (t === e) return M = !0, 0;
                var n, s = 0, r = t.parentNode, a = e.parentNode, l = [ t ], u = [ e ];
                if (!r || !a) return t === i ? -1 : e === i ? 1 : r ? -1 : a ? 1 : E ? ee.call(E, t) - ee.call(E, e) : 0;
                if (r === a) return o(t, e);
                for (n = t; n = n.parentNode; ) l.unshift(n);
                for (n = e; n = n.parentNode; ) u.unshift(n);
                for (;l[s] === u[s]; ) s++;
                return s ? o(l[s], u[s]) : l[s] === j ? -1 : u[s] === j ? 1 : 0;
            }, i) : A;
        }, e.matches = function(t, i) {
            return e(t, null, null, i);
        }, e.matchesSelector = function(t, i) {
            if ((t.ownerDocument || t) !== A && P(t), i = i.replace(he, "='$1']"), !(!w.matchesSelector || !O || L && L.test(i) || F && F.test(i))) try {
                var n = H.call(t, i);
                if (n || w.disconnectedMatch || t.document && 11 !== t.document.nodeType) return n;
            } catch (s) {}
            return e(i, A, null, [ t ]).length > 0;
        }, e.contains = function(t, e) {
            return (t.ownerDocument || t) !== A && P(t), $(t, e);
        }, e.attr = function(t, e) {
            (t.ownerDocument || t) !== A && P(t);
            var i = x.attrHandle[e.toLowerCase()], n = i && K.call(x.attrHandle, e.toLowerCase()) ? i(t, e, !O) : void 0;
            ...
            preFilter: {
                ATTR: function(t) {
                    return t[1] = t[1].replace(we, xe), t[3] = (t[3] || t[4] || t[5] || "").replace(we, xe), 
                ...
                PSEUDO: function(t) {
                    var e, i = !t[6] && t[2];
                    return fe.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : i && de.test(i) && (e = T(i, !0)) && (e = i.indexOf(")", i.length - e) - i.length) && (t[0] = t[0].slice(0, e), 
            ...
            filter: {
                ...
                CHILD: function(t, e, i, n, s) {
                    ...
                    return 1 === n && 0 === s ? function(t) {
                        ...
                        var u, c, h, d, p, f, m = r !== o ? "nextSibling" : "previousSibling", g = e.parentNode, v = a && e.nodeName.toLowerCase(), b = !l && !a;
                        if (g) {
                            if (r) {
                                for (;m; ) {
                            ...
                            if (f = [ o ? g.firstChild : g.lastChild ], o && b) {
                                for (c = g[z] || (g[z] = {}), u = c[t] || [], p = u[0] === R && u[1], d = u[0] === R && u[2], 
                                h = p && g.childNodes[p]; h = ++p && h && h[m] || (d = p = 0) || f.pop(); ) if (1 === h.nodeType && ++d && h === e) {
                                    c[t] = [ R, p, d ];
                                    break;
                                }
                            } else if (b && (u = (e[z] || (e[z] = {}))[t]) && u[0] === R) d = u[1]; else for (;(h = ++p && h && h[m] || (d = p = 0) || f.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++d || (b && ((h[z] || (h[z] = {}))[t] = [ R, d ]), 
                            h !== e)); ) ;
            ...
            pseudos: {
                ...
                lang: n(function(t) {
                    ...
                    function(e) {
                        var i;
                        do if (i = O ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang")) return i = i.toLowerCase(), 
        ...
        return h.prototype = x.filters = x.pseudos, x.setFilters = new h(), T = e.tokenize = function(t, i) {
            ...
            for (a = t, l = [], u = x.preFilter; a; ) {
                (!n || (s = ue.exec(a))) && (s && (a = a.slice(s[0].length) || a), l.push(r = [])), 
                n = !1, (s = ce.exec(a)) && (n = s.shift(), r.push({
                    value: n,
                    type: s[0].replace(le, " ")
                }), a = a.slice(n.length));
                for (o in x.filter) !(s = fe[o].exec(a)) || u[o] && !(s = u[o](s)) || (n = s.shift(), 
                r.push({
                    value: n,
                    type: o,
                    matches: s
            ...
            var i, n = [], s = [], r = V[t + " "];
            if (!r) {
                for (e || (e = T(t)), i = e.length; i--; ) r = b(e[i]), r[z] ? n.push(r) : s.push(r);
                r = V(t, y(s, n)), r.selector = t;
            }
            return r;
        }, N = e.select = function(t, e, i, n) {
            var s, r, o, a, l, u = "function" == typeof t && t, h = !n && T(t = u.selector || t);
            if (i = i || [], 1 === h.length) {
                if (r = h[0] = h[0].slice(0), r.length > 2 && "ID" === (o = r[0]).type && w.getById && 9 === e.nodeType && O && x.relative[r[1].type]) {
                    if (e = (x.find.ID(o.matches[0].replace(we, xe), e) || [])[0], !e) return i;
                    u && (e = e.parentNode), t = t.slice(r.shift().value.length);
                }
                for (s = fe.needsContext.test(t) ? 0 : r.length; s-- && (o = r[s], !x.relative[a = o.type]); ) if ((l = x.find[a]) && (n = l(o.matches[0].replace(we, xe), ye.test(r[0].type) && c(e.parentNode) || e))) {
                    if (r.splice(s, 1), t = n.length && d(r), !t) return Z.apply(i, n), i;
                    break;
                }
            }
            return (u || S(t, h))(n, e, !O, i, ye.test(t) && c(e.parentNode) || e), i;
        }, w.sortStable = z.split("").sort(U).join("") === z, w.detectDuplicates = !!M, 
        P(), w.sortDetached = s(function(t) {
    ...
    se.find = ue, se.expr = ue.selectors, se.expr[":"] = se.expr.pseudos, se.unique = ue.uniqueSort, 
    se.text = ue.getText, se.isXMLDoc = ue.isXML, se.contains = ue.contains;
    var ce = se.expr.match.needsContext, he = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, de = /^.[^:#\[\.,]*$/;
    se.filter = function(t, e, i) {
        ...
        find: function(t) {
            ...
            return i = this.pushStack(s > 1 ? se.unique(i) : i), i.selector = this.selector ? this.selector + " " + t : t, 
            i;
        },
        filter: function(t) {
    ...
    var pe, fe = t.document, me = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/, ge = se.fn.init = function(t, e) {
        ...
        if ("string" == typeof t) {
            ...
            !i || !i[1] && e) return !e || e.jquery ? (e || pe).find(t) : this.constructor(e).find(t);
            if (i[1]) {
                if (e = e instanceof se ? e[0] : e, se.merge(this, se.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : fe, !0)), 
                he.test(i[1]) && se.isPlainObject(e)) for (i in e) se.isFunction(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
                return this;
            }
        ...
        return t.nodeType ? (this.context = this[0] = t, this.length = 1, this) : se.isFunction(t) ? "undefined" != typeof pe.ready ? pe.ready(t) : t(se) : (void 0 !== t.selector && (this.selector = t.selector, 
        this.context = t.context), se.makeArray(t, this));
    };
    ge.prototype = se.fn, pe = se(fe);
    var ve = /^(?:parents|prev(?:Until|All))/, be = {
        children: !0,
        contents: !0,
        next: !0,
        prev: !0
    ...
    se.extend({
        ...
        closest: function(t, e) {
            for (var i, n = 0, s = this.length, r = [], o = ce.test(t) || "string" != typeof t ? se(t, e || this.context) : 0; s > n; n++) for (i = this[n]; i && i !== e; i = i.parentNode) if (i.nodeType < 11 && (o ? o.index(i) > -1 : 1 === i.nodeType && se.find.matchesSelector(i, t))) {
                r.push(i);
                break;
            }
        ...
        se.fn[t] = function(i, n) {
            ...
            return "Until" !== t.slice(-5) && (n = i), n && "string" == typeof n && (s = se.filter(n, s)), 
    ...
    se.Callbacks = function(t) {
        t = "string" == typeof t ? _e[t] || r(t) : se.extend({}, t);
        var e, i, n, s, o, a, l = [], u = !t.once && [], c = function(r) {
            for (i = t.memory && r, n = !0, o = a || 0, a = 0, s = l.length, e = !0; l && s > o; o++) if (l[o].apply(r[0], r[1]) === !1 && t.stopOnFalse) {
                i = !1;
                break;
            }
            ...
            remove: function() {
                return l && se.each(arguments, function(t, i) {
                    for (var n; (n = se.inArray(i, l, n)) > -1; ) l.splice(n, 1), e && (s >= n && s--, 
                    o >= n && o--);
                }), this;
            },
            has: function(t) {
            ...
            fireWith: function(t, i) {
                return !l || n && !u || (i = i || [], i = [ t, i.slice ? i.slice() : i ], e ? u.push(i) : c(i)), 
                this;
            },
            fire: function() {
        ...
        when: function(t) {
            var e, i, n, s = 0, r = K.call(arguments), o = r.length, a = 1 !== o || t && se.isFunction(t.promise) ? o : 0, l = 1 === a ? t : se.Deferred(), u = function(t, i, n) {
                return function(s) {
                    i[t] = this, n[t] = arguments.length > 1 ? K.call(arguments) : s, n === e ? l.notifyWith(i, n) : --a || l.resolveWith(i, n);
                };
            };
            if (o > 1) for (e = new Array(o), i = new Array(o), n = new Array(o); o > s; s++) r[s] && se.isFunction(r[s].promise) ? r[s].promise().done(u(s, n, r)).fail(l.reject).progress(u(s, i, e)) : --a;
    ...
    se.fn.ready = function(t) {
        ...
        ready: function(t) {
            if (t === !0 ? !--se.readyWait : !se.isReady) {
                ...
                se.isReady = !0, t !== !0 && --se.readyWait > 0 || (we.resolveWith(fe, [ se ]), 
                se.fn.triggerHandler && (se(fe).triggerHandler("ready"), se(fe).off("ready")));
            }
        }
    }), se.ready.promise = function(e) {
        if (!we) if (we = se.Deferred(), "complete" === fe.readyState) setTimeout(se.ready); else if (fe.addEventListener) fe.addEventListener("DOMContentLoaded", a, !1), 
    ...
    ie.ownLast = "0" !== xe, ie.inlineBlockNeedsLayout = !1, se(function() {
        var t, e, i, n;
        i = fe.getElementsByTagName("body")[0], i && i.style && (e = fe.createElement("div"), 
        n = fe.createElement("div"), n.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", 
        i.appendChild(n).appendChild(e), typeof e.style.zoom !== ke && (e.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1", 
        ie.inlineBlockNeedsLayout = t = 3 === e.offsetWidth, t && (i.style.zoom = 1)), i.removeChild(n));
    }), function() {
    ...
    se.extend({
        ...
        data: function(t, e) {
            ...
            if (void 0 === t) {
                if (this.length && (s = se.data(r), 1 === r.nodeType && !se._data(r, "parsedAttrs"))) {
                    for (i = o.length; i--; ) o[i] && (n = o[i].name, 0 === n.indexOf("data-") && (n = se.camelCase(n.slice(5)), 
                    l(r, n, s[n])));
        ...
        queue: function(t, e, i) {
            var n;
            return t ? (e = (e || "fx") + "queue", n = se._data(t, e), i && (!n || se.isArray(i) ? n = se._data(t, e, se.makeArray(i)) : n.push(i)), 
            n || []) : void 0;
        },
        dequeue: function(t, e) {
            e = e || "fx";
            var i = se.queue(t, e), n = i.length, s = i.shift(), r = se._queueHooks(t, e), o = function() {
                se.dequeue(t, e);
            };
            "inprogress" === s && (s = i.shift(), n--), s && ("fx" === e && i.unshift("inprogress"), 
            delete r.stop, s.call(t, o, r)), !n && r && r.empty.fire();
        },
        ...
        promise: function(t, e) {
            var i, n = 1, s = se.Deferred(), r = this, o = this.length, a = function() {
                --n || s.resolveWith(r, [ r ]);
            };
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; o--; ) i = se._data(r[o], t + "queueHooks"), 
            i && i.empty && (n++, i.empty.add(a));
            return a(), s.promise(e);
        }
    });
    var Se = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Ne = [ "Top", "Right", "Bottom", "Left" ], De = function(t, e) {
        return t = e || t, "none" === se.css(t, "display") || !se.contains(t.ownerDocument, t);
    }, Ee = se.access = function(t, e, i, n, s, r, o) {
        var a = 0, l = t.length, u = null == i;
        if ("object" === se.type(i)) {
            s = !0;
            for (a in i) se.access(t, e, a, i[a], !0, r, o);
        } else if (void 0 !== n && (s = !0, se.isFunction(n) || (o = !0), u && (o ? (e.call(t, n), 
        e = null) : (u = e, e = function(t, e, i) {
            return u.call(se(t), i);
    ...
    !function() {
        ...
        ie.leadingWhitespace = 3 === e.firstChild.nodeType, ie.tbody = !e.getElementsByTagName("tbody").length, 
        ie.htmlSerialize = !!e.getElementsByTagName("link").length, ie.html5Clone = "<:nav></:nav>" !== fe.createElement("nav").cloneNode(!0).outerHTML, 
        t.type = "checkbox", t.checked = !0, i.appendChild(t), ie.appendChecked = t.checked, 
        ...
        ie.checkClone = e.cloneNode(!0).cloneNode(!0).lastChild.checked, ie.noCloneEvent = !0, 
    ...
    var Pe = /^(?:input|select|textarea)$/i, Ae = /^key/, Ie = /^(?:mouse|pointer|contextmenu)|click/, Oe = /^(?:focusinfocus|focusoutblur)$/, Fe = /^([^.]*)(?:\.(.+)|)$/;
    se.event = {
        global: {},
        add: function(t, e, i, n, s) {
            var r, o, a, l, u, c, h, d, p, f, m, g = se._data(t);
            if (g) {
                for (i.handler && (l = i, i = l.handler, s = l.selector), i.guid || (i.guid = se.guid++), 
                (o = g.events) || (o = g.events = {}), (c = g.handle) || (c = g.handle = function(t) {
                    return typeof se === ke || t && se.event.triggered === t.type ? void 0 : se.event.dispatch.apply(c.elem, arguments);
                }, c.elem = t), e = (e || "").match(ye) || [ "" ], a = e.length; a--; ) r = Fe.exec(e[a]) || [], 
                p = m = r[1], f = (r[2] || "").split(".").sort(), p && (u = se.event.special[p] || {}, 
                p = (s ? u.delegateType : u.bindType) || p, u = se.event.special[p] || {}, h = se.extend({
                    type: p,
                    origType: m,
                    data: n,
                    handler: i,
                    ...
                    namespace: f.join(".")
                }, l), (d = o[p]) || (d = o[p] = [], d.delegateCount = 0, u.setup && u.setup.call(t, n, f, c) !== !1 || (t.addEventListener ? t.addEventListener(p, c, !1) : t.attachEvent && t.attachEvent("on" + p, c))), 
                u.add && (u.add.call(t, h), h.handler.guid || (h.handler.guid = i.guid)), s ? d.splice(d.delegateCount++, 0, h) : d.push(h), 
                se.event.global[p] = !0);
                t = null;
            }
        },
        remove: function(t, e, i, n, s) {
            var r, o, a, l, u, c, h, d, p, f, m, g = se.hasData(t) && se._data(t);
            if (g && (c = g.events)) {
                for (e = (e || "").match(ye) || [ "" ], u = e.length; u--; ) if (a = Fe.exec(e[u]) || [], 
                p = m = a[1], f = (a[2] || "").split(".").sort(), p) {
                    for (h = se.event.special[p] || {}, p = (n ? h.delegateType : h.bindType) || p, 
                    d = c[p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), 
                    l = r = d.length; r--; ) o = d[r], !s && m !== o.origType || i && i.guid !== o.guid || a && !a.test(o.namespace) || n && n !== o.selector && ("**" !== n || !o.selector) || (d.splice(r, 1), 
                    o.selector && d.delegateCount--, h.remove && h.remove.call(t, o));
                    l && !d.length && (h.teardown && h.teardown.call(t, f, g.handle) !== !1 || se.removeEvent(t, p, g.handle), 
                    delete c[p]);
                } else for (p in c) se.event.remove(t, p + e[u], i, n, !0);
                se.isEmptyObject(c) && (delete g.handle, se._removeData(t, "events"));
            }
        },
        trigger: function(e, i, n, s) {
            var r, o, a, l, u, c, h, d = [ n || fe ], p = ee.call(e, "type") ? e.type : e, f = ee.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = c = n = n || fe, 3 !== n.nodeType && 8 !== n.nodeType && !Oe.test(p + se.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), 
            p = f.shift(), f.sort()), o = p.indexOf(":") < 0 && "on" + p, e = e[se.expando] ? e : new se.Event(p, "object" == typeof e && e), 
            e.isTrigger = s ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, 
            e.result = void 0, e.target || (e.target = n), i = null == i ? [ e ] : se.makeArray(i, [ e ]), 
            u = se.event.special[p] || {}, s || !u.trigger || u.trigger.apply(n, i) !== !1)) {
                if (!s && !u.noBubble && !se.isWindow(n)) {
                    for (l = u.delegateType || p, Oe.test(l + p) || (a = a.parentNode); a; a = a.parentNode) d.push(a), 
                    c = a;
                    c === (n.ownerDocument || fe) && d.push(c.defaultView || c.parentWindow || t);
                }
                for (h = 0; (a = d[h++]) && !e.isPropagationStopped(); ) e.type = h > 1 ? l : u.bindType || p, 
                r = (se._data(a, "events") || {})[e.type] && se._data(a, "handle"), r && r.apply(a, i), 
                r = o && a[o], r && r.apply && se.acceptData(a) && (e.result = r.apply(a, i), e.result === !1 && e.preventDefault());
                if (e.type = p, !s && !e.isDefaultPrevented() && (!u._default || u._default.apply(d.pop(), i) === !1) && se.acceptData(n) && o && n[p] && !se.isWindow(n)) {
        ...
        dispatch: function(t) {
            t = se.event.fix(t);
            var e, i, n, s, r, o = [], a = K.call(arguments), l = (se._data(this, "events") || {})[t.type] || [], u = se.event.special[t.type] || {};
            if (a[0] = t, t.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, t) !== !1) {
                for (o = se.event.handlers.call(this, t, l), e = 0; (s = o[e++]) && !t.isPropagationStopped(); ) for (t.currentTarget = s.elem, 
                r = 0; (n = s.handlers[r++]) && !t.isImmediatePropagationStopped(); ) (!t.namespace_re || t.namespace_re.test(n.namespace)) && (t.handleObj = n, 
                t.data = n.data, i = ((se.event.special[n.origType] || {}).handle || n.handler).apply(s.elem, a), 
        ...
        handlers: function(t, e) {
            ...
            if (a && l.nodeType && (!t.button || "click" !== t.type)) for (;l != this; l = l.parentNode || this) if (1 === l.nodeType && (l.disabled !== !0 || "click" !== t.type)) {
                for (s = [], r = 0; a > r; r++) n = e[r], i = n.selector + " ", void 0 === s[i] && (s[i] = n.needsContext ? se(i, this).index(l) >= 0 : se.find(i, this, null, [ l ]).length), 
                s[i] && s.push(n);
                s.length && o.push({
                    elem: l,
                    handlers: s
        ...
        fix: function(t) {
            ...
            for (o || (this.fixHooks[s] = o = Ie.test(s) ? this.mouseHooks : Ae.test(s) ? this.keyHooks : {}), 
            n = o.props ? this.props.concat(o.props) : this.props, t = new se.Event(r), e = n.length; e--; ) i = n[e], 
            t[i] = r[i];
            return t.target || (t.target = r.srcElement || fe), 3 === t.target.nodeType && (t.target = t.target.parentNode), 
            t.metaKey = !!t.metaKey, o.filter ? o.filter(t, r) : t;
        },
        ...
        mouseHooks: {
            ...
            filter: function(t, e) {
                ...
                !t.relatedTarget && o && (t.relatedTarget = o === t.target ? e.toElement : o), t.which || void 0 === r || (t.which = 1 & r ? 1 : 2 & r ? 3 : 4 & r ? 2 : 0), 
                t;
            }
        },
        special: {
            ...
            click: {
                trigger: function() {
                    return se.nodeName(this, "input") && "checkbox" === this.type && this.click ? (this.click(), 
                    !1) : void 0;
                },
                _default: function(t) {
        ...
        return this instanceof se.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, 
        this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && t.returnValue === !1 ? d : p) : this.type = t, 
        e && se.extend(this, e), this.timeStamp = t && t.timeStamp || se.now(), void (this[se.expando] = !0)) : new se.Event(t, e);
    }, se.Event.prototype = {
        ...
        stopImmediatePropagation: function() {
            var t = this.originalEvent;
            this.isImmediatePropagationStopped = d, t && t.stopImmediatePropagation && t.stopImmediatePropagation(), 
        ...
        se.event.special[t] = {
            ...
            handle: function(t) {
                ...
                return (!s || s !== n && !se.contains(n, s)) && (t.type = r.origType, i = r.handler.apply(this, arguments), 
                t.type = e), i;
            }
        };
        ...
        on: function(t, e, i, n, s) {
            ...
            i = void 0) : (n = i, i = e, e = void 0)), n === !1) n = p; else if (!n) return this;
        ...
        off: function(t, e, i) {
            var n, s;
            if (t && t.preventDefault && t.handleObj) return n = t.handleObj, se(t.delegateTarget).off(n.namespace ? n.origType + "." + n.namespace : n.origType, n.selector, n.handler), 
            this;
            if ("object" == typeof t) {
                for (s in t) this.off(s, e, t[s]);
                return this;
            }
            return (e === !1 || "function" == typeof e) && (i = e, e = void 0), i === !1 && (i = p), 
            this.each(function() {
    ...
    var Le = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", He = / jQuery\d+="(?:null|\d+)"/g, $e = new RegExp("<(?:" + Le + ")[\\s/>]", "i"), ze = /^\s+/, je = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Re = /<([\w:]+)/, We = /<tbody/i, qe = /<|&#?\w+;/, Be = /<(?:script|style|link)/i, Ve = /checked\s*(?:[^=]|=\s*.checked.)/i, Ue = /^$|\/(?:java|ecma)script/i, Xe = /^true\/(.*)/, Ye = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, Ke = {
    ...
    }, Je = m(fe), Ge = Je.appendChild(fe.createElement("div"));
    Ke.optgroup = Ke.option, Ke.tbody = Ke.tfoot = Ke.colgroup = Ke.caption = Ke.thead, 
    Ke.th = Ke.td, se.extend({
        clone: function(t, e, i) {
            var n, s, r, o, a, l = se.contains(t.ownerDocument, t);
            if (ie.html5Clone || se.isXMLDoc(t) || !$e.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (Ge.innerHTML = t.outerHTML, 
            Ge.removeChild(r = Ge.firstChild)), !(ie.noCloneEvent && ie.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || se.isXMLDoc(t))) for (n = g(r), 
            a = g(t), o = 0; null != (s = a[o]); ++o) n[o] && k(s, n[o]);
            if (e) if (i) for (a = a || g(t), n = n || g(r), o = 0; null != (s = a[o]); o++) x(s, n[o]); else x(t, r);
            return n = g(r, "script"), n.length > 0 && w(n, !l && g(t, "script")), n = a = s = null, 
            r;
        },
        buildFragment: function(t, e, i, n) {
            for (var s, r, o, a, l, u, c, h = t.length, d = m(e), p = [], f = 0; h > f; f++) if (r = t[f], 
            r || 0 === r) if ("object" === se.type(r)) se.merge(p, r.nodeType ? [ r ] : r); else if (qe.test(r)) {
                for (a = a || d.appendChild(e.createElement("div")), l = (Re.exec(r) || [ "", "" ])[1].toLowerCase(), 
                c = Ke[l] || Ke._default, a.innerHTML = c[1] + r.replace(je, "<$1></$2>") + c[2], 
                s = c[0]; s--; ) a = a.lastChild;
                if (!ie.leadingWhitespace && ze.test(r) && p.push(e.createTextNode(ze.exec(r)[0])), 
                !ie.tbody) for (r = "table" !== l || We.test(r) ? "<table>" !== c[1] || We.test(r) ? 0 : a : a.firstChild, 
                s = r && r.childNodes.length; s--; ) se.nodeName(u = r.childNodes[s], "tbody") && !u.childNodes.length && r.removeChild(u);
                for (se.merge(p, a.childNodes), a.textContent = ""; a.firstChild; ) a.removeChild(a.firstChild);
                a = d.lastChild;
            } else p.push(e.createTextNode(r));
            for (a && d.removeChild(a), ie.appendChecked || se.grep(g(p, "input"), v), f = 0; r = p[f++]; ) if ((!n || -1 === se.inArray(r, n)) && (o = se.contains(r.ownerDocument, r), 
            a = g(d.appendChild(r), "script"), o && w(a), i)) for (s = 0; r = a[s++]; ) Ue.test(r.type || "") && i.push(r);
            return a = null, d;
        },
        cleanData: function(t, e) {
            for (var i, n, s, r, o = 0, a = se.expando, l = se.cache, u = ie.deleteExpando, c = se.event.special; null != (i = t[o]); o++) if ((e || se.acceptData(i)) && (s = i[a], 
            r = s && l[s])) {
                if (r.events) for (n in r.events) c[n] ? se.event.remove(i, n) : se.removeEvent(i, n, r.handle);
                l[s] && (delete l[s], u ? delete i[a] : typeof i.removeAttribute !== ke ? i.removeAttribute(a) : i[a] = null, 
                Y.push(s));
            }
        }
    }), se.fn.extend({
        ...
        html: function(t) {
            return Ee(this, function(t) {
                ...
                if (!("string" != typeof t || Be.test(t) || !ie.htmlSerialize && $e.test(t) || !ie.leadingWhitespace && ze.test(t) || Ke[(Re.exec(t) || [ "", "" ])[1].toLowerCase()])) {
                    t = t.replace(je, "<$1></$2>");
                    try {
                        for (;n > i; i++) e = this[i] || {}, 1 === e.nodeType && (se.cleanData(g(e, !1)), 
                        e.innerHTML = t);
                        e = 0;
                    } catch (s) {}
                }
        ...
        domManip: function(t, e) {
            t = J.apply([], t);
            var i, n, s, r, o, a, l = 0, u = this.length, c = this, h = u - 1, d = t[0], p = se.isFunction(d);
            if (p || u > 1 && "string" == typeof d && !ie.checkClone && Ve.test(d)) return this.each(function(i) {
                var n = c.eq(i);
                p && (t[0] = d.call(this, i, n.html())), n.domManip(t, e);
            });
            if (u && (a = se.buildFragment(t, this[0].ownerDocument, !1, this), i = a.firstChild, 
            1 === a.childNodes.length && (a = i), i)) {
                for (r = se.map(g(a, "script"), y), s = r.length; u > l; l++) n = a, l !== h && (n = se.clone(n, !0, !0), 
                s && se.merge(r, g(n, "script"))), e.call(this[l], n, l);
                if (s) for (o = r[r.length - 1].ownerDocument, se.map(r, _), l = 0; s > l; l++) n = r[l], 
                Ue.test(n.type || "") && !se._data(n, "globalEval") && se.contains(o, n) && (n.src ? se._evalUrl && se._evalUrl(n.src) : se.globalEval((n.text || n.textContent || n.innerHTML || "").replace(Ye, "")));
                a = i = null;
            }
            return this;
        }
        ...
        se.fn[t] = function(t) {
            for (var i, n = 0, s = [], r = se(t), o = r.length - 1; o >= n; n++) i = n === o ? this : this.clone(!0), 
            se(r[n])[e](i), G.apply(s, i.get());
    ...
    !function() {
        ...
        ie.shrinkWrapBlocks = function() {
            ...
            t = !1;
            var e, i, n;
            return i = fe.getElementsByTagName("body")[0], i && i.style ? (e = fe.createElement("div"), 
            n = fe.createElement("div"), n.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", 
            i.appendChild(n).appendChild(e), typeof e.style.zoom !== ke && (e.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1", 
            e.appendChild(fe.createElement("div")).style.width = "5px", t = 3 !== e.offsetWidth), 
    ...
    t.getComputedStyle ? (ti = function(t) {
        ...
        return i = i || ti(t), o = i ? i.getPropertyValue(e) || i[e] : void 0, i && ("" !== o || se.contains(t.ownerDocument, t) || (o = se.style(t, e)), 
        ni.test(o) && ii.test(e) && (n = a.width, s = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = o, 
        o = i.width, a.width = n, a.minWidth = s, a.maxWidth = r)), void 0 === o ? o : o + "";
    }) : fe.documentElement.currentStyle && (ti = function(t) {
        return t.currentStyle;
    }, ei = function(t, e, i) {
        var n, s, r, o, a = t.style;
        return i = i || ti(t), o = i ? i[e] : void 0, null == o && a && a[e] && (o = a[e]), 
        ni.test(o) && !si.test(e) && (n = a.left, s = t.runtimeStyle, r = s && s.left, r && (s.left = t.currentStyle.left), 
        a.left = "fontSize" === e ? "1em" : o, o = a.pixelLeft + "px", a.left = n, r && (s.left = r)), 
        void 0 === o ? o : o + "" || "auto";
    }), function() {
        function e() {
            var e, i, n, s;
            ...
            r = o = !1, l = !0, t.getComputedStyle && (r = "1%" !== (t.getComputedStyle(e, null) || {}).top, 
            o = "4px" === (t.getComputedStyle(e, null) || {
                width: "4px"
            }).width, s = e.appendChild(fe.createElement("div")), s.style.cssText = e.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", 
            s.style.marginRight = s.style.width = "0", e.style.width = "1px", l = !parseFloat((t.getComputedStyle(s, null) || {}).marginRight)), 
            e.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", s = e.getElementsByTagName("td"), 
            s[0].style.cssText = "margin:0;border:0;padding:0;display:none", a = 0 === s[0].offsetHeight, 
            a && (s[0].style.display = "", s[1].style.display = "none", a = 0 === s[0].offsetHeight), 
            i.removeChild(n));
        }
        var i, n, s, r, o, a, l;
        i = fe.createElement("div"), i.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", 
        s = i.getElementsByTagName("a")[0], n = s && s.style, n && (n.cssText = "float:left;opacity:.5", 
        ie.opacity = "0.5" === n.opacity, ie.cssFloat = !!n.cssFloat, i.style.backgroundClip = "content-box", 
        i.cloneNode(!0).style.backgroundClip = "", ie.clearCloneStyle = "content-box" === i.style.backgroundClip, 
    ...
    var ri = /alpha\([^)]*\)/i, oi = /opacity\s*=\s*([^)]*)/, ai = /^(none|table(?!-c[ea]).+)/, li = new RegExp("^(" + Se + ")(.*)$", "i"), ui = new RegExp("^([+-])=(" + Se + ")", "i"), ci = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, hi = {
    ...
    se.extend({
        ...
        style: function(t, e, i, n) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var s, r, o, a = se.camelCase(e), l = t.style;
                if (e = se.cssProps[a] || (se.cssProps[a] = N(l, a)), o = se.cssHooks[e] || se.cssHooks[a], 
                void 0 === i) return o && "get" in o && void 0 !== (s = o.get(t, !1, n)) ? s : l[e];
                if (r = typeof i, "string" === r && (s = ui.exec(i)) && (i = (s[1] + 1) * s[2] + parseFloat(se.css(t, e)), 
                r = "number"), null != i && i === i && ("number" !== r || se.cssNumber[a] || (i += "px"), 
                ie.clearCloneStyle || "" !== i || 0 !== e.indexOf("background") || (l[e] = "inherit"), 
                !(o && "set" in o && void 0 === (i = o.set(t, i, n))))) try {
                    l[e] = i;
                } catch (u) {}
            }
        },
        css: function(t, e, i, n) {
            ...
            return e = se.cssProps[a] || (se.cssProps[a] = N(t.style, a)), o = se.cssHooks[e] || se.cssHooks[a], 
            o && "get" in o && (r = o.get(t, !0, i)), void 0 === r && (r = ei(t, e, n)), "normal" === r && e in hi && (r = hi[e]), 
            "" === i || i ? (s = parseFloat(r), i === !0 || se.isNumeric(s) ? s || 0 : r) : r;
        }
        ...
        se.cssHooks[e] = {
            ...
            set: function(t, i, n) {
                var s = n && ti(t);
                return E(t, i, n ? M(t, e, n, ie.boxSizing && "border-box" === se.css(t, "boxSizing", !1, s), s) : 0);
            }
        };
        ...
        set: function(t, e) {
            var i = t.style, n = t.currentStyle, s = se.isNumeric(e) ? "alpha(opacity=" + 100 * e + ")" : "", r = n && n.filter || i.filter || "";
            i.zoom = 1, (e >= 1 || "" === e) && "" === se.trim(r.replace(ri, "")) && i.removeAttribute && (i.removeAttribute("filter"), 
            "" === e || n && !n.filter) || (i.filter = ri.test(r) ? r.replace(ri, s) : r + " " + s);
        }
        ...
        se.cssHooks[t + e] = {
            expand: function(i) {
                for (var n = 0, s = {}, r = "string" == typeof i ? i.split(" ") : [ i ]; 4 > n; n++) s[t + Ne[n] + e] = r[n] || r[n - 2] || r[0];
                return s;
            }
        ...
        init: function(t, e, i, n, s, r) {
            ...
            this.end = n, this.unit = r || (se.cssNumber[i] ? "" : "px");
        },
        cur: function() {
        ...
        run: function(t) {
            ...
            i && i.set ? i.set(this) : A.propHooks._default.set(this), this;
        }
    }, A.prototype.init.prototype = A.prototype, A.propHooks = {
        _default: {
            get: function(t) {
                var e;
                return null == t.elem[t.prop] || t.elem.style && null != t.elem.style[t.prop] ? (e = se.css(t.elem, t.prop, ""), 
    ...
    var pi, fi, mi = /^(?:toggle|show|hide)$/, gi = new RegExp("^(?:([+-])=|)(" + Se + ")([a-z%]*)$", "i"), vi = /queueHooks$/, bi = [ L ], yi = {
        "*": [ function(t, e) {
            var i = this.createTween(t, e), n = i.cur(), s = gi.exec(e), r = s && s[3] || (se.cssNumber[t] ? "" : "px"), o = (se.cssNumber[t] || "px" !== r && +n) && gi.exec(se.css(i.elem, t)), a = 1, l = 20;
            if (o && o[3] !== r) {
                r = r || o[3], s = s || [], o = +n || 1;
    ...
    se.Animation = se.extend($, {
        ...
        animate: function(t, e, i, n) {
            var s = se.isEmptyObject(t), r = se.speed(e, i, n), o = function() {
                var e = $(this, se.extend({}, t), r);
        ...
        stop: function(t, e, i) {
            ...
            this.each(function() {
                var e = !0, s = null != t && t + "queueHooks", r = se.timers, o = se._data(this);
                if (s) o[s] && o[s].stop && n(o[s]); else for (s in o) o[s] && o[s].stop && vi.test(s) && n(o[s]);
                for (s = r.length; s--; ) r[s].elem !== this || null != t && r[s].queue !== t || (r[s].anim.stop(i), 
                e = !1, r.splice(s, 1));
        ...
        finish: function(t) {
            return t !== !1 && (t = t || "fx"), this.each(function() {
                var e, i = se._data(this), n = i[t + "queue"], s = i[t + "queueHooks"], r = se.timers, o = n ? n.length : 0;
                for (i.finish = !0, se.queue(this, t, []), s && s.stop && s.stop.call(this, !0), 
        ...
        var t, e, i, n, s;
        e = fe.createElement("div"), e.setAttribute("className", "t"), e.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", 
        n = e.getElementsByTagName("a")[0], i = fe.createElement("select"), s = i.appendChild(fe.createElement("option")), 
        t = e.getElementsByTagName("input")[0], n.style.cssText = "top:1px", ie.getSetAttribute = "t" !== e.className, 
        ie.style = /top/.test(n.getAttribute("style")), ie.hrefNormalized = "/a" === n.getAttribute("href"), 
        ie.checkOn = !!t.value, ie.optSelected = s.selected, ie.enctype = !!fe.createElement("form").enctype, 
        i.disabled = !0, ie.optDisabled = !s.disabled, t = fe.createElement("input"), t.setAttribute("value", ""), 
        ie.input = "" === t.getAttribute("value"), t.value = "t", t.setAttribute("type", "radio"), 
    ...
    se.fn.extend({
        ...
        valHooks: {
            ...
            select: {
                get: function(t) {
                    for (var e, i, n = t.options, s = t.selectedIndex, r = "select-one" === t.type || 0 > s, o = r ? null : [], a = r ? s + 1 : n.length, l = 0 > s ? a : r ? s : 0; a > l; l++) if (i = n[l], 
                    !(!i.selected && l !== s || (ie.optDisabled ? i.disabled : null !== i.getAttribute("disabled")) || i.parentNode.disabled && se.nodeName(i.parentNode, "optgroup"))) {
                ...
                set: function(t, e) {
                    for (var i, n, s = t.options, r = se.makeArray(e), o = s.length; o--; ) if (n = s[o], 
                    se.inArray(se.valHooks.option.get(n), r) >= 0) try {
                        n.selected = i = !0;
                    } catch (a) {
                        n.scrollHeight;
                    } else n.selected = !1;
    ...
    var wi, xi, ki = se.expr.attrHandle, Ci = /^(?:checked|selected)$/i, Ti = ie.getSetAttribute, Si = ie.input;
    se.fn.extend({
        attr: function(t, e) {
        ...
        attr: function(t, e, i) {
            ...
            if (t && 3 !== r && 8 !== r && 2 !== r) return typeof t.getAttribute === ke ? se.prop(t, e, i) : (1 === r && se.isXMLDoc(t) || (e = e.toLowerCase(), 
            n = se.attrHooks[e] || (se.expr.match.bool.test(e) ? xi : wi)), void 0 === i ? n && "get" in n && null !== (s = n.get(t, e)) ? s : (s = se.find.attr(t, e), 
            null == s ? void 0 : s) : null !== i ? n && "set" in n && void 0 !== (s = n.set(t, i, e)) ? s : (t.setAttribute(e, i + ""), 
            i) : void se.removeAttr(t, e));
        },
        removeAttr: function(t, e) {
            var i, n, s = 0, r = e && e.match(ye);
            if (r && 1 === t.nodeType) for (;i = r[s++]; ) n = se.propFix[i] || i, se.expr.match.bool.test(i) ? Si && Ti || !Ci.test(i) ? t[n] = !1 : t[se.camelCase("default-" + i)] = t[n] = !1 : se.attr(t, i, ""), 
        ...
        set: function(t, e, i) {
            return e === !1 ? se.removeAttr(t, i) : Si && Ti || !Ci.test(i) ? t.setAttribute(!Ti && se.propFix[i] || i, i) : t[se.camelCase("default-" + i)] = t[i] = !0, 
            i;
        }
        ...
        ki[e] = Si && Ti || !Ci.test(e) ? function(t, e, n) {
            var s, r;
            return n || (r = ki[e], ki[e] = s, s = null != i(t, e, n) ? e.toLowerCase() : null, 
            ki[e] = r), s;
        } : function(t, e, i) {
    ...
    var Ni = /^(?:input|select|textarea|button|object)$/i, Di = /^(?:a|area)$/i;
    se.fn.extend({
        prop: function(t, e) {
        ...
        prop: function(t, e, i) {
            ...
            if (t && 3 !== o && 8 !== o && 2 !== o) return r = 1 !== o || !se.isXMLDoc(t), r && (e = se.propFix[e] || e, 
            s = se.propHooks[e]), void 0 !== i ? s && "set" in s && void 0 !== (n = s.set(t, i, e)) ? n : t[e] = i : s && "get" in s && null !== (n = s.get(t, e)) ? n : t[e];
        },
        propHooks: {
            tabIndex: {
                get: function(t) {
                    var e = se.find.attr(t, "tabindex");
                    return e ? parseInt(e, 10) : Ni.test(t.nodeName) || Di.test(t.nodeName) && t.href ? 0 : -1;
                }
            }
        }
    ...
    se.fn.extend({
        addClass: function(t) {
            var e, i, n, s, r, o, a = 0, l = this.length, u = "string" == typeof t && t;
            if (se.isFunction(t)) return this.each(function(e) {
                se(this).addClass(t.call(this, e, this.className));
            });
            if (u) for (e = (t || "").match(ye) || []; l > a; a++) if (i = this[a], n = 1 === i.nodeType && (i.className ? (" " + i.className + " ").replace(Ei, " ") : " ")) {
        ...
        removeClass: function(t) {
            var e, i, n, s, r, o, a = 0, l = this.length, u = 0 === arguments.length || "string" == typeof t && t;
            if (se.isFunction(t)) return this.each(function(e) {
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : this.each(se.isFunction(t) ? function(i) {
                ...
                if ("string" === i) for (var e, n = 0, s = se(this), r = t.match(ye) || []; e = r[n++]; ) s.hasClass(e) ? s.removeClass(e) : s.addClass(e); else (i === ke || "boolean" === i) && (this.className && se._data(this, "__className__", this.className), 
                this.className = this.className || t === !1 ? "" : se._data(this, "__className__") || "");
            });
        },
        hasClass: function(t) {
            for (var e = " " + t + " ", i = 0, n = this.length; n > i; i++) if (1 === this[i].nodeType && (" " + this[i].className + " ").replace(Ei, " ").indexOf(e) >= 0) return !0;
            return !1;
        }
    ...
    se.parseJSON = function(e) {
        ...
        return s && !se.trim(s.replace(Ai, function(t, e, s, r) {
    ...
    var Ii, Oi, Fi = /#.*$/, Li = /([?&])_=[^&]*/, Hi = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, $i = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, zi = /^(?:GET|HEAD)$/, ji = /^\/\//, Ri = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Wi = {}, qi = {}, Bi = "*/".concat("*");
    try {
        Oi = location.href;
    } catch (Vi) {
        Oi = fe.createElement("a"), Oi.href = "", Oi = Oi.href;
    }
    Ii = Ri.exec(Oi.toLowerCase()) || [], se.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function(t, e) {
            function i(t, e, i, n) {
                var s, c, v, b, _, x = e;
                2 !== y && (y = 2, a && clearTimeout(a), u = void 0, o = n || "", w.readyState = t > 0 ? 4 : 0, 
                s = t >= 200 && 300 > t || 304 === t, i && (b = W(h, w, i)), b = q(h, b, w, s), 
                s ? (h.ifModified && (_ = w.getResponseHeader("Last-Modified"), _ && (se.lastModified[r] = _), 
                _ = w.getResponseHeader("etag"), _ && (se.etag[r] = _)), 204 === t || "HEAD" === h.type ? x = "nocontent" : 304 === t ? x = "notmodified" : (x = b.state, 
                c = b.data, v = b.error, s = !v)) : (v = x, (t || !x) && (x = "error", 0 > t && (t = 0))), 
                w.status = t, w.statusText = (e || x) + "", s ? f.resolveWith(d, [ c, x, w ]) : f.rejectWith(d, [ w, x, v ]), 
                w.statusCode(g), g = void 0, l && p.trigger(s ? "ajaxSuccess" : "ajaxError", [ w, h, s ? c : v ]), 
                m.fireWith(d, [ w, x ]), l && (p.trigger("ajaxComplete", [ w, h ]), --se.active || se.event.trigger("ajaxStop")));
            }
            "object" == typeof t && (e = t, t = void 0), e = e || {};
            var n, s, r, o, a, l, u, c, h = se.ajaxSetup({}, e), d = h.context || h, p = h.context && (d.nodeType || d.jquery) ? se(d) : se.event, f = se.Deferred(), m = se.Callbacks("once memory"), g = h.statusCode || {}, v = {}, b = {}, y = 0, _ = "canceled", w = {
                readyState: 0,
            ...
            if (f.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, h.url = ((t || h.url || Oi) + "").replace(Fi, "").replace(ji, Ii[1] + "//"), 
            h.type = e.method || e.type || h.method || h.type, h.dataTypes = se.trim(h.dataType || "*").toLowerCase().match(ye) || [ "" ], 
            null == h.crossDomain && (n = Ri.exec(h.url.toLowerCase()), h.crossDomain = !(!n || n[1] === Ii[1] && n[2] === Ii[2] && (n[3] || ("http:" === n[1] ? "80" : "443")) === (Ii[3] || ("http:" === Ii[1] ? "80" : "443")))), 
            h.data && h.processData && "string" != typeof h.data && (h.data = se.param(h.data, h.traditional)), 
            j(Wi, h, e, w), 2 === y) return w;
            l = h.global, l && 0 === se.active++ && se.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), 
            h.hasContent = !zi.test(h.type), r = h.url, h.hasContent || (h.data && (r = h.url += (Pi.test(r) ? "&" : "?") + h.data, 
            delete h.data), h.cache === !1 && (h.url = Li.test(r) ? r.replace(Li, "$1_=" + Mi++) : r + (Pi.test(r) ? "&" : "?") + "_=" + Mi++)), 
            h.ifModified && (se.lastModified[r] && w.setRequestHeader("If-Modified-Since", se.lastModified[r]), 
            se.etag[r] && w.setRequestHeader("If-None-Match", se.etag[r])), (h.data && h.hasContent && h.contentType !== !1 || e.contentType) && w.setRequestHeader("Content-Type", h.contentType), 
            w.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Bi + "; q=0.01" : "") : h.accepts["*"]);
    ...
    se.param = function(t, e) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var t = this.type;
                return this.name && !se(this).is(":disabled") && Ji.test(this.nodeName) && !Ki.test(t) && (this.checked || !Me.test(t));
            }).map(function(t, e) {
                var i = se(this).val();
    ...
    var Gi = 0, Qi = {}, Zi = se.ajaxSettings.xhr();
    t.ActiveXObject && se(t).on("unload", function() {
            ...
            return {
                send: function(i, n) {
                    ...
                    r.send(t.hasContent && t.data || null), e = function(i, s) {
                        var a, l, u;
                        if (e && (s || 4 === r.readyState)) if (delete Qi[o], e = void 0, r.onreadystatechange = se.noop, 
                    ...
                    }, t.async ? 4 === r.readyState ? setTimeout(e) : r.onreadystatechange = Qi[o] = e : e();
                },
                abort: function() {
                    e && e(void 0, !0);
                }
        ...
        if (t.crossDomain) {
            ...
            return {
                send: function(n, s) {
                    e = fe.createElement("script"), e.async = !0, t.scriptCharset && (e.charset = t.scriptCharset), 
    ...
    se.ajaxSetup({
        ...
        return a || "jsonp" === e.dataTypes[0] ? (s = e.jsonpCallback = se.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, 
        a ? e[a] = e[a].replace(en, "$1" + s) : e.jsonp !== !1 && (e.url += (Pi.test(e.url) ? "&" : "?") + e.jsonp + "=" + s), 
        e.converters["script json"] = function() {
            return o || se.error(s + " was not called"), o[0];
        }, e.dataTypes[0] = "json", r = t[s], t[s] = function() {
            o = arguments;
        }, n.always(function() {
            t[s] = r, e[s] && (e.jsonpCallback = i.jsonpCallback, tn.push(s)), o && se.isFunction(r) && r(o[0]), 
            o = r = void 0;
        }), "script") : void 0;
        ...
        var n = he.exec(t), s = !i && [];
        return n ? [ e.createElement(n[1]) ] : (n = se.buildFragment([ t ], e, s), s && s.length && se(s).remove(), 
    ...
    se.fn.load = function(t, e, i) {
        ...
        return a >= 0 && (n = se.trim(t.slice(a, t.length)), t = t.slice(0, a)), se.isFunction(e) ? (i = e, 
        e = void 0) : e && "object" == typeof e && (r = "POST"), o.length > 0 && se.ajax({
            url: t,
            type: r,
            dataType: "html",
            data: e
    ...
    se.offset = {
        setOffset: function(t, e, i) {
            var n, s, r, o, a, l, u, c = se.css(t, "position"), h = se(t), d = {};
            "static" === c && (t.style.position = "relative"), a = h.offset(), r = se.css(t, "top"), 
            l = se.css(t, "left"), u = ("absolute" === c || "fixed" === c) && se.inArray("auto", [ r, l ]) > -1, 
            u ? (n = h.position(), o = n.top, s = n.left) : (o = parseFloat(r) || 0, s = parseFloat(l) || 0), 
            se.isFunction(e) && (e = e.call(t, i, a)), null != e.top && (d.top = e.top - a.top + o), 
            null != e.left && (d.left = e.left - a.left + s), "using" in e ? e.using.call(t, d) : h.css(d);
        }
    }, se.fn.extend({
        offset: function(t) {
            ...
            if (r) return e = r.documentElement, se.contains(e, s) ? (typeof s.getBoundingClientRect !== ke && (n = s.getBoundingClientRect()), 
            i = X(r), {
        ...
        position: function() {
            if (this[0]) {
                ...
                return "fixed" === se.css(n, "position") ? e = n.getBoundingClientRect() : (t = this.offsetParent(), 
                e = this.offset(), se.nodeName(t[0], "html") || (i = t.offset()), i.top += se.css(t[0], "borderTopWidth", !0), 
                i.left += se.css(t[0], "borderLeftWidth", !0)), {
        ...
        se.each({
            ...
            se.fn[n] = function(n, s) {
                ...
                return Ee(this, function(e, i, n) {
                    var s;
                    return se.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (s = e.documentElement, 
                    Math.max(e.body["scroll" + t], s["scroll" + t], e.body["offset" + t], s["offset" + t], s["client" + t])) : void 0 === n ? se.css(e, i, o) : se.style(e, i, n, o);
                }, e, r ? n : void 0, r, null);
            };
        });
    }), se.fn.size = function() {
    ...
    {
        var s = t.Backbone, r = [], o = (r.push, r.slice);
        r.splice;
    }
    ...
    var a = e.Events = {
        ...
        off: function(t, e, n) {
            ...
            for (a = t ? [ t ] : i.keys(this._events), l = 0, c = a.length; c > l; l++) if (t = a[l], 
            o = this._events[t]) {
                if (this._events[t] = s = [], e || n) for (h = 0, d = o.length; d > h; h++) r = o[h], 
        ...
        stopListening: function(t, e, n) {
            ...
            for (var o in s) t = s[o], t.off(e, n, this), (r || i.isEmpty(t._events)) && delete this._listeningTo[o];
            return this;
        }
    }, l = /\s+/, u = function(t, e, i, n) {
        if (!i) return !0;
        if ("object" == typeof i) {
        ...
        if (l.test(i)) {
            for (var r = i.split(l), o = 0, a = r.length; a > o; o++) t[e].apply(t, [ r[o] ].concat(n));
            return !1;
        }
        return !0;
    }, c = function(t, e) {
    ...
    i.each(h, function(t, e) {
        a[e] = function(e, n, s) {
            var r = this._listeningTo || (this._listeningTo = {}), o = e._listenId || (e._listenId = i.uniqueId("l"));
            return r[o] = e, s || "object" != typeof n || (s = this), e[t](n, s, this), this;
        };
    }), a.bind = a.on, a.unbind = a.off, i.extend(e, a);
    var d = e.Model = function(t, e) {
        var n = t || {};
        e || (e = {}), this.cid = i.uniqueId("c"), this.attributes = {}, e.collection && (this.collection = e.collection), 
        e.parse && (n = this.parse(n, e) || {}), n = i.defaults({}, n, i.result(this, "defaults")), 
    ...
    i.extend(d.prototype, a, {
        ...
        set: function(t, e, n) {
            ...
            o = n.unset, l = n.silent, a = [], u = this._changing, this._changing = !0, u || (this._previousAttributes = i.clone(this.attributes), 
            this.changed = {}), h = this.attributes, c = this._previousAttributes, this.idAttribute in r && (this.id = r[this.idAttribute]);
            for (s in r) e = r[s], i.isEqual(h[s], e) || a.push(s), i.isEqual(c[s], e) ? delete this.changed[s] : this.changed[s] = e, 
            o ? delete h[s] : h[s] = e;
            if (!l) {
                a.length && (this._pending = n);
                for (var d = 0, p = a.length; p > d; d++) this.trigger("change:" + a[d], this, h[a[d]], n);
            }
            if (u) return this;
        ...
        save: function(t, e, n) {
            ...
            return n.success = function(t) {
                l.attributes = a;
                var e = l.parse(t, n);
                return n.wait && (e = i.extend(s || {}, e)), i.isObject(e) && !l.set(e, n) ? !1 : (u && u(l, t, n), 
                void l.trigger("sync", l, t, n));
            }, H(this, n), r = this.isNew() ? "create" : n.patch ? "patch" : "update", "patch" === r && (n.attrs = s), 
    ...
    var f = e.Collection = function(t, e) {
        ...
        this._reset(), this.initialize.apply(this, arguments), t && this.reset(t, i.extend({
            silent: !0
        }, e));
    }, m = {
        add: !0,
    ...
    i.extend(f.prototype, a, {
        ...
        remove: function(t, e) {
            ...
            t = n ? [ t ] : i.clone(t), e || (e = {});
            var s, r, o, a;
            for (s = 0, r = t.length; r > s; s++) a = t[s] = this.get(t[s]), a && (delete this._byId[a.id], 
            delete this._byId[a.cid], o = this.indexOf(a), this.models.splice(o, 1), this.length--, 
            e.silent || (e.index = o, a.trigger("remove", a, this, e)), this._removeReference(a, e));
            return n ? t[0] : t;
        },
        set: function(t, e) {
            ...
            var n = !i.isArray(t);
            t = n ? t ? [ t ] : [] : i.clone(t);
            var s, r, o, a, l, u, c, h = e.at, p = this.model, f = this.comparator && null == h && e.sort !== !1, g = i.isString(this.comparator) ? this.comparator : null, v = [], b = [], y = {}, _ = e.add, w = e.merge, x = e.remove, k = !f && _ && x ? [] : !1;
            for (s = 0, r = t.length; r > s; s++) {
                if (l = t[s] || {}, o = l instanceof d ? a = l : l[p.prototype.idAttribute || "id"], 
                u = this.get(o)) x && (y[u.cid] = !0), w && (l = l === a ? a.attributes : l, e.parse && (l = u.parse(l, e)), 
                u.set(l, e), f && !c && u.hasChanged(g) && (c = !0)), t[s] = u; else if (_) {
                    if (a = t[s] = this._prepareModel(l, e), !a) continue;
                    v.push(a), this._addReference(a, e);
                }
                a = u || a, !k || !a.isNew() && y[a.id] || k.push(a), y[a.id] = !0;
            }
            if (x) {
                for (s = 0, r = this.length; r > s; ++s) y[(a = this.models[s]).cid] || b.push(a);
                b.length && this.remove(b, e);
            }
            if (v.length || k && k.length) if (f && (c = !0), this.length += v.length, null != h) for (s = 0, 
            r = v.length; r > s; s++) this.models.splice(h + s, 0, v[s]); else {
                k && (this.models.length = 0);
                var C = k || v;
                for (s = 0, r = C.length; r > s; s++) this.models.push(C[s]);
            }
            if (c && this.sort({
                silent: !0
            }), !e.silent) {
                for (s = 0, r = v.length; r > s; s++) (a = v[s]).trigger("add", a, this, e);
        ...
        sort: function(t) {
            ...
            return t || (t = {}), i.isString(this.comparator) || 1 === this.comparator.length ? this.models = this.sortBy(this.comparator, this) : this.models.sort(i.bind(this.comparator, this)), 
    ...
    var y = e.View = function(t) {
        this.cid = i.uniqueId("view"), t || (t = {}), i.extend(this, i.pick(t, w)), this._ensureElement(), 
    ...
    i.extend(y.prototype, a, {
        ...
        setElement: function(t, i) {
            ...
            this.el = this.$el[0], i !== !1 && this.delegateEvents(), this;
        },
        ...
        if (s.url || (o.url = i.result(n, "url") || L()), null != s.data || !n || "create" !== t && "update" !== t && "patch" !== t || (o.contentType = "application/json", 
    ...
    var x = !("undefined" == typeof window || !window.ActiveXObject || window.XMLHttpRequest && new XMLHttpRequest().dispatchEvent), k = {
        create: "POST",
        update: "PUT",
        patch: "PATCH",
        "delete": "DELETE",
    ...
    }, T = /\((.*?)\)/g, S = /(\(\?)?:\w+/g, N = /\*\w+/g, D = /[\-{}\[\]+?.,\\\^$|#\s]/g;
    i.extend(C.prototype, a, {
        initialize: function() {},
        route: function(t, n, s) {
            i.isRegExp(t) || (t = this._routeToRegExp(t)), i.isFunction(n) && (s = n, n = ""), 
            s || (s = this[n]);
            var r = this;
        ...
        _routeToRegExp: function(t) {
            return t = t.replace(D, "\\$&").replace(T, "(?:$1)?").replace(S, function(t, e) {
                return e ? t : "([^/?]+)";
    ...
    E.started = !1, i.extend(E.prototype, a, {
        ...
        start: function(t) {
            ...
            if (this.root = ("/" + this.root + "/").replace(P, "/"), r && this._wantsHashChange) {
    ...
    var F = function(t, e) {
        ...
        return r.prototype = s.prototype, n.prototype = new r(), t && i.extend(n.prototype, t), 
        n.__super__ = s.prototype, n;
    };
    d.extend = f.extend = C.extend = y.extend = E.extend = F;
    var L = function() {
    ...
    var e, i, n, s, r, o = [ "Msxml2.XMLHTTP", "Microsoft.XMLHTTP", "Msxml2.XMLHTTP.4.0" ], a = /^\s*<\?xml(\s)+version=[\'\"](\d)*.(\d)*[\'\"](\s)*\?>/im, l = /<body[^>]*>\s*([\s\S]+)\s*<\/body>/im, u = "undefined" != typeof location && location.href, c = u && location.protocol && location.protocol.replace(/\:/, ""), h = u && location.hostname, d = u && (location.port || void 0), p = {}, f = t.config && t.config() || {};
    return e = {
        version: "2.0.12",
        strip: function(t) {
            if (t) {
        ...
        parseName: function(t) {
            var e, i, n, s = !1, r = t.indexOf("."), o = 0 === t.indexOf("./") || 0 === t.indexOf("../");
            return -1 !== r && (!o || r > 1) ? (e = t.substring(0, r), i = t.substring(r + 1, t.length)) : e = t, 
            n = i || e, r = n.indexOf("!"), -1 !== r && (s = "strip" === n.substring(r + 1), 
            n = n.substring(0, r), i ? i = n : e = n), {
                moduleName: e,
                ext: i,
                strip: s
            };
        ...
        load: function(t, i, n, s) {
            ...
            var r = e.parseName(t), o = r.moduleName + (r.ext ? "." + r.ext : ""), a = i.toUrl(o), l = f.useXhr || e.useXhr;
            return 0 === a.indexOf("empty:") ? void n() : void (!u || l(a, c, h, d) ? e.get(a, function(i) {
        ...
        writeFile: function(t, i, n, s, r) {
            var o = e.parseName(i), a = o.ext ? "." + o.ext : "", l = o.moduleName + a, u = n.toUrl(o.moduleName + a) + ".js";
            e.load(l, n, function() {
                var i = function(t) {
                    return s(u, t);
                };
    ...
    }, "node" === f.env || !f.env && "undefined" != typeof process && process.versions && process.versions.node && !process.versions["node-webkit"] ? (i = require.nodeRequire("fs"), 
    e.get = function(t, e, n) {
        ...
        var r, o = e.createXhr();
        if (o.open("GET", t, !0), s) for (r in s) s.hasOwnProperty(r) && o.setRequestHeader(r.toLowerCase(), s[r]);
        f.onXhr && f.onXhr(o, t), o.onreadystatechange = function() {
            var e, s;
            4 === o.readyState && (e = o.status || 0, e > 399 && 600 > e ? (s = new Error(t + " HTTP status: " + e), 
            s.xhr = o, n && n(s)) : i(o.responseText), f.onXhrComplete && f.onXhrComplete(o, t));
        }, o.send(null);
    } : "rhino" === f.env || !f.env && "undefined" != typeof Packages && "undefined" != typeof java ? e.get = function(t, e) {
        var i, n, s = "utf-8", r = new java.io.File(t), o = java.lang.System.getProperty("line.separator"), a = new java.io.BufferedReader(new java.io.InputStreamReader(new java.io.FileInputStream(r), s)), l = "";
        try {
        ...
        e(l);
    } : ("xpconnect" === f.env || !f.env && "undefined" != typeof Components && Components.classes && Components.interfaces) && (n = Components.classes, 
    s = Components.interfaces, Components.utils["import"]("resource://gre/modules/FileUtils.jsm"), 
    r = "@mozilla.org/windows-registry-key;1" in n, e.get = function(t, e) {
        var i, o, a, l = {};
        r && (t = t.replace(/\//g, "\\")), a = new FileUtils.File(t);
        try {
            i = n["@mozilla.org/network/file-input-stream;1"].createInstance(s.nsIFileInputStream), 
            i.init(a, 1, 0, !1), o = n["@mozilla.org/intl/converter-input-stream;1"].createInstance(s.nsIConverterInputStream), 
            o.init(i, "utf-8", i.available(), s.nsIConverterInputStream.DEFAULT_REPLACEMENT_CHARACTER), 
            o.readString(i.available(), l), o.close(), i.close(), e(l.value);
        } catch (u) {
            throw new Error((a && a.path || "") + ": " + u);
        }
    }), e;
}), define("text!views/../../templates/main/panel.html", [], function() {
    return '<div class="nano-content">\r\n    <h1 class="center" data-i18n="label.field"></h1>\r\n    <% for (var n in list) { %>\r\n        <div class="row">\r\n            <div class="col-md-10 col-md-offset-1 fields" data-type="<%= n.replace(" Field ", " ") %>" data-i18n="fields.<%= list[n]["i18n"] %>">\r\n                <%= list[n]["i18n"] %>\r\n            </div>\r\n        </div>\r\n        <%}; %>\r\n</div>\r\n';
}), function() {
    function t(t, e) {
    ...
    function e(t, i) {
        for (var n in i) n in t ? e(t[n], i[n]) : t[n] = i[n];
        return t;
    }
    function i(t, e, i) {
        var n, s = 0, r = t.length, o = void 0 === r || "[object Array]" !== Object.prototype.toString.apply(t) || "function" == typeof t;
        if (i) if (o) {
            for (n in t) if (e.apply(t[n], i) === !1) break;
        } else for (;r > s && e.apply(t[s++], i) !== !1; ) ; else if (o) {
            for (n in t) if (e.call(t[n], n, t[n]) === !1) break;
        } else for (;r > s && e.call(t[s], s, t[s++]) !== !1; ) ;
        return t;
    }
    function n(t) {
    ...
    function s(t) {
        var e = function(t) {
            ...
            t = n(t);
            var i, s, r, o, a, l, u, c = "", h = 0;
            do i = t.charCodeAt(h++), s = t.charCodeAt(h++), r = t.charCodeAt(h++), o = i >> 2, 
            a = (3 & i) << 4 | s >> 4, l = (15 & s) << 2 | r >> 6, u = 63 & r, isNaN(s) ? l = u = 64 : isNaN(r) && (u = 64), 
            c += e.charAt(o) + e.charAt(a) + e.charAt(l) + e.charAt(u), i = s = r = "", o = a = l = u = ""; while (h < t.length);
            return c;
        }, r = function() {
            ...
            "function" == typeof s && (a = s, s = {}), s.cache = s.cache || !1, s.data = s.data || {}, 
            s.headers = s.headers || {}, s.jsonp = s.jsonp || !1, s.async = void 0 === s.async ? !0 : s.async;
            var l, u = r({
                accept: "*/*",
                "content-type": "application/x-www-form-urlencoded;charset=UTF-8"
            }, o.headers, s.headers);
            if (l = "application/json" === u["content-type"] ? JSON.stringify(s.data) : i(s.data), 
            "GET" === t) {
                var c = [];
                if (l && (c.push(l), l = null), s.cache || c.push("_=" + new Date().getTime()), 
                s.jsonp && (c.push("callback=" + s.jsonp), c.push("jsonp=" + s.jsonp)), c = c.join("&"), 
                c.length > 1 && (n += n.indexOf("?") > -1 ? "&" + c : "?" + c), s.jsonp) {
                    var h = document.getElementsByTagName("head")[0], d = document.createElement("script");
                    return d.type = "text/javascript", d.src = n, void h.appendChild(d);
                }
            }
            e(function(e, i) {
                if (e) return a(e);
                i.open(t, n, s.async);
                for (var r in u) u.hasOwnProperty(r) && i.setRequestHeader(r, u[r]);
            ...
            authBasic: function(t, e) {
                o.headers.Authorization = "Basic " + s(t + ":" + e);
            },
            connect: function(t, e, i) {
                return o("CONNECT", t, e, i);
            },
            del: function(t, e, i) {
                return o("DELETE", t, e, i);
            },
            get: function(t, e, i) {
                return o("GET", t, e, i);
            },
            ...
            isAllowed: function(t, e, i) {
                this.options(t, function(t, n) {
                    i(-1 !== n.text().indexOf(e));
                });
            },
            options: function(t, e, i) {
                return o("OPTIONS", t, e, i);
            },
            patch: function(t, e, i) {
                return o("PATCH", t, e, i);
            },
            post: function(t, e, i) {
                return o("POST", t, e, i);
            },
            ...
            trace: function(t, e, i) {
                return o("TRACE", t, e, i);
            }
        }, l = t.type ? t.type.toLowerCase() : "get";
        a[l](t.url, t, function(e, i) {
            200 === e || 0 === e && i.text() ? t.success(i.json(), e, null) : t.error(i.text(), e, null);
        });
    }
    function r(t, e) {
        "function" == typeof t && (e = t, t = {}), t = t || {}, q.extend(z, t), delete z.fixLng, 
        "string" == typeof z.ns && (z.ns = {
            namespaces: [ z.ns ],
            defaultNs: z.ns
        }), "string" == typeof z.fallbackNS && (z.fallbackNS = [ z.fallbackNS ]), ("string" == typeof z.fallbackLng || "boolean" == typeof z.fallbackLng) && (z.fallbackLng = [ z.fallbackLng ]), 
        z.interpolationPrefixEscaped = q.regexEscape(z.interpolationPrefix), z.interpolationSuffixEscaped = q.regexEscape(z.interpolationSuffix), 
        z.lng || (z.lng = q.detectLanguage()), F = q.toLanguages(z.lng), E = F[0], q.log("currentLng set to: " + E), 
        z.useCookie && q.cookie.read(z.cookieName) !== E && q.cookie.create(z.cookieName, E, z.cookieExpirationTime, z.cookieDomain), 
        z.detectLngFromLocalStorage && "undefined" != typeof document && window.localstorage && window.localStorage.setItem("i18next_lng", E);
        var i = k;
        t.fixLng && (i = function(t, e) {
            return e = e || {}, e.lng = e.lng || i.lng, k(t, e);
        }, i.lng = E), B.setCurrentLng(E), P && z.setJqueryExt && g();
        var n;
        if (P && P.Deferred && (n = P.Deferred()), !z.resStore) {
            var s = q.toLanguages(z.lng);
            "string" == typeof z.preload && (z.preload = [ z.preload ]);
            for (var r = 0, o = z.preload.length; o > r; r++) for (var a = q.toLanguages(z.preload[r]), l = 0, u = a.length; u > l; l++) s.indexOf(a[l]) < 0 && s.push(a[l]);
            return A.sync.load(s, z, function(t, s) {
                I = s, L = !0, e && e(i), n && n.resolve(i);
            }), n ? n.promise() : void 0;
        }
        return I = z.resStore, L = !0, e && e(i), n && n.resolve(i), n ? n.promise() : void 0;
    }
    function o(t, e) {
        "string" == typeof t && (t = [ t ]);
        for (var i = 0, n = t.length; n > i; i++) z.preload.indexOf(t[i]) < 0 && z.preload.push(t[i]);
        return r(e);
    }
    function a(t, e, i, n) {
        "string" != typeof e ? (i = e, e = z.ns.defaultNs) : z.ns.namespaces.indexOf(e) < 0 && z.ns.namespaces.push(e), 
        I[t] = I[t] || {}, I[t][e] = I[t][e] || {}, n ? q.deepExtend(I[t][e], i) : q.extend(I[t][e], i);
    }
    function l(t, e) {
        "string" != typeof e && (e = z.ns.defaultNs), I[t] = I[t] || {}, I[t][e] = {};
    }
    function u(t, e, i, n) {
        "string" != typeof e ? (resource = e, e = z.ns.defaultNs) : z.ns.namespaces.indexOf(e) < 0 && z.ns.namespaces.push(e), 
        I[t] = I[t] || {}, I[t][e] = I[t][e] || {};
        for (var s = i.split(z.keyseparator), r = 0, o = I[z.lng][e]; s[r]; ) r == s.length - 1 ? o[s[r]] = n : (null == o[s[r]] && (o[s[r]] = {}), 
        o = o[s[r]]), r++;
    }
    function c(t, e, i) {
        "string" != typeof e ? (resource = e, e = z.ns.defaultNs) : z.ns.namespaces.indexOf(e) < 0 && z.ns.namespaces.push(e);
        for (var n in i) "string" == typeof i[n] && u(t, e, n, i[n]);
    }
    function h(t) {
        z.ns.defaultNs = t;
    }
    ...
    function p(t, e) {
        var i = {
            dynamicLoad: z.dynamicLoad,
            resGetPath: z.resGetPath,
            getAsync: z.getAsync,
            customLoad: z.customLoad,
            ns: {
                namespaces: t,
                defaultNs: ""
            }
        }, n = q.toLanguages(z.lng);
        "string" == typeof z.preload && (z.preload = [ z.preload ]);
        for (var s = 0, r = z.preload.length; r > s; s++) for (var o = q.toLanguages(z.preload[s]), a = 0, l = o.length; l > a; a++) n.indexOf(o[a]) < 0 && n.push(o[a]);
        for (var u = [], c = 0, h = n.length; h > c; c++) {
            var d = !1, p = I[n[c]];
            if (p) for (var f = 0, m = t.length; m > f; f++) p[t[f]] || (d = !0); else d = !0;
            d && u.push(n[c]);
        }
        u.length ? A.sync._fetch(u, i, function(i, n) {
            var s = t.length * u.length;
            q.each(t, function(t, i) {
                z.ns.namespaces.indexOf(i) < 0 && z.ns.namespaces.push(i), q.each(u, function(t, r) {
                    I[r] = I[r] || {}, I[r][i] = n[r][i], s--, 0 === s && e && (z.useLocalStorage && A.sync._storeLocal(I), 
                    e());
                });
            });
        }) : e && e();
    ...
    function f(t, e, i) {
        return "function" == typeof e ? (i = e, e = {}) : e || (e = {}), e.lng = t, r(e, i);
    }
    function m() {
        return E;
    }
    function g() {
        function t(t, e, i) {
            if (0 !== e.length) {
                ...
                if (0 === e.indexOf("[")) {
                    var s = e.split("]");
                    e = s[1], n = s[0].substr(1, s[0].length - 1);
                }
                e.indexOf(";") === e.length - 1 && (e = e.substr(0, e.length - 2));
                var r;
                if ("html" === n) r = z.defaultValueFromContent ? P.extend({
                    defaultValue: t.html()
                }, i) : i, t.html(P.t(e, r)); else if ("text" === n) r = z.defaultValueFromContent ? P.extend({
                    defaultValue: t.text()
                }, i) : i, t.text(P.t(e, r)); else if ("prepend" === n) r = z.defaultValueFromContent ? P.extend({
                    defaultValue: t.html()
                }, i) : i, t.prepend(P.t(e, r)); else if ("append" === n) r = z.defaultValueFromContent ? P.extend({
                    defaultValue: t.html()
                }, i) : i, t.append(P.t(e, r)); else if (0 === n.indexOf("data-")) {
                    var o = n.substr("data-".length);
                    r = z.defaultValueFromContent ? P.extend({
                        defaultValue: t.data(o)
                    }, i) : i;
                    var a = P.t(e, r);
                    t.data(o, a), t.attr(n, a);
                } else r = z.defaultValueFromContent ? P.extend({
                    defaultValue: t.attr(n)
                }, i) : i, t.attr(n, P.t(e, r));
            }
        }
        function e(e, i) {
            var n = e.attr(z.selectorAttr);
            if (n || "undefined" == typeof n || n === !1 || (n = e.text() || e.val()), n) {
                var s = e, r = e.data("i18n-target");
                if (r && (s = e.find(r) || e), i || z.useDataAttrOptions !== !0 || (i = e.data("i18n-options")), 
                i = i || {}, n.indexOf(";") >= 0) {
                    var o = n.split(";");
                    P.each(o, function(e, n) {
                        "" !== n && t(s, n, i);
                    });
                } else t(s, n, i);
                z.useDataAttrOptions === !0 && e.data("i18n-options", i);
            }
        }
        P.t = P.t || k, P.fn.i18n = function(t) {
            return this.each(function() {
                e(P(this), t);
                var i = P(this).find("[" + z.selectorAttr + "]");
                i.each(function() {
                    e(P(this), t);
                });
            });
    ...
    function v(t, e, i, n) {
        if (!t) return t;
        if (n = n || e, t.indexOf(n.interpolationPrefix || z.interpolationPrefix) < 0) return t;
        var s = n.interpolationPrefix ? q.regexEscape(n.interpolationPrefix) : z.interpolationPrefixEscaped, r = n.interpolationSuffix ? q.regexEscape(n.interpolationSuffix) : z.interpolationSuffixEscaped, o = "HTML" + r, a = e.replace && "object" == typeof e.replace ? e.replace : e;
        return q.each(a, function(e, a) {
            var l = i ? i + z.keyseparator + e : e;
            "object" == typeof a && null !== a ? t = v(t, a, l, n) : n.escapeInterpolation || z.escapeInterpolation ? (t = t.replace(new RegExp([ s, l, o ].join(""), "g"), q.regexReplacementEscape(a)), 
            t = t.replace(new RegExp([ s, l, r ].join(""), "g"), q.regexReplacementEscape(q.escape(a)))) : t = t.replace(new RegExp([ s, l, r ].join(""), "g"), q.regexReplacementEscape(a));
        }), t;
    }
    function b(t, e) {
        var i = ",", n = "{", s = "}", r = q.extend({}, e);
        for (delete r.postProcess; -1 != t.indexOf(z.reusePrefix) && (O++, !(O > z.maxRecursion)); ) {
            var o = t.lastIndexOf(z.reusePrefix), a = t.indexOf(z.reuseSuffix, o) + z.reuseSuffix.length, l = t.substring(o, a), u = l.replace(z.reusePrefix, "").replace(z.reuseSuffix, "");
            if (o >= a) return q.error("there is an missing closing in following translation value", t), 
            "";
            if (-1 != u.indexOf(i)) {
                var c = u.indexOf(i);
                if (-1 != u.indexOf(n, c) && -1 != u.indexOf(s, c)) {
                    var h = u.indexOf(n, c), d = u.indexOf(s, h) + s.length;
                    try {
                        r = q.extend(r, JSON.parse(u.substring(h, d))), u = u.substring(0, c);
                    } catch (p) {}
                }
            }
            var f = S(u, r);
            t = t.replace(l, q.regexReplacementEscape(f));
        }
        return t;
    }
    function y(t) {
    ...
    function _(t, e) {
        return void 0 !== t.count && "string" != typeof t.count && B.needsPlural(e, t.count);
    }
    function w(t) {
        return void 0 !== t.indefinite_article && "string" != typeof t.indefinite_article && t.indefinite_article;
    }
    function x(t, e) {
        e = e || {};
        var i = C(t, e), n = N(t, e);
    ...
    function k(t, e) {
        return e = e || {}, L ? (O = 0, S.apply(null, arguments)) : (q.log("i18next not finished initialization. you might have called t function before loading resources finished."), 
        e.defaultValue || "");
    }
    function C(t, e) {
    ...
    function S(t, e) {
        if (e && "object" != typeof e ? "sprintf" === z.shortcutFunction ? e = T.apply(null, arguments) : "defaultValue" === z.shortcutFunction && (e = {
            defaultValue: e
        }) : e = e || {}, void 0 === t || null === t || "" === t) return "";
        "string" == typeof t && (t = [ t ]);
        var i = t[0];
        if (t.length > 1) for (var n = 0; n < t.length && (i = t[n], !x(i, e)); n++) ;
        var s, r = C(i, e), o = N(i, e), a = e.lng ? q.toLanguages(e.lng, e.fallbackLng) : F, l = e.ns || z.ns.defaultNs;
        i.indexOf(z.nsseparator) > -1 && (s = i.split(z.nsseparator), l = s[0], i = s[1]), 
        void 0 === o && z.sendMissing && "function" == typeof z.missingKeyHandler && (e.lng ? z.missingKeyHandler(a[0], l, i, r, a) : z.missingKeyHandler(z.lng, l, i, r, a));
        var u = e.postProcess || z.postProcess;
        void 0 !== o && u && V[u] && (o = V[u](o, i, e));
        var c = r;
        if (r.indexOf(z.nsseparator) > -1 && (s = r.split(z.nsseparator), c = s[1]), c === i && z.parseMissingKey && (r = z.parseMissingKey(r)), 
        void 0 === o && (r = v(r, e), r = b(r, e), u && V[u])) {
            var h = C(i, e);
            o = V[u](h, i, e);
        }
        return void 0 !== o ? o : r;
    ...
    function N(t, e) {
        ...
        var i, n, s = C(t, e), r = F;
        if (!I) return s;
        if ("cimode" === r[0].toLowerCase()) return s;
        if (e.lng && (r = q.toLanguages(e.lng, e.fallbackLng), !I[r[0]])) {
            var o = z.getAsync;
            z.getAsync = !1, A.sync.load(r, z, function(t, e) {
                q.extend(I, e), z.getAsync = o;
            });
        }
        var a = e.ns || z.ns.defaultNs;
        if (t.indexOf(z.nsseparator) > -1) {
            var l = t.split(z.nsseparator);
            a = l[0], t = l[1];
        }
        if (y(e)) {
            i = q.extend({}, e), delete i.context, i.defaultValue = z.contextNotFound;
            var u = a + z.nsseparator + t + "_" + e.context;
            if (n = k(u, i), n != z.contextNotFound) return v(n, {
                context: e.context
            });
        }
        if (_(e, r[0])) {
            i = q.extend({}, e), delete i.count, i.defaultValue = z.pluralNotFound;
            var c = a + z.nsseparator + t + z.pluralSuffix, h = B.get(r[0], e.count);
            if (h >= 0 ? c = c + "_" + h : 1 === h && (c = a + z.nsseparator + t), n = k(c, i), 
            n != z.pluralNotFound) return v(n, {
                count: e.count,
        ...
        if (w(e)) {
            ...
            var p = a + z.nsseparator + t + (e.count && !_(e, r[0]) || !e.count ? z.indefiniteSuffix : "");
            if (n = k(p, d), n != z.indefiniteNotFound) return n;
        }
        for (var f, m = t.split(z.keyseparator), g = 0, x = r.length; x > g && void 0 === f; g++) {
            for (var T = r[g], D = 0, E = I[T] && I[T][a]; m[D]; ) E = E && E[m[D]], D++;
            if (void 0 !== E) {
                var M = Object.prototype.toString.apply(E);
                if ("string" == typeof E) E = v(E, e), E = b(E, e); else if ("[object Array]" !== M || z.returnObjectTrees || e.returnObjectTrees) {
                    if (null === E && z.fallbackOnNull === !0) E = void 0; else if (null !== E) if (z.returnObjectTrees || e.returnObjectTrees) {
                        if ("[object Number]" !== M && "[object Function]" !== M && "[object RegExp]" !== M) {
                            var P = "[object Array]" === M ? [] : {};
                            q.each(E, function(i) {
                                P[i] = S(a + z.nsseparator + t + z.keyseparator + i, e);
                            }), E = P;
                        }
                    } else z.objectTreeKeyHandler && "function" == typeof z.objectTreeKeyHandler ? E = z.objectTreeKeyHandler(t, E, T, a, e) : (E = "key '" + a + ":" + t + " (" + T + ")' returned an object instead of string.", 
                    q.log(E));
                } else E = E.join("\n"), E = v(E, e), E = b(E, e);
                "string" == typeof E && "" === E.trim() && z.fallbackOnEmpty === !0 && (E = void 0), 
                f = E;
            }
        }
        if (void 0 === f && !e.isFallbackLookup && (z.fallbackToDefaultNS === !0 || z.fallbackNS && z.fallbackNS.length > 0)) {
            if (e.isFallbackLookup = !0, z.fallbackNS.length) {
                for (var O = 0, L = z.fallbackNS.length; L > O; O++) if (f = N(z.fallbackNS[O] + z.nsseparator + t, e)) {
                    var H = f.indexOf(z.nsseparator) > -1 ? f.split(z.nsseparator)[1] : f, $ = s.indexOf(z.nsseparator) > -1 ? s.split(z.nsseparator)[1] : s;
                    if (H !== $) break;
                }
            } else f = N(t, e);
            e.isFallbackLookup = !1;
        }
        return f;
    }
    function D() {
        ...
        if ("undefined" != typeof window && (!function() {
            for (var t = window.location.search.substring(1), i = t.split("&"), n = 0; n < i.length; n++) {
                var s = i[n].indexOf("=");
                if (s > 0) {
                    var r = i[n].substring(0, s), o = i[n].substring(s + 1);
                    e[r] = o;
                }
            }
        }(), e[z.detectLngQS] && (t = e[z.detectLngQS])), !t && "undefined" != typeof document && z.useCookie) {
            var i = q.cookie.read(z.cookieName);
            i && (t = i);
        }
        return !t && "undefined" != typeof document && window.localstorage && z.detectLngFromLocalStorage && (t = window.localStorage.getItem("i18next_lng")), 
        t || "undefined" == typeof navigator || (t = navigator.language ? navigator.language : navigator.userLanguage), 
        t || (t = z.fallbackLng[0]), t;
    }
    Array.prototype.indexOf || (Array.prototype.indexOf = function(t) {
        ...
        for (var s = n >= 0 ? Math.min(n, i - 1) : i - Math.abs(n); s >= 0; s--) if (s in e && e[s] === t) return s;
        return -1;
    }), "function" != typeof String.prototype.trim && (String.prototype.trim = function() {
        return this.replace(/^\s+|\s+$/g, "");
    });
    var E, M = this, P = M.jQuery || M.Zepto, A = {}, I = {}, O = 0, F = [], L = !1, H = {};
    if ("undefined" != typeof module && module.exports) {
        if (!P) try {
            P = require("jquery");
        } catch ($) {}
        P && (P.i18n = P.i18n || A), module.exports = A;
    } else P && (P.i18n = P.i18n || A), M.i18n = M.i18n || A;
    H = {
        load: function(t, e, i) {
            e.useLocalStorage ? H._loadLocal(t, e, function(n, s) {
                for (var r = [], o = 0, a = t.length; a > o; o++) s[t[o]] || r.push(t[o]);
                r.length > 0 ? H._fetch(r, e, function(t, e) {
                    q.extend(s, e), H._storeLocal(e), i(null, s);
                }) : i(null, s);
            }) : H._fetch(t, e, function(t, e) {
                i(null, e);
            });
        },
        _loadLocal: function(t, e, i) {
            var n = {}, s = new Date().getTime();
            if (window.localStorage) {
                var r = t.length;
                q.each(t, function(t, o) {
                    var a = window.localStorage.getItem("res_" + o);
                    a && (a = JSON.parse(a), a.i18nStamp && a.i18nStamp + e.localStorageExpirationTime > s && (n[o] = a)), 
                    r--, 0 === r && i(null, n);
                });
            }
        },
        ...
        _fetch: function(t, e, i) {
            ...
            if (e.dynamicLoad) {
                ...
                if ("function" == typeof e.customLoad) e.customLoad(t, n.namespaces, e, r); else {
                    var o = v(e.resGetPath, {
                        lng: t.join("+"),
                    ...
                    q.ajax({
                        url: o,
                        success: function(t) {
                            q.log("loaded: " + o), r(null, t);
                        },
                        error: function(t, e, i) {
                            q.log("failed loading: " + o), r("failed loading resource.json error: " + i);
                        },
                        dataType: "json",
                        async: e.getAsync
                    });
                ...
                var a, l = n.namespaces.length * t.length;
                q.each(n.namespaces, function(n, r) {
                    q.each(t, function(t, n) {
                        var o = function(t, e) {
                            t && (a = a || [], a.push(t)), s[n] = s[n] || {}, s[n][r] = e, l--, 0 === l && i(a, s);
                        };
                        "function" == typeof e.customLoad ? e.customLoad(n, r, e, o) : H._fetchOne(n, r, e, o);
                    });
                });
            }
        },
        _fetchOne: function(t, e, i, n) {
            var s = v(i.resGetPath, {
                lng: t,
                ns: e
            });
            q.ajax({
                url: s,
                success: function(t) {
                    q.log("loaded: " + s), n(null, t);
                },
                error: function(t, e, i) {
                    if (e && 200 == e || t && t.status && 200 == t.status) q.error("There is a typo in: " + s); else if (e && 404 == e || t && t.status && 404 == t.status) q.log("Does not exist: " + s); else {
                        var r = e ? e : t && t.status ? t.status : null;
                        q.log(r + " when loading " + s);
                    }
                    n(i, {});
                },
                dataType: "json",
        ...
        postMissing: function(t, e, i, n, s) {
            var r = {};
            r[i] = n;
            var o = [];
            if ("fallback" === z.sendMissingTo && z.fallbackLng[0] !== !1) for (var a = 0; a < z.fallbackLng.length; a++) o.push({
                lng: z.fallbackLng[a],
                url: v(z.resPostPath, {
                    lng: z.fallbackLng[a],
                    ns: e
                })
            }); else if ("current" === z.sendMissingTo || "fallback" === z.sendMissingTo && z.fallbackLng[0] === !1) o.push({
                lng: t,
                url: v(z.resPostPath, {
                    lng: t,
                    ns: e
                })
            }); else if ("all" === z.sendMissingTo) for (var a = 0, l = s.length; l > a; a++) o.push({
                lng: s[a],
                url: v(z.resPostPath, {
                    lng: s[a],
                    ns: e
            ...
            for (var u = 0, c = o.length; c > u; u++) {
                ...
                q.ajax({
                    ...
                    data: r,
                    success: function() {
                        q.log("posted missing key '" + i + "' to: " + h.url);
                        for (var t = i.split("."), s = 0, r = I[h.lng][e]; t[s]; ) r = r[t[s]] = s === t.length - 1 ? n : r[t[s]] || {}, 
                        s++;
                    },
                    error: function() {
                        q.log("failed posting missing key '" + i + "' to: " + h.url);
                    },
                    dataType: "json",
                    async: z.postAsync
                });
    ...
    var z = {
        ...
        missingKeyHandler: H.postMissing,
        ...
        create: function(t, e, i, n) {
            ...
            if (i) {
                var r = new Date();
                r.setTime(r.getTime() + 60 * i * 1e3), s = "; expires=" + r.toGMTString();
            } else s = "";
            n = n ? "domain=" + n + ";" : "", document.cookie = t + "=" + e + s + ";" + n + "path=/";
        },
        read: function(t) {
        ...
        deepExtend: e,
        each: P ? P.each : i,
        ajax: P ? P.ajax : "undefined" != typeof document ? s : function() {},
        cookie: "undefined" != typeof document ? R : W,
        detectLanguage: D,
        escape: n,
        log: function(t) {
            z.debug && "undefined" != typeof console && console.log(t);
        },
        error: function(t) {
            "undefined" != typeof console && console.error(t);
        },
        getCountyIndexOfLng: function(t) {
            var e = 0;
            return ("nb-NO" === t || "nn-NO" === t) && (e = 1), e;
        },
        toLanguages: function(t) {
            var e = this.log, i = [], n = z.lngWhitelist || !1, s = function(t) {
                !n || n.indexOf(t) > -1 ? i.push(t) : e("rejecting non-whitelisted language: " + t);
            };
            if ("string" == typeof t && t.indexOf("-") > -1) {
                var r = t.split("-");
                t = z.lowerCaseLng ? r[0].toLowerCase() + "-" + r[1].toLowerCase() : r[0].toLowerCase() + "-" + r[1].toUpperCase(), 
                "unspecific" !== z.load && s(t), "current" !== z.load && s(r[this.getCountyIndexOfLng(t)]);
            } else s(t);
            for (var o = 0; o < z.fallbackLng.length; o++) -1 === i.indexOf(z.fallbackLng[o]) && z.fallbackLng[o] && i.push(z.fallbackLng[o]);
            return i;
        },
        regexEscape: function(t) {
            return t.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
        },
        regexReplacementEscape: function(t) {
            return "string" == typeof t ? t.replace(/\$/g, "$$$$") : t;
        }
    };
    q.applyReplacement = v;
    var B = {
        rules: {
            ach: {
                name: "Acholi",
        ...
        setCurrentLng: function(t) {
            if (!B.currentRule || B.currentRule.lng !== t) {
                var e = t.split("-");
                B.currentRule = {
                    lng: t,
                    rule: B.rules[e[0]]
        ...
        needsPlural: function(t, e) {
            var i, n = t.split("-");
            return i = B.currentRule && B.currentRule.lng === t ? B.currentRule.rule : B.rules[n[q.getCountyIndexOfLng(t)]], 
            i && i.numbers.length <= 1 ? !1 : 1 !== this.get(t, e);
        },
        get: function(t, e) {
            function i(e, i) {
                var n;
                if (n = B.currentRule && B.currentRule.lng === t ? B.currentRule.rule : B.rules[e]) {
                    var s;
                    s = n.plurals(n.noAbs ? i : Math.abs(i));
                    var r = n.numbers[s];
                    return 2 === n.numbers.length && 1 === n.numbers[0] && (2 === r ? r = -1 : 1 === r && (r = 1)), 
                    r;
                }
                return 1 === i ? "1" : "-1";
            }
            var n = t.split("-");
            return i(n[q.getCountyIndexOfLng(t)], e);
        }
    }, V = {}, U = function(t, e) {
        V[t] = e;
    }, X = function() {
        ...
        return i.format = function(i, n) {
            var s, r, o, a, l, u, c, h = 1, d = i.length, p = "", f = [];
            for (r = 0; d > r; r++) if (p = t(i[r]), "string" === p) f.push(i[r]); else if ("array" === p) {
                if (a = i[r], a[2]) for (s = n[h], o = 0; o < a[2].length; o++) {
                    if (!s.hasOwnProperty(a[2][o])) throw X('[sprintf] property "%s" does not exist', a[2][o]);
                    s = s[a[2][o]];
                } else s = a[1] ? n[a[1]] : n[h++];
                if (/[^s]/.test(a[8]) && "number" != t(s)) throw X("[sprintf] expecting number but found %s", t(s));
                switch (a[8]) {
                  case "b":
                    s = s.toString(2);
                    break;
                ...
                s = /[def]/.test(a[8]) && a[3] && s >= 0 ? "+" + s : s, u = a[4] ? "0" == a[4] ? "0" : a[4].charAt(1) : " ", 
                c = a[6] - String(s).length, l = a[6] ? e(u, c) : "", f.push(a[5] ? s + l : l + s);
            }
            return f.join("");
        }, i.cache = {}, i.parse = function(t) {
            for (var e = t, i = [], n = [], s = 0; e; ) {
                if (null !== (i = /^[^\x25]+/.exec(e))) n.push(i[0]); else if (null !== (i = /^\x25{2}/.exec(e))) n.push("%"); else {
                    if (null === (i = /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/.exec(e))) throw "[sprintf] huh?";
                    if (i[2]) {
                        s |= 1;
                        var r = [], o = i[2], a = [];
        ...
        return e.unshift(t), X.apply(null, e);
    };
    U("sprintf", function(t, e, i) {
        return i.sprintf ? "[object Array]" === Object.prototype.toString.apply(i.sprintf) ? Y(t, i.sprintf) : "object" == typeof i.sprintf ? X(t, i.sprintf) : t : t;
    }), A.init = r, A.setLng = f, A.preload = o, A.addResourceBundle = a, A.addResource = u, 
    A.addResources = c, A.removeResourceBundle = l, A.loadNamespace = d, A.loadNamespaces = p, 
    A.setDefaultNamespace = h, A.t = k, A.translate = k, A.exists = x, A.detectLanguage = q.detectLanguage, 
    A.pluralExtensions = B, A.sync = H, A.functions = q, A.lng = m, A.addPostProcessor = U, 
    A.options = z;
}(), define("i18n", [ "jquery" ], function(t) {
    return function() {
        var e;
        return e || t.$;
    };
}(this)), define("models/fields", [ "jquery", "underscore", "backbone", "i18n" ], function(t, e, i) {
    var n = e.template('        <div class="form-group padding5 paddingRight25 field-<%= key %>">            <label class="control-label" for="<%= editorId %>"><%= title %></label>            <div data-editor >                <p class="help-block" data-error></p>                <p class="help-block"><%= help %></p>            </div>        </div>    ');
    i18n.init({
        resGetPath: "ressources/locales/__lng__/__ns__.json",
        getAsync: !1
    });
    var s = {};
    s.BaseField = i.Model.extend({
        defaults: {
            id: 0,
            label: "My label",
            name: {
        ...
        schema: {
            ...
            readonly: {
                ...
                editorClass: "form-control",
                template: n,
                title: t.t("schema.readonly")
            }
        },
        getXML: function() {
            return "<label>" + this.get("label") + "</label><name>   <label lang='" + this.get("name").label.lang + "'>" + this.get("name").label.value + "</label>   <display_label>" + this.get("name").displayLabel + "</display_label></name><required>" + this.get("required") + "</required><readOnly>" + this.get("readOnly") + "</readOnly>";
        },
        isAdvanced: function(t) {
            return "advanced" === this.getSchemaProperty(t, "advanced");
        }
    }), s.HiddenField = i.Model.extend({
        defaults: {
            id: 0,
            name: {
                label: {
        ...
        schema: {
            ...
            value: {
                ...
                editorClass: "form-control",
                template: n,
                title: t.t("schema.value")
            }
        },
        getSchemaProperty: function() {
            s.BaseField.prototype.getSchemaProperty.apply(this, arguments);
        },
        changePropertyValue: function() {
            s.BaseField.prototype.changePropertyValue.apply(this, arguments);
        },
        getXML: function() {
            return "<name>   <label lang='" + this.get("name").label.lang + "'>" + this.get("name").label.value + "</label>   <display_label>" + this.get("name").displayLabel + "</display_label></name><value>" + this.get("value") + "</value>";
        }
    }, {
        type: "Hidden",
        xmlTag: "field_hidden",
        i18n: "hidden"
    }), s.HorizontalLineField = i.Model.extend({}, {
        type: "HorizontalLine",
        xmlTag: "field_horizontalLine",
        i18n: "line"
    }), s.AutocompleteField = s.BaseField.extend({
        defaults: function() {
            return e.extend(s.BaseField.prototype.defaults, {
                defaultValue: "",
        ...
        schema: function() {
            return e.extend(s.BaseField.prototype.schema, {
                defaultValue: {
                    type: "Text",
                    title: t.t("schema.default"),
                    fieldClass: "advanced",
                    editorClass: "form-control",
                    template: n
                },
                hint: {
                    ...
                    editorClass: "form-control",
                    template: n,
                    title: t.t("schema.hint")
                },
                url: {
                    type: "Text",
                    editorClass: "form-control",
                    template: n,
                    title: t.t("schema.url")
                }
            });
        },
        getXML: function() {
            var t = s.BaseField.prototype.getXML.apply(this, arguments);
            return t + "<defaultValue>" + this.get("defaultValue") + "</defaultValue><hint>" + this.get("hint") + "</hint><url>" + this.get("url") + "</url>";
        },
        initialize: function() {
            s.BaseField.prototype.initialize.apply(this, arguments);
        }
    }, {
        type: "Autocomplete",
        xmlTag: "field_autocomplete",
        i18n: "autocomplete"
    }), s.TextField = s.BaseField.extend({
        defaults: function() {
            return e.extend(s.BaseField.prototype.defaults, {
                defaultValue: "",
                hint: "Write some text",
        ...
        getXML: function() {
            var t = s.BaseField.prototype.getXML.apply(this, arguments);
            return t + "<defaultValue>" + this.get("defaultValue") + "</defaultValue><hint>" + this.get("hint") + "</hint><size>" + this.get("size") + "</size><multiline>" + this.get("multiline") + "</multiline>";
        }
    }, {
        type: "Text",
        xmlTag: "field_text",
        i18n: "text"
    }), s.FileField = s.BaseField.extend({
        defaults: function() {
            return e.extend(s.BaseField.prototype.defaults, {
                defaultValue: "",
                file: "",
        ...
        schema: function() {
            return e.extend(s.BaseField.prototype.schema, {
                ...
                file: {
                    ...
                    editorClass: "form-control",
                    template: n,
                    title: t.t("schema.file")
                },
                mimeType: {
                    type: "Text",
                    editorClass: "form-control",
                    template: n,
                    title: t.t("schema.mime")
                },
                size: {
                    type: "Number",
                    title: "Maximum size",
        ...
        getXML: function() {
            var t = s.BaseField.prototype.getXML.apply(this, arguments);
            return t + "<file>" + this.get("file") + "</file><defaultValue>" + this.get("defaultValue") + "</defaultValue><mimeType>" + this.get("mimeType") + "</mimeType><size>" + this.get("size") + "</size>";
        }
    }, {
        type: "File",
        xmlTag: "field_file",
    ...
    var r = i.Model.extend({
        schema: {
            title: {
                type: "Text",
                title: t.t("schema.title")
            },
            key: {
                type: "Number",
                title: t.t("schema.key")
            },
            folder: {
                type: "Checkbox",
                title: t.t("schema.readonly")
    ...
    return s.TreeViewField = s.BaseField.extend({
        defaults: function() {
            return e.extend(s.BaseField.prototype.defaults, {
                node: [ {
                    title: "Node 1",
        ...
        schema: function() {
            return e.extend(s.BaseField.prototype.schema, {
                defaultNode: {
                    type: "Number",
                    title: t.t("schema.defaultNode")
                },
                multipleSelection: {
                    type: "Checkbox",
                    title: t.t("schema.multipleSelection")
                },
                hierarchicSelection: {
                    type: "Checkbox",
                    title: t.t("schema.hierarchic")
                },
                node: {
                    type: "List",
                    itemType: "Object",
                    itemToString: function(t) {
                        return "<b>Title : </b>" + t.title + ", <b>Key : </b>" + t.key + ", <b>is a folder : </b>" + (t.folder ? "Yes" : "No");
                    },
                    subSchema: {
                        title: {
                            type: "Text",
                        ...
                        folder: {
                            type: "Checkbox",
                            title: t.t("schema.folder")
                        },
                        children: {
                            type: "List",
                            itemToString: function(t) {
                                return "Children : <b>Title : </b>" + t.title + ", <b>Key : </b>" + t.key + ", <b>is a folder : </b>" + (t.folder ? "Yes" : "No");
                            },
                            itemType: "NestedModel",
                            model: r,
                            title: t.t("schema.child")
                        }
                    }
                }
            });
        ...
        initialize: function() {
            s.BaseField.prototype.initialize.apply(this, arguments), e.bindAll(this, "getNodeXml", "getXML");
        },
        getNodeXml: function(t) {
            var i = "<node>   <title>" + t.title + "</title>   <key>" + t.key + "</key>   <folder>" + (void 0 === t.folder ? "false" : t.folder) + "</folder>";
            return t.folder === !0 && (i += "<children>", e.each(t.children, e.bind(function(t) {
                i += this.getNodeXml(t);
            }, this)), i += "</children>"), i + "</node>";
        },
        getXML: function() {
            var t = s.BaseField.prototype.getXML.apply(this, arguments);
            return t += "<defaultNode>" + this.get("defaultNode") + "</defaultNode><multipleSelection>" + this.get("multipleSelection") + "</multipleSelection><hierarchicSelection>" + this.get("hierarchicSelection") + "</hierarchicSelection>", 
            e.each(this.get("node"), e.bind(function(e) {
                t += this.getNodeXml(e);
            }, this)), t;
        }
    }, {
        ...
        i18n: "tree"
    }), s.EnumerationField = s.BaseField.extend({
        defaults: function() {
            return e.extend(s.BaseField.prototype.defaults, {
                itemList: {
                    items: [ {
                ...
                itemList: {
                    ...
                    subSchema: {
                        ...
                        items: {
                            ...
                            itemToString: function(t) {
                                return "ID : " + t.id + ", <b>EN label</b> : " + t.en + ", FR label : " + t.fr + ", value : " + t.value;
                            },
                            subSchema: {
                                id: {
                                    type: "Number",
                                ...
                                en: {
                                    ...
                                    validators: [ "required" ],
                                    title: t.t("schema.englishText")
                                },
                                fr: {
                                    type: "Text",
                                    title: t.t("schema.frenchText"),
                                    validators: [ "required" ]
                                }
                            }
                        }
        ...
        addOption: function(t, e, i) {
            this.get("items")[t].items.push(e), i && (this.get("items")[t].defaultValue = e.id), 
            this.trigger("change");
        },
        removeOption: function(t, e) {
            this.get("items")[t].splice(e, 1), this.trigger("change");
        },
        ...
        getXML: function() {
            var t = s.BaseField.prototype.getXML.apply(this, arguments);
            return t += "<itemList><items>", e.each(this.get("itemList").items, function(e) {
                t += '<item id="' + e.id + '"><en>' + e.en + "</en><fr>" + e.fr + "</fr><value>" + e.value + "</value></item>";
            }), t += "</items>", t += "<defaultValue>" + this.get("itemList").defaultValue + "</defaultValue>", 
            t += "</itemList>", t += "<expanded>" + this.get("expanded") + "</expanded>", t += "<multiple>" + this.get("multiple") + "</multiple>";
        }
    }), s.DateField = s.TextField.extend({
        defaults: function() {
            return e.extend(s.TextField.prototype.defaults(), {
                format: "dd/mm/yyyy"
            });
        },
        schema: function() {
            return e.extend(s.TextField.prototype.schema(), {
                format: {
                    type: "Text",
                    editorClass: "form-control",
                    template: n,
                    title: t.t("schema.format")
                }
            });
        },
        initialize: function() {
            s.TextField.prototype.initialize.apply(this, arguments);
        },
        getXML: function() {
            return s.TextField.prototype.getXML.apply(this, arguments) + "<format>" + this.get("format") + "</format>";
        }
    }, {
        type: "Date",
        xmlTag: "field_date",
        i18n: "date"
    }), s.LongTextField = s.TextField.extend({
        defaults: function() {
            return e.extend(s.TextField.prototype.defaults(), {
                multiline: !0
            });
        ...
        schema: function() {
            return e.extend(s.TextField.prototype.schema(), {
                multiline: {
                    ...
                    editorClass: "form-control",
                    template: n,
                    title: t.t("schema.multiline")
                }
            });
        },
        initialize: function() {
            s.TextField.prototype.initialize.apply(this, arguments), this.set("multiline", !0);
        },
        getXML: function() {
            return s.TextField.prototype.getXML.apply(this, arguments);
        }
    }, {
        type: "LongText",
        xmlTag: "field_text",
        i18n: "long"
    }), s.NumericField = s.TextField.extend({
        defaults: function() {
            return e.extend(s.TextField.prototype.defaults(), {
                minValue: 0,
                maxValue: 100,
        ...
        schema: function() {
            return e.extend(s.TextField.prototype.schema(), {
                minValue: {
                    ...
                    editorClass: "form-control",
                    template: n,
                    title: t.t("schema.min")
                },
                maxValue: {
                    type: "Number",
                    editorClass: "form-control",
                    template: n,
                    title: t.t("schema.max")
                },
                precision: {
                    type: "Number",
                    editorClass: "form-control",
                    template: n,
                    title: t.t("schema.precision")
                },
                unity: {
                    type: "Text",
                    editorClass: "form-control",
                    template: n,
                    title: t.t("schema.unity")
                }
            });
        },
        initialize: function() {
            s.TextField.prototype.initialize.apply(this, arguments), this.set("hint", "Enter a numeric value");
        },
        getXML: function() {
            return s.TextField.prototype.getXML.apply(this, arguments) + "<min>" + this.get("minValue") + "</min><max>" + this.get("maxValue") + "</max><precision>" + this.get("precision") + "</precision><unity>" + this.get("unity") + "</unity>";
        }
    }, {
        type: "Numeric",
        xmlTag: "field_numeric",
        i18n: "numeric"
    }), s.PatternField = s.TextField.extend({
        defaults: function() {
            return e.extend(s.TextField.prototype.defaults, {
                pattern: ""
            });
        ...
        schema: function() {
            return e.extend(s.TextField.constructor.schema, {
                pattern: {
                    type: "Text",
                    editorClass: "form-control",
                    template: n,
                    title: t.t("schema.pattern")
                }
            });
        },
        initialize: function() {
        ...
        getXML: function() {
            return s.TextField.prototype.getXML.apply(this, arguments) + "<pattern>" + this.get("pattern") + "</pattern>";
        }
    }, {
        type: "Pattern",
        xmlTag: "field_pattern",
        i18n: "mask"
    }), s.CheckBoxField = s.EnumerationField.extend({
        defaults: function() {
            return s.EnumerationField.prototype.defaults();
        },
        schema: function() {
            return s.EnumerationField.prototype.schema();
        },
        getXML: function() {
            return s.EnumerationField.prototype.getXML.apply(this, arguments);
        },
        initialize: function() {
            s.EnumerationField.prototype.initialize.apply(this, arguments), this.set("multiple", !0), 
            this.set("expanded", !0);
        }
    }, {
        type: "CheckBox",
        xmlTag: "field_list",
        i18n: "checkbox"
    }), s.RadioField = s.EnumerationField.extend({
        defaults: function() {
            return s.EnumerationField.prototype.defaults();
        },
        schema: function() {
            return s.EnumerationField.constructor.schema;
        },
        getXML: function() {
            return s.EnumerationField.prototype.getXML.apply(this, arguments);
        },
        initialize: function() {
            s.EnumerationField.prototype.initialize.apply(this, arguments), this.set("multiple", !1), 
            this.set("expanded", !0);
        }
    }, {
        type: "Radio",
        xmlTag: "field_list",
        i18n: "radio"
    }), s.SelectField = s.EnumerationField.extend({
        defaults: function() {
            return s.EnumerationField.prototype.defaults();
        },
        schema: function() {
        ...
        initialize: function() {
            s.EnumerationField.prototype.initialize.apply(this, arguments);
        }
    }, {
        type: "Select",
        xmlTag: "field_list",
        i18n: "select"
    }), s.SubformField = i.Model.extend({
        defaults: {
            id: 0,
            fields: [],
            legend: "Fieldset",
        ...
        schema: {
            ...
            multiple: {
                ...
                title: t.t("schema.multiple")
            },
            legend: {
                type: "Text",
                editorClass: "form-control",
                template: n,
                title: t.t("schema.legend")
            }
        },
        initialize: function() {
            e.bindAll(this, "addModel", "removeModel", "getXML", "updateModel");
        },
        addModel: function(t) {
            var e = this.get("fields");
            t.set("isDragged", !0), e.push(t), this.set("fields", e);
        },
        removeModel: function(t) {
            var e = this.get("fields");
            delete e[t], this.set("fields", e);
        },
        updateModel: function(t, e, i) {
            var n = this.get("fields"), s = n[e];
            n.splice(e, 1), n.splice(i, 0, s), this.set("fields", n);
        },
        getXML: function() {
            var t = "<legend>" + this.get("legend") + "</legend>";
            return t += "<multiple>" + this.get("multiple") + "</multiple>", e.each(this.get("fields"), function(e) {
                t += "<" + e.constructor.xmlTag + ' id="' + e.get("id") + '" >' + e.getXML() + "</" + e.constructor.xmlTag + ">";
            }), t;
        },
        changePropertyValue: function() {
            s.models.BaseField.prototype.changePropertyValue.apply(this, arguments);
        }
    }, {
        type: "Subform",
        xmlTag: "fieldset",
        i18n: "fieldset"
    }), s.TableField = i.Model.extend({
        defaults: {
            fields: []
        },
        initialize: function() {
            s.BaseField.prototype.initialize.apply(this, arguments), e.bindAll(this, "moveModel", "addModel", "removeModel", "getXML");
        },
        getXML: function() {
            var t = s.BaseField.prototype.getXML.apply(this, arguments);
            return e.each(this.get("fields"), function(e) {
                t += "<" + e.constructor.xmlTag + ' id="' + e.get("id") + '" >' + e.getXML() + "</" + e.constructor.xmlTag + ">";
            }), t;
        },
        addModel: function(t) {
        ...
        moveModel: function(t, e) {
            var i = this.get("fields");
            if (void 0 !== i[e]) {
                var n = i[t];
                i[t] = i[e], i[e] = n;
            } else i[e] = i[t], delete i[t];
            this.set("fields", i), this.trigger("update", t, e), this.trigger("done");
        }
    }, {
        type: "Table",
        xmlTag: "field_table",
    ...
    function e(e, n) {
        ...
        return "area" === a ? (s = e.parentNode, r = s.name, e.href && r && "map" === s.nodeName.toLowerCase() ? (o = t("img[usemap='#" + r + "']")[0], 
        !!o && i(o)) : !1) : (/input|select|textarea|button|object/.test(a) ? !e.disabled : "a" === a ? e.href || n : n) && i(e);
    }
    function i(e) {
    ...
    function s() {
        ...
        this.regional["en-US"] = t.extend(!0, {}, this.regional.en), this.dpDiv = r(t("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"));
    }
    function r(e) {
    ...
    t.ui = t.ui || {}, t.extend(t.ui, {
        ...
        scrollParent: function(e) {
            var i = this.css("position"), n = "absolute" === i, s = e ? /(auto|scroll|hidden)/ : /(auto|scroll)/, r = this.parents().filter(function() {
                var e = t(this);
    ...
    t.fn.extend({
        ...
        zIndex: function(e) {
            ...
            if (this.length) for (var i, n, s = t(this[0]); s.length && s[0] !== document; ) {
                if (i = s.css("position"), ("absolute" === i || "relative" === i || "fixed" === i) && (n = parseInt(s.css("zIndex"), 10), 
    ...
    t.cleanData = function(e) {
        ...
        for (var i, n, s = c.call(arguments, 1), r = 0, o = s.length; o > r; r++) for (i in s[r]) n = s[r][i], 
        s[r].hasOwnProperty(i) && void 0 !== n && (e[i] = t.isPlainObject(n) ? t.isPlainObject(e[i]) ? t.widget.extend({}, e[i], n) : t.widget.extend({}, n) : n);
        return e;
    }, t.widget.bridge = function(e, i) {
        var n = i.prototype.widgetFullName || e;
        t.fn[e] = function(s) {
            var r = "string" == typeof s, o = c.call(arguments, 1), a = this;
            return s = !r && o.length ? t.widget.extend.apply(null, [ s ].concat(o)) : s, this.each(r ? function() {
                var i, r = t.data(this, n);
                return "instance" === s ? (a = r, !1) : r ? t.isFunction(r[s]) && "_" !== s.charAt(0) ? (i = r[s].apply(r, o), 
                i !== r && void 0 !== i ? (a = i && i.jquery ? a.pushStack(i.get()) : i, !1) : void 0) : t.error("no such method '" + s + "' for " + e + " widget instance") : t.error("cannot call methods on " + e + " prior to initialization; attempted to call method '" + s + "'");
            } : function() {
                var e = t.data(this, n);
        ...
        _createWidget: function(e, i) {
            i = t(i || this.defaultElement || this)[0], this.element = t(i), this.uuid = u++, 
        ...
        option: function(e, i) {
            ...
            if ("string" == typeof e) if (o = {}, n = e.split("."), e = n.shift(), n.length) {
                for (s = o[e] = t.widget.extend({}, this.options[e]), r = 0; n.length - 1 > r; r++) s[n[r]] = s[n[r]] || {}, 
                s = s[n[r]];
        ...
        _on: function(e, i, n) {
            ...
            i = this.element, s = this.widget()), t.each(n, function(n, o) {
                function a() {
    ...
    t(document).mouseup(function() {
        ...
        t.ui = t.ui || {};
        var s, r, o = Math.max, a = Math.abs, l = Math.round, u = /left|center|right/, c = /top|center|bottom/, h = /[\+\-]\d+(\.[\d]+)?%?/, d = /^\w+/, p = /%$/, f = t.fn.position;
        t.position = {
            scrollbarWidth: function() {
                ...
                return t("body").append(n), e = r.offsetWidth, n.css("overflow", "scroll"), i = r.offsetWidth, 
            ...
            s = t.extend({}, s);
            var p, m, g, v, b, y, _ = t(s.of), w = t.position.getWithinInfo(s.within), x = t.position.getScrollInfo(w), k = (s.collision || "flip").split(" "), C = {};
            return y = n(_), _[0].preventDefault && (s.at = "left top"), m = y.width, g = y.height, 
            v = y.offset, b = t.extend({}, v), t.each([ "my", "at" ], function() {
                var t, e, i = (s[this] || "").split(" ");
                1 === i.length && (i = u.test(i[0]) ? i.concat([ "center" ]) : c.test(i[0]) ? [ "center" ].concat(i) : [ "center", "center" ]), 
                i[0] = u.test(i[0]) ? i[0] : "center", i[1] = c.test(i[1]) ? i[1] : "center", t = h.exec(i[0]), 
                e = h.exec(i[1]), C[this] = [ t ? t[0] : 0, e ? e[0] : 0 ], s[this] = [ d.exec(i[0])[0], d.exec(i[1])[0] ];
            }), 1 === k.length && (k[1] = k[0]), "right" === s.at[0] ? b.left += m : "center" === s.at[0] && (b.left += m / 2), 
            "bottom" === s.at[1] ? b.top += g : "center" === s.at[1] && (b.top += g / 2), p = e(C.at, m, g), 
            b.left += p[0], b.top += p[1], this.each(function() {
                var n, u, c = t(this), h = c.outerWidth(), d = c.outerHeight(), f = i(this, "marginLeft"), y = i(this, "marginTop"), T = h + f + i(this, "marginRight") + x.width, S = d + y + i(this, "marginBottom") + x.height, N = t.extend({}, b), D = e(C.my, c.outerWidth(), c.outerHeight());
                "right" === s.my[0] ? N.left -= h : "center" === s.my[0] && (N.left -= h / 2), "bottom" === s.my[1] ? N.top -= d : "center" === s.my[1] && (N.top -= d / 2), 
                N.left += D[0], N.top += D[1], r || (N.left = l(N.left), N.top = l(N.top)), n = {
                    marginLeft: f,
                    marginTop: y
                }, t.each([ "left", "top" ], function(e, i) {
                    t.ui.position[k[e]] && t.ui.position[k[e]][i](N, {
                        targetWidth: m,
                        targetHeight: g,
                        elemWidth: h,
                        elemHeight: d,
                    ...
                    var e = v.left - N.left, i = e + m - h, n = v.top - N.top, r = n + g - d, l = {
                        target: {
                            element: _,
                            left: v.left,
                            top: v.top,
                    ...
                    h > m && m > a(e + i) && (l.horizontal = "center"), d > g && g > a(n + r) && (l.vertical = "middle"), 
                    l.important = o(a(e), a(i)) > o(a(n), a(r)) ? "horizontal" : "vertical", s.using.call(this, t, l);
                }), c.offset(t.extend(N, {
                    using: u
                }));
            });
            ...
            fit: {
                left: function(t, e) {
                    var i, n = e.within, s = n.isWindow ? n.scrollLeft : n.offset.left, r = n.width, a = t.left - e.collisionPosition.marginLeft, l = s - a, u = a + e.collisionWidth - r - s;
                    e.collisionWidth > r ? l > 0 && 0 >= u ? (i = t.left + l + e.collisionWidth - r - s, 
                    t.left += l - i) : t.left = u > 0 && 0 >= l ? s : l > u ? s + r - e.collisionWidth : s : l > 0 ? t.left += l : u > 0 ? t.left -= u : t.left = o(t.left - a, t.left);
                },
                top: function(t, e) {
                    var i, n = e.within, s = n.isWindow ? n.scrollTop : n.offset.top, r = e.within.height, a = t.top - e.collisionPosition.marginTop, l = s - a, u = a + e.collisionHeight - r - s;
                    e.collisionHeight > r ? l > 0 && 0 >= u ? (i = t.top + l + e.collisionHeight - r - s, 
                    t.top += l - i) : t.top = u > 0 && 0 >= l ? s : l > u ? s + r - e.collisionHeight : s : l > 0 ? t.top += l : u > 0 ? t.top -= u : t.top = o(t.top - a, t.top);
                }
            },
            flip: {
                left: function(t, e) {
                    var i, n, s = e.within, r = s.offset.left + s.scrollLeft, o = s.width, l = s.isWindow ? s.scrollLeft : s.offset.left, u = t.left - e.collisionPosition.marginLeft, c = u - l, h = u + e.collisionWidth - o - l, d = "left" === e.my[0] ? -e.elemWidth : "right" === e.my[0] ? e.elemWidth : 0, p = "left" === e.at[0] ? e.targetWidth : "right" === e.at[0] ? -e.targetWidth : 0, f = -2 * e.offset[0];
                    0 > c ? (i = t.left + d + p + f + e.collisionWidth - o - r, (0 > i || a(c) > i) && (t.left += d + p + f)) : h > 0 && (n = t.left - e.collisionPosition.marginLeft + d + p + f - l, 
                    (n > 0 || h > a(n)) && (t.left += d + p + f));
                },
                top: function(t, e) {
                    var i, n, s = e.within, r = s.offset.top + s.scrollTop, o = s.height, l = s.isWindow ? s.scrollTop : s.offset.top, u = t.top - e.collisionPosition.marginTop, c = u - l, h = u + e.collisionHeight - o - l, d = "top" === e.my[1], p = d ? -e.elemHeight : "bottom" === e.my[1] ? e.elemHeight : 0, f = "top" === e.at[1] ? e.targetHeight : "bottom" === e.at[1] ? -e.targetHeight : 0, m = -2 * e.offset[1];
                    0 > c ? (n = t.top + p + f + m + e.collisionHeight - o - r, t.top + p + f + m > c && (0 > n || a(c) > n) && (t.top += p + f + m)) : h > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + m - l, 
                    t.top + p + f + m > h && (i > 0 || h > a(i)) && (t.top += p + f + m));
                }
            },
            flipfit: {
                left: function() {
            ...
            var e, i, n, s, o, a = document.getElementsByTagName("body")[0], l = document.createElement("div");
            ...
            e.appendChild(l), i = a || document.documentElement, i.insertBefore(e, i.firstChild), 
            l.style.cssText = "position: absolute; left: 10.7432222px;", s = t(l).offset().left, 
            r = s > 10 && 11 > s, e.innerHTML = "", i.removeChild(e);
        }();
        ...
        _eventHandler: function(e) {
            var i = this.options, n = this.active, s = t(e.currentTarget), r = s[0] === n[0], o = r && i.collapsible, a = o ? t() : s.next(), l = n.next(), u = {
                oldHeader: n,
                oldPanel: l,
                newHeader: o ? t() : s,
                newPanel: a
            };
            e.preventDefault(), r && !i.collapsible || this._trigger("beforeActivate", e, u) === !1 || (i.active = o ? !1 : this.headers.index(s), 
            this.active = r ? t() : s, this._toggle(u), n.removeClass("ui-accordion-header-active ui-state-active"), 
        ...
        _animate: function(t, e, i) {
            var n, s, r, o = this, a = 0, l = t.length && (!e.length || t.index() < e.index()), u = this.options.animate || {}, c = l && u.down || u, h = function() {
                o._toggleComplete(i);
            };
            return "number" == typeof c && (r = c), "string" == typeof c && (s = c), s = s || c.easing || u.easing, 
            r = r || c.duration || u.duration, e.length ? t.length ? (n = t.show().outerHeight(), 
            e.animate(this.hideProps, {
                ...
                complete: h,
                step: function(t, i) {
                    i.now = Math.round(t), "height" !== i.prop ? a += i.now : "content" !== o.options.heightStyle && (i.now = Math.round(n - e.outerHeight() - a), 
                    a = 0);
                }
            })) : e.animate(this.hideProps, r, s, h) : t.animate(this.showProps, r, s, h);
        },
        ...
        _keydown: function(e) {
            ...
            switch (e.keyCode) {
              ...
              default:
                l = !1, s = this.previousFilter || "", r = String.fromCharCode(e.keyCode), o = !1, 
                clearTimeout(this.filterTimer), r === s ? o = !0 : r = s + r, a = RegExp("^" + i(r), "i"), 
                ...
                n.length || (r = String.fromCharCode(e.keyCode), a = RegExp("^" + i(r), "i"), n = this.activeMenu.find(this.options.items).filter(function() {
                    return a.test(t(this).text());
        ...
        refresh: function() {
            var e, i, n = this, s = this.options.icons.submenu, r = this.element.find(this.options.menus);
        ...
        _scrollIntoView: function(e) {
            ...
            r = this.activeMenu.scrollTop(), o = this.activeMenu.height(), a = e.outerHeight(), 
            0 > s ? this.activeMenu.scrollTop(r + s) : s + a > o && this.activeMenu.scrollTop(r + s - o + a));
        },
        blur: function(t, e) {
        ...
        _create: function() {
            ...
            this.isMultiLine = r ? !0 : o ? !1 : this.element.prop("isContentEditable"), this.valueMethod = this.element[r || o ? "val" : "text"], 
            ...
            this._on(this.element, {
                ...
                menufocus: function(e, i) {
                    ...
                    n = i.item.attr("aria-label") || s.value, void (n && t.trim(n).length && (this.liveRegion.children().hide(), 
    ...
    t.widget("ui.button", {
        ...
        _setOption: function(t, e) {
            ...
            this.element.prop("disabled", !!e), void (e && this.buttonElement.removeClass("checkbox" === this.type || "radio" === this.type ? "ui-state-focus" : "ui-state-focus ui-state-active"))) : void this._resetButton();
        },
        refresh: function() {
        ...
        _resetButton: function() {
            ...
            var e = this.buttonElement.removeClass(f), i = t("<span></span>", this.document[0]).addClass("ui-button-text").html(this.options.label).appendTo(e.empty()).text(), n = this.options.icons, s = n.primary && n.secondary, r = [];
            n.primary || n.secondary ? (this.options.text && r.push("ui-button-text-icon" + (s ? "s" : n.primary ? "-primary" : "-secondary")), 
            ...
            this.options.text || (r.push(s ? "ui-button-icons-only" : "ui-button-icon-only"), 
    ...
    t.extend(s.prototype, {
        ...
        _attachDatepicker: function(e, i) {
            var n, s, r;
            n = e.nodeName.toLowerCase(), s = "div" === n || "span" === n, e.id || (this.uuid += 1, 
            e.id = "dp" + this.uuid), r = this._newInst(t(e), s), r.settings = t.extend({}, i || {}), 
        ...
        _attachments: function(e, i) {
            ...
            i.append && i.append.remove(), o && (i.append = t("<span class='" + this._appendClass + "'>" + o + "</span>"), 
            e[a ? "before" : "after"](i.append)), e.unbind("focus", this._showDatepicker), i.trigger && i.trigger.remove(), 
            n = this._get(i, "showOn"), ("focus" === n || "both" === n) && e.focus(this._showDatepicker), 
        ...
        _autoSize: function(t) {
            if (this._get(t, "autoSize") && !t.inline) {
                ...
                o.match(/[DM]/) && (e = function(t) {
                    for (i = 0, n = 0, s = 0; t.length > s; s++) t[s].length > i && (i = t[s].length, 
                    n = s);
                    return n;
        ...
        _dialogDatepicker: function(e, i, n, s, r) {
            ...
            return d || (this.uuid += 1, o = "dp" + this.uuid, this._dialogInput = t("<input type='text' id='" + o + "' style='position: absolute; top: -100px; width: 0px;'/>"), 
            ...
            this._pos = [ l / 2 - 100 + c, u / 2 - 150 + h ]), this._dialogInput.css("left", this._pos[0] + 20 + "px").css("top", this._pos[1] + "px"), 
        ...
        _enableDatepicker: function(e) {
            var i, n, s = t(e), r = t.data(e, "datepicker");
            s.hasClass(this.markerClassName) && (i = e.nodeName.toLowerCase(), "input" === i ? (e.disabled = !1, 
        ...
        _disableDatepicker: function(e) {
            var i, n, s = t(e), r = t.data(e, "datepicker");
            s.hasClass(this.markerClassName) && (i = e.nodeName.toLowerCase(), "input" === i ? (e.disabled = !0, 
            r.trigger.filter("button").each(function() {
                this.disabled = !0;
            }).end().filter("img").css({
                opacity: "0.5",
        ...
        _optionDatepicker: function(e, i, n) {
            var s, r, o, l, u = this._getInst(e);
            return 2 === arguments.length && "string" == typeof i ? "defaults" === i ? t.extend({}, t.datepicker._defaults) : u ? "all" === i ? t.extend({}, u.settings) : this._get(u, i) : null : (s = i || {}, 
            "string" == typeof i && (s = {}, s[i] = n), void (u && (this._curInst === u && this._hideDatepicker(), 
            r = this._getDateDatepicker(e, !0), o = this._getMinMaxDate(u, "min"), l = this._getMinMaxDate(u, "max"), 
            a(u.settings, s), null !== o && void 0 !== s.dateFormat && void 0 === s.minDate && (u.settings.minDate = this._formatDate(u, o)), 
            ...
            this._attachments(t(e), u), this._autoSize(u), this._setDate(u, r), this._updateAlternate(u), 
        ...
        _doKeyDown: function(e) {
            ...
            if (r._keyEvent = !0, t.datepicker._datepickerShowing) switch (e.keyCode) {
              ...
              case 13:
                ...
                i = t.datepicker._get(r, "onSelect"), i ? (n = t.datepicker._formatDate(r), i.apply(r.input ? r.input[0] : null, [ n, r ])) : t.datepicker._hideDatepicker(), 
                !1;
              ...
              case 37:
                ...
                o = e.ctrlKey || e.metaKey, e.originalEvent.altKey && t.datepicker._adjustDate(e.target, e.ctrlKey ? -t.datepicker._get(r, "stepBigMonths") : -t.datepicker._get(r, "stepMonths"), "M");
                break;
        ...
        _showDatepicker: function(e) {
            ...
            !t.datepicker._isDisabledDatepicker(e) && t.datepicker._lastInput !== e) {
                ...
                s = t.datepicker._get(i, "beforeShow"), r = s ? s.apply(e, [ e, i ]) : {}, r !== !1 && (a(i.settings, r), 
                ...
                t.datepicker._pos[1] += e.offsetHeight), o = !1, t(e).parents().each(function() {
                    ...
                    left: l.left + "px",
                    top: l.top + "px"
                }), i.inline || (u = t.datepicker._get(i, "showAnim"), c = t.datepicker._get(i, "duration"), 
                i.dpDiv.css("z-index", n(t(e)) + 1), t.datepicker._datepickerShowing = !0, t.effects && t.effects.effect[u] ? i.dpDiv.show(u, t.datepicker._get(i, "showOptions"), c) : i.dpDiv[u || "show"](u ? c : null), 
        ...
        _checkOffset: function(e, i, n) {
            var s = e.dpDiv.outerWidth(), r = e.dpDiv.outerHeight(), o = e.input ? e.input.outerWidth() : 0, a = e.input ? e.input.outerHeight() : 0, l = document.documentElement.clientWidth + (n ? 0 : t(document).scrollLeft()), u = document.documentElement.clientHeight + (n ? 0 : t(document).scrollTop());
            return i.left -= this._get(e, "isRTL") ? s - o : 0, i.left -= n && i.left === e.input.offset().left ? t(document).scrollLeft() : 0, 
            i.top -= n && i.top === e.input.offset().top + a ? t(document).scrollTop() : 0, 
            i.left -= Math.min(i.left, i.left + s > l && l > s ? Math.abs(i.left + s - l) : 0), 
            i.top -= Math.min(i.top, i.top + r > u && u > r ? Math.abs(r + a) : 0), i;
        },
        _findPos: function(e) {
        ...
        _hideDatepicker: function(e) {
            ...
            i || s(), this._datepickerShowing = !1, r = this._get(o, "onClose"), r && r.apply(o.input ? o.input[0] : null, [ o.input ? o.input.val() : "", o ]), 
        ...
        _selectDay: function(e, i, n, s) {
            var r, o = t(e);
            t(s).hasClass(this._unselectableClass) || this._isDisabledDatepicker(o[0]) || (r = this._getInst(o[0]), 
            r.selectedDay = r.currentDay = t("a", s).html(), r.selectedMonth = r.currentMonth = i, 
            r.selectedYear = r.currentYear = n, this._selectDate(e, this._formatDate(r, r.currentDay, r.currentMonth, r.currentYear)));
        },
        ...
        _selectDate: function(e, i) {
            ...
            n = this._get(r, "onSelect"), n ? n.apply(r.input ? r.input[0] : null, [ i, r ]) : r.input && r.input.trigger("change"), 
        ...
        _updateAlternate: function(e) {
            ...
            r && (i = this._get(e, "altFormat") || this._get(e, "dateFormat"), n = this._getDate(e), 
            s = this.formatDate(i, n, this._getFormatConfig(e)), t(r).each(function() {
                t(this).val(s);
            }));
        },
        ...
        parseDate: function(e, i, n) {
            ...
            var s, r, o, a, l = 0, u = (n ? n.shortYearCutoff : null) || this._defaults.shortYearCutoff, c = "string" != typeof u ? u : new Date().getFullYear() % 100 + parseInt(u, 10), h = (n ? n.dayNamesShort : null) || this._defaults.dayNamesShort, d = (n ? n.dayNames : null) || this._defaults.dayNames, p = (n ? n.monthNamesShort : null) || this._defaults.monthNamesShort, f = (n ? n.monthNames : null) || this._defaults.monthNames, m = -1, g = -1, v = -1, b = -1, y = !1, _ = function(t) {
                var i = e.length > s + 1 && e.charAt(s + 1) === t;
                return i && s++, i;
            }, w = function(t) {
                var e = _(t), n = "@" === t ? 14 : "!" === t ? 20 : "y" === t && e ? 4 : "o" === t ? 3 : 2, s = "y" === t ? n : 1, r = RegExp("^\\d{" + s + "," + n + "}"), o = i.substring(l).match(r);
                if (!o) throw "Missing number at position " + l;
                return l += o[0].length, parseInt(o[0], 10);
            }, x = function(e, n, s) {
                var r = -1, o = t.map(_(e) ? s : n, function(t, e) {
                    return [ [ e, t ] ];
                }).sort(function(t, e) {
                ...
                if (t.each(o, function(t, e) {
                    var n = e[1];
                    return i.substr(l, n.length).toLowerCase() === n.toLowerCase() ? (r = e[0], l += n.length, 
                    !1) : void 0;
                }), -1 !== r) return r + 1;
            ...
            for (s = 0; e.length > s; s++) if (y) "'" !== e.charAt(s) || _("'") ? k() : y = !1; else switch (e.charAt(s)) {
              case "d":
                v = w("d");
                break;
              ...
              case "!":
                a = new Date((w("!") - this._ticksTo1970) / 1e4), m = a.getFullYear(), g = a.getMonth() + 1, 
                v = a.getDate();
                break;
            ...
            b > -1) for (g = 1, v = b; r = this._getDaysInMonth(m, g - 1), !(r >= v); ) g++, 
            v -= r;
        ...
        formatDate: function(t, e, i) {
            ...
            if (e) for (n = 0; t.length > n; n++) if (d) "'" !== t.charAt(n) || l("'") ? h += t.charAt(n) : d = !1; else switch (t.charAt(n)) {
              case "d":
                h += u("d", e.getDate(), 2);
                break;
        ...
        _setDateFromField: function(t, e) {
            if (t.input.val() !== t.lastVal) {
                ...
                t.currentDay = n ? r.getDate() : 0, t.currentMonth = n ? r.getMonth() : 0, t.currentYear = n ? r.getFullYear() : 0, 
        ...
        _determineDate: function(e, i, n) {
            var s = function(t) {
                ...
                for (var s = (i.toLowerCase().match(/^c/) ? t.datepicker._getDate(e) : null) || new Date(), r = s.getFullYear(), o = s.getMonth(), a = s.getDate(), l = /([+\-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, u = l.exec(i); u; ) {
                    switch (u[2] || "d") {
                      case "d":
                      case "D":
                        a += parseInt(u[1], 10);
                      ...
                      case "m":
                      case "M":
                        o += parseInt(u[1], 10), a = Math.min(a, t.datepicker._getDaysInMonth(r, o));
                        break;

                      case "y":
                      case "Y":
                        r += parseInt(u[1], 10), a = Math.min(a, t.datepicker._getDaysInMonth(r, o));
                    }
                    u = l.exec(i);
                }
                return new Date(r, o, a);
            }, o = null == i || "" === i ? n : "string" == typeof i ? r(i) : "number" == typeof i ? isNaN(i) ? n : s(i) : new Date(i.getTime());
            return o = o && "Invalid Date" == "" + o ? n : o, o && (o.setHours(0), o.setMinutes(0), 
        ...
        _setDate: function(t, e, i) {
            ...
            t.selectedDay = t.currentDay = o.getDate(), t.drawMonth = t.selectedMonth = t.currentMonth = o.getMonth(), 
            t.drawYear = t.selectedYear = t.currentYear = o.getFullYear(), s === t.selectedMonth && r === t.selectedYear || i || this._notifyChange(t), 
        ...
        _generateHTML: function(t) {
            var e, i, n, s, r, o, a, l, u, c, h, d, p, f, m, g, v, b, y, _, w, x, k, C, T, S, N, D, E, M, P, A, I, O, F, L, H, $, z, j = new Date(), R = this._daylightSavingAdjust(new Date(j.getFullYear(), j.getMonth(), j.getDate())), W = this._get(t, "isRTL"), q = this._get(t, "showButtonPanel"), B = this._get(t, "hideIfNoPrevNext"), V = this._get(t, "navigationAsDateFormat"), U = this._getNumberOfMonths(t), X = this._get(t, "showCurrentAtPos"), Y = this._get(t, "stepMonths"), K = 1 !== U[0] || 1 !== U[1], J = this._daylightSavingAdjust(t.currentDay ? new Date(t.currentYear, t.currentMonth, t.currentDay) : new Date(9999, 9, 9)), G = this._getMinMaxDate(t, "min"), Q = this._getMinMaxDate(t, "max"), Z = t.drawMonth - X, te = t.drawYear;
            ...
            0 > Z && (Z = 11, te--);
            for (t.drawMonth = Z, t.drawYear = te, i = this._get(t, "prevText"), i = V ? this.formatDate(i, this._daylightSavingAdjust(new Date(te, Z - Y, 1)), this._getFormatConfig(t)) : i, 
            n = this._canAdjustMonth(t, -1, te, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (W ? "e" : "w") + "'>" + i + "</span></a>" : B ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (W ? "e" : "w") + "'>" + i + "</span></a>", 
            s = this._get(t, "nextText"), s = V ? this.formatDate(s, this._daylightSavingAdjust(new Date(te, Z + Y, 1)), this._getFormatConfig(t)) : s, 
            r = this._canAdjustMonth(t, 1, te, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (W ? "w" : "e") + "'>" + s + "</span></a>" : B ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (W ? "w" : "e") + "'>" + s + "</span></a>", 
            o = this._get(t, "currentText"), a = this._get(t, "gotoCurrent") && t.currentDay ? J : R, 
            o = V ? this.formatDate(o, a, this._getFormatConfig(t)) : o, l = t.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(t, "closeText") + "</button>", 
            u = q ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (W ? l : "") + (this._isInRange(t, a) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + o + "</button>" : "") + (W ? "" : l) + "</div>" : "", 
            c = parseInt(this._get(t, "firstDay"), 10), c = isNaN(c) ? 0 : c, h = this._get(t, "showWeek"), 
            ...
            b = this._get(t, "selectOtherMonths"), y = this._getDefaultDate(t), _ = "", x = 0; U[0] > x; x++) {
                for (k = "", this.maxRows = 4, C = 0; U[1] > C; C++) {
                    if (T = this._daylightSavingAdjust(new Date(te, Z, t.selectedDay)), S = " ui-corner-all", 
                    N = "", K) {
                        if (N += "<div class='ui-datepicker-group", U[1] > 1) switch (C) {
                          case 0:
                            N += " ui-datepicker-group-first", S = " ui-corner-" + (W ? "right" : "left");
                            break;

                          case U[1] - 1:
                            N += " ui-datepicker-group-last", S = " ui-corner-" + (W ? "left" : "right");
                            break;
                    ...
                    for (N += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + S + "'>" + (/all|left/.test(S) && 0 === x ? W ? r : n : "") + (/all|right/.test(S) && 0 === x ? W ? n : r : "") + this._generateMonthYearHeader(t, Z, te, G, Q, x > 0 || C > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", 
                    D = h ? "<th class='ui-datepicker-week-col'>" + this._get(t, "weekHeader") + "</th>" : "", 
                    w = 0; 7 > w; w++) E = (w + c) % 7, D += "<th scope='col'" + ((w + c + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + d[E] + "'>" + p[E] + "</span></th>";
                    for (N += D + "</tr></thead><tbody>", M = this._getDaysInMonth(te, Z), te === t.selectedYear && Z === t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, M)), 
                    P = (this._getFirstDayOfMonth(te, Z) - c + 7) % 7, A = Math.ceil((P + M) / 7), I = K && this.maxRows > A ? this.maxRows : A, 
                    this.maxRows = I, O = this._daylightSavingAdjust(new Date(te, Z, 1 - P)), F = 0; I > F; F++) {
                        for (N += "<tr>", L = h ? "<td class='ui-datepicker-week-col'>" + this._get(t, "calculateWeek")(O) + "</td>" : "", 
                        w = 0; 7 > w; w++) H = g ? g.apply(t.input ? t.input[0] : null, [ O ]) : [ !0, "" ], 
                        $ = O.getMonth() !== Z, z = $ && !b || !H[0] || G && G > O || Q && O > Q, L += "<td class='" + ((w + c + 6) % 7 >= 5 ? " ui-datepicker-week-end" : "") + ($ ? " ui-datepicker-other-month" : "") + (O.getTime() === T.getTime() && Z === t.selectedMonth && t._keyEvent || y.getTime() === O.getTime() && y.getTime() === T.getTime() ? " " + this._dayOverClass : "") + (z ? " " + this._unselectableClass + " ui-state-disabled" : "") + ($ && !v ? "" : " " + H[1] + (O.getTime() === J.getTime() ? " " + this._currentClass : "") + (O.getTime() === R.getTime() ? " ui-datepicker-today" : "")) + "'" + ($ && !v || !H[2] ? "" : " title='" + H[2].replace(/'/g, "&#39;") + "'") + (z ? "" : " data-handler='selectDay' data-event='click' data-month='" + O.getMonth() + "' data-year='" + O.getFullYear() + "'") + ">" + ($ && !v ? "&#xa0;" : z ? "<span class='ui-state-default'>" + O.getDate() + "</span>" : "<a class='ui-state-default" + (O.getTime() === R.getTime() ? " ui-state-highlight" : "") + (O.getTime() === J.getTime() ? " ui-state-active" : "") + ($ ? " ui-priority-secondary" : "") + "' href='#'>" + O.getDate() + "</a>") + "</td>", 
                        O.setDate(O.getDate() + 1), O = this._daylightSavingAdjust(O);
                        N += L + "</tr>";
                    }
                    Z++, Z > 11 && (Z = 0, te++), N += "</tbody></table>" + (K ? "</div>" + (U[0] > 0 && C === U[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : ""), 
                    k += N;
                }
                _ += k;
            }
        ...
        _generateMonthYearHeader: function(t, e, i, n, s, r, o, a) {
            var l, u, c, h, d, p, f, m, g = this._get(t, "changeMonth"), v = this._get(t, "changeYear"), b = this._get(t, "showMonthAfterYear"), y = "<div class='ui-datepicker-title'>", _ = "";
            if (r || !g) _ += "<span class='ui-datepicker-month'>" + o[e] + "</span>"; else {
                ...
                c = 0; 12 > c; c++) (!l || c >= n.getMonth()) && (!u || s.getMonth() >= c) && (_ += "<option value='" + c + "'" + (c === e ? " selected='selected'" : "") + ">" + a[c] + "</option>");
                _ += "</select>";
            }
            if (b || (y += _ + (!r && g && v ? "" : "&#xa0;")), !t.yearshtml) if (t.yearshtml = "", 
            r || !v) y += "<span class='ui-datepicker-year'>" + i + "</span>"; else {
                for (h = this._get(t, "yearRange").split(":"), d = new Date().getFullYear(), p = function(t) {
                    var e = t.match(/c[+\-].*/) ? i + parseInt(t.substring(1), 10) : t.match(/[+\-].*/) ? d + parseInt(t, 10) : parseInt(t, 10);
                    return isNaN(e) ? d : e;
                }, f = p(h[0]), m = Math.max(f, p(h[1] || "")), f = n ? Math.max(f, n.getFullYear()) : f, 
                m = s ? Math.min(m, s.getFullYear()) : m, t.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; m >= f; f++) t.yearshtml += "<option value='" + f + "'" + (f === i ? " selected='selected'" : "") + ">" + f + "</option>";
                t.yearshtml += "</select>", y += t.yearshtml, t.yearshtml = null;
            }
            return y += this._get(t, "yearSuffix"), b && (y += (!r && g && v ? "" : "&#xa0;") + _), 
            y += "</div>";
        },
    ...
    t.datepicker.version = "1.11.1", t.datepicker, t.widget("ui.draggable", t.ui.mouse, {
        version: "1.11.1",
        ...
        _mouseDrag: function(e, i) {
            ...
            this.position = this._generatePosition(e, !0), this.positionAbs = this._convertPositionTo("absolute"), 
            !i) {
                var n = this._uiHash();
        ...
        _setContainment: function() {
            ...
            i = t(s.containment), n = i[0], void (n && (e = "hidden" !== i.css("overflow"), 
        ...
        _generatePosition: function(t, e) {
            ...
            t.pageY - this.offset.click.top > i[3] && (u = i[3] + this.offset.click.top)), o.grid && (s = o.grid[1] ? this.originalPageY + Math.round((u - this.originalPageY) / o.grid[1]) * o.grid[1] : this.originalPageY, 
            ...
            "y" === o.axis && (l = this.originalPageX), "x" === o.axis && (u = this.originalPageY)), 
            {
        ...
        _trigger: function(e, i, n) {
            return n = n || this._uiHash(), t.ui.plugin.call(this, e, [ i, n, this ], !0), "drag" === e && (this.positionAbs = this._convertPositionTo("absolute")), 
        ...
        drag: function(e, i, n) {
            ...
            t.each(n.sortables, function() {
                ...
                t.each(n.sortables, function() {
                    ...
                    this.instance.offset.click = n.offset.click, this !== o && this.instance._intersectsWith(this.instance.containerCache) && t.contains(o.instance.element[0], this.instance.element[0]) && (r = !1), 
                    r;
                })), r ? (this.instance.isOver || (this.instance.isOver = 1, this.instance.currentItem = t(s).clone().removeAttr("id").appendTo(this.instance.element).data("ui-sortable-item", !0), 
        ...
        drag: function(e, i, n) {
            ...
            o !== a && "HTML" !== o.tagName ? (s.axis && "x" === s.axis || (n.overflowOffset.top + o.offsetHeight - e.pageY < s.scrollSensitivity ? o.scrollTop = r = o.scrollTop + s.scrollSpeed : e.pageY - n.overflowOffset.top < s.scrollSensitivity && (o.scrollTop = r = o.scrollTop - s.scrollSpeed)), 
            s.axis && "y" === s.axis || (n.overflowOffset.left + o.offsetWidth - e.pageX < s.scrollSensitivity ? o.scrollLeft = r = o.scrollLeft + s.scrollSpeed : e.pageX - n.overflowOffset.left < s.scrollSensitivity && (o.scrollLeft = r = o.scrollLeft - s.scrollSpeed))) : (s.axis && "x" === s.axis || (e.pageY - t(a).scrollTop() < s.scrollSensitivity ? r = t(a).scrollTop(t(a).scrollTop() - s.scrollSpeed) : t(window).height() - (e.pageY - t(a).scrollTop()) < s.scrollSensitivity && (r = t(a).scrollTop(t(a).scrollTop() + s.scrollSpeed))), 
            s.axis && "y" === s.axis || (e.pageX - t(a).scrollLeft() < s.scrollSensitivity ? r = t(a).scrollLeft(t(a).scrollLeft() - s.scrollSpeed) : t(window).width() - (e.pageX - t(a).scrollLeft()) < s.scrollSensitivity && (r = t(a).scrollLeft(t(a).scrollLeft() + s.scrollSpeed)))), 
        ...
        drag: function(e, i, n) {
            var s, r, o, a, l, u, c, h, d, p, f = n.options, m = f.snapTolerance, g = i.offset.left, v = g + n.helperProportions.width, b = i.offset.top, y = b + n.helperProportions.height;
            for (d = n.snapElements.length - 1; d >= 0; d--) l = n.snapElements[d].left, u = l + n.snapElements[d].width, 
            c = n.snapElements[d].top, h = c + n.snapElements[d].height, l - m > v || g > u + m || c - m > y || b > h + m || !t.contains(n.snapElements[d].item.ownerDocument, n.snapElements[d].item) ? (n.snapElements[d].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
                snapItem: n.snapElements[d].item
            })), n.snapElements[d].snapping = !1) : ("inner" !== f.snapMode && (s = m >= Math.abs(c - y), 
            r = m >= Math.abs(h - b), o = m >= Math.abs(l - v), a = m >= Math.abs(u - g), s && (i.position.top = n._convertPositionTo("relative", {
                top: c - n.helperProportions.height,
                left: 0
            }).top - n.margins.top), r && (i.position.top = n._convertPositionTo("relative", {
                top: h,
                left: 0
            }).top - n.margins.top), o && (i.position.left = n._convertPositionTo("relative", {
                top: 0,
                left: l - n.helperProportions.width
            }).left - n.margins.left), a && (i.position.left = n._convertPositionTo("relative", {
                top: 0,
                left: u
            }).left - n.margins.left)), p = s || r || o || a, "outer" !== f.snapMode && (s = m >= Math.abs(c - b), 
            r = m >= Math.abs(h - y), o = m >= Math.abs(l - g), a = m >= Math.abs(u - v), s && (i.position.top = n._convertPositionTo("relative", {
                top: c,
                left: 0
            }).top - n.margins.top), r && (i.position.top = n._convertPositionTo("relative", {
            ...
            }).left - n.margins.left)), !n.snapElements[d].snapping && (s || r || o || a || p) && n.options.snap.snap && n.options.snap.snap.call(n.element, e, t.extend(n._uiHash(), {
                snapItem: n.snapElements[d].item
        ...
        _create: function() {
            ...
            r = "ui-resizable-" + n, s = t("<div class='ui-resizable-handle " + r + "'></div>"), 
            s.css({
                zIndex: a.zIndex
            ...
            this._renderAxis = function(e) {
                ...
                e.css(s, r), this._proportionallyResize()), t(this.handles[i]).length;
            }, this._renderAxis(this.element), this._handles = t(".ui-resizable-handle", this.element).disableSelection(), 
            this._handles.mouseover(function() {
                o.resizing || (this.className && (s = this.className.match(/ui-resizable-(se|sw|ne|nw|n|e|s|w)/i)), 
                o.axis = s && s[1] ? s[1] : "se");
        ...
        _mouseStart: function(e) {
            ...
            n = this._num(this.helper.css("top")), r.containment && (i += t(r.containment).scrollLeft() || 0, 
            n += t(r.containment).scrollTop() || 0), this.offset = this.helper.offset(), this.position = {
                left: i,
                top: n
        ...
        _mouseDrag: function(e) {
            var i, n, s = this.originalMousePosition, r = this.axis, o = e.pageX - s.left || 0, a = e.pageY - s.top || 0, l = this._change[r];
            return this._updatePrevProperties(), l ? (i = l.apply(this, [ e, o, a ]), this._updateVirtualBoundaries(e.shiftKey), 
        ...
        _mouseStop: function(e) {
            this.resizing = !1;
            var i, n, s, r, o, a, l, u = this.options, c = this;
            return this._helper && (i = this._proportionallyResizeElements, n = i.length && /textarea/i.test(i[0].nodeName), 
            s = n && this._hasScroll(i[0], "left") ? 0 : c.sizeDiff.height, r = n ? 0 : c.sizeDiff.width, 
            o = {
            ...
            u.animate || this.element.css(t.extend(o, {
                top: l,
                left: a
            })), c.helper.height(c.size.height), c.helper.width(c.size.width), this._helper && !u.animate && this._proportionallyResize()), 
        ...
        _updateVirtualBoundaries: function(t) {
            ...
            }, (this._aspectRatio || t) && (e = r.minHeight * this.aspectRatio, n = r.minWidth / this.aspectRatio, 
            i = r.maxHeight * this.aspectRatio, s = r.maxWidth / this.aspectRatio, e > r.minWidth && (r.minWidth = e), 
            n > r.minHeight && (r.minHeight = n), r.maxWidth > i && (r.maxWidth = i), r.maxHeight > s && (r.maxHeight = s)), 
            this._vBoundaries = r;
        },
        ...
        _respectSize: function(t) {
            ...
            return r && (t.width = e.minWidth), o && (t.height = e.minHeight), n && (t.width = e.maxWidth), 
            s && (t.height = e.maxHeight), r && u && (t.left = a - e.minWidth), n && u && (t.left = a - e.maxWidth), 
            o && c && (t.top = l - e.minHeight), s && c && (t.top = l - e.maxHeight), t.width || t.height || t.left || !t.top ? t.width || t.height || t.top || !t.left || (t.left = null) : t.top = null, 
            t;
        },
        _getPaddingPlusBorderDimensions: function(t) {
            for (var e = 0, i = [], n = [ t.css("borderTopWidth"), t.css("borderRightWidth"), t.css("borderBottomWidth"), t.css("borderLeftWidth") ], s = [ t.css("paddingTop"), t.css("paddingRight"), t.css("paddingBottom"), t.css("paddingLeft") ]; 4 > e; e++) i[e] = parseInt(n[e], 10) || 0, 
        ...
        stop: function(e) {
            var i = t(this).resizable("instance"), n = i.options, s = i._proportionallyResizeElements, r = s.length && /textarea/i.test(s[0].nodeName), o = r && i._hasScroll(s[0], "left") ? 0 : i.sizeDiff.height, a = r ? 0 : i.sizeDiff.width, l = {
                width: i.size.width - a,
                height: i.size.height - o
            }, u = parseInt(i.element.css("left"), 10) + (i.position.left - i.originalPosition.left) || null, c = parseInt(i.element.css("top"), 10) + (i.position.top - i.originalPosition.top) || null;
        ...
        start: function() {
            var e, i, n, s, r, o, a, l = t(this).resizable("instance"), u = l.options, c = l.element, h = u.containment, d = h instanceof t ? h.get(0) : /parent/.test(h) ? c.parent().get(0) : h;
            ...
            }, n = l.containerOffset, s = l.containerSize.height, r = l.containerSize.width, 
            o = l._hasScroll(d, "left") ? d.scrollWidth : r, a = l._hasScroll(d) ? d.scrollHeight : s, 
            l.parentData = {
                element: d,
                left: n.left,
                top: n.top,
        ...
        resize: function(e) {
            var i, n, s, r, o = t(this).resizable("instance"), a = o.options, l = o.containerOffset, u = o.position, c = o._aspectRatio || e.shiftKey, h = {
                top: 0,
                left: 0
            }, d = o.containerElement, p = !0;
            d[0] !== document && /static/.test(d.css("position")) && (h = l), u.left < (o._helper ? l.left : 0) && (o.size.width = o.size.width + (o._helper ? o.position.left - l.left : o.position.left - h.left), 
            c && (o.size.height = o.size.width / o.aspectRatio, p = !1), o.position.left = a.helper ? l.left : 0), 
            u.top < (o._helper ? l.top : 0) && (o.size.height = o.size.height + (o._helper ? o.position.top - l.top : o.position.top), 
            c && (o.size.width = o.size.height * o.aspectRatio, p = !1), o.position.top = o._helper ? l.top : 0), 
            s = o.containerElement.get(0) === o.element.parent().get(0), r = /relative|absolute/.test(o.containerElement.css("position")), 
            s && r ? (o.offset.left = o.parentData.left + o.position.left, o.offset.top = o.parentData.top + o.position.top) : (o.offset.left = o.element.offset().left, 
            o.offset.top = o.element.offset().top), i = Math.abs(o.sizeDiff.width + (o._helper ? o.offset.left - h.left : o.offset.left - l.left)), 
            n = Math.abs(o.sizeDiff.height + (o._helper ? o.offset.top - h.top : o.offset.top - l.top)), 
            i + o.size.width >= o.parentData.width && (o.size.width = o.parentData.width - i, 
            c && (o.size.height = o.size.width / o.aspectRatio, p = !1)), n + o.size.height >= o.parentData.height && (o.size.height = o.parentData.height - n, 
            c && (o.size.width = o.size.height * o.aspectRatio, p = !1)), p || (o.position.left = o.prevPosition.left, 
            o.position.top = o.prevPosition.top, o.size.width = o.prevSize.width, o.size.height = o.prevSize.height);
        },
        stop: function() {
            var e = t(this).resizable("instance"), i = e.options, n = e.containerOffset, s = e.containerPosition, r = e.containerElement, o = t(e.helper), a = o.offset(), l = o.outerWidth() - e.sizeDiff.width, u = o.outerHeight() - e.sizeDiff.height;
        ...
        resize: function() {
            var e, i = t(this).resizable("instance"), n = i.options, s = i.size, r = i.originalSize, o = i.originalPosition, a = i.axis, l = "number" == typeof n.grid ? [ n.grid, n.grid ] : n.grid, u = l[0] || 1, c = l[1] || 1, h = Math.round((s.width - r.width) / u) * u, d = Math.round((s.height - r.height) / c) * c, p = r.width + h, f = r.height + d, m = n.maxWidth && p > n.maxWidth, g = n.maxHeight && f > n.maxHeight, v = n.minWidth && n.minWidth > p, b = n.minHeight && n.minHeight > f;
            n.grid = l, v && (p += u), b && (f += c), m && (p -= u), g && (f -= c), /^(se|s|e)$/.test(a) ? (i.size.width = p, 
            i.size.height = f) : /^(ne)$/.test(a) ? (i.size.width = p, i.size.height = f, i.position.top = o.top - d) : /^(sw)$/.test(a) ? (i.size.width = p, 
            i.size.height = f, i.position.left = o.left - h) : ((0 >= f - c || 0 >= p - u) && (e = i._getPaddingPlusBorderDimensions(this)), 
            f - c > 0 ? (i.size.height = f, i.position.top = o.top - d) : (f = c - e.height, 
            i.size.height = f, i.position.top = o.top + r.height - f), p - u > 0 ? (i.size.width = p, 
            i.position.left = o.left - h) : (p = c - e.height, i.size.width = p, i.position.left = o.left + r.width - p));
        }
        ...
        _makeDraggable: function() {
            ...
            this.uiDialog.draggable({
                ...
                stop: function(s, r) {
                    var o = r.offset.left - i.document.scrollLeft(), a = r.offset.top - i.document.scrollTop();
                    n.position = {
                        my: "left top",
        ...
        _makeResizable: function() {
            ...
            this.uiDialog.resizable({
                ...
                stop: function(s, r) {
                    var o = i.uiDialog.offset(), a = o.left - i.document.scrollLeft(), l = o.top - i.document.scrollTop();
        ...
        _setOption: function(t, e) {
            ...
            "dialogClass" === t && s.removeClass(this.options.dialogClass).addClass(e), "disabled" !== t && (this._super(t, e), 
            ...
            "closeText" === t && this.uiDialogTitlebarClose.button({
                label: "" + e
            }), "draggable" === t && (i = s.is(":data(ui-draggable)"), i && !e && s.draggable("destroy"), 
            !i && e && this._makeDraggable()), "position" === t && this._position(), "resizable" === t && (n = s.is(":data(ui-resizable)"), 
            n && !e && s.resizable("destroy"), n && "string" == typeof e && s.resizable("option", "handles", e), 
            n || e === !1 || this._makeResizable()), "title" === t && this._title(this.uiDialogTitlebar.find(".ui-dialog-title")));
        },
        _size: function() {
        ...
        return function(e, i, n, s) {
            ...
            var r = (e.positionAbs || e.position.absolute).left, o = (e.positionAbs || e.position.absolute).top, a = r + e.helperProportions.width, l = o + e.helperProportions.height, u = i.offset.left, c = i.offset.top, h = u + i.proportions().width, d = c + i.proportions().height;
            switch (n) {
              case "fit":
                return r >= u && h >= a && o >= c && d >= l;

              case "intersect":
                return r + e.helperProportions.width / 2 > u && h > a - e.helperProportions.width / 2 && o + e.helperProportions.height / 2 > c && d > l - e.helperProportions.height / 2;

              case "pointer":
                return t(s.pageY, c, i.proportions().height) && t(s.pageX, u, i.proportions().width);

              case "touch":
                return (o >= c && d >= o || l >= c && d >= l || c > o && l > d) && (r >= u && h >= r || a >= u && h >= a || u > r && a > h);
        ...
        drag: function(e, i) {
            e.options.refreshPositions && t.ui.ddmanager.prepareOffsets(e, i), t.each(t.ui.ddmanager.droppables[e.options.scope] || [], function() {
                if (!this.options.disabled && !this.greedyChild && this.visible) {
                    var n, s, r, o = t.ui.intersect(e, this, this.options.tolerance, i), a = !o && this.isover ? "isout" : o && !this.isover ? "isover" : null;
                    a && (this.options.greedy && (s = this.options.scope, r = this.element.parents(":data(ui-droppable)").filter(function() {
                        return t(this).droppable("instance").options.scope === s;
                    }), r.length && (n = t(r[0]).droppable("instance"), n.greedyChild = "isover" === a)), 
    ...
    t.effects = {
        ...
        function n(i) {
            ...
            return i = i.toLowerCase(), f(l, function(t, r) {
                var o, a = r.re.exec(i), l = a && r.parse(a), u = r.space || "rgba";
        ...
        var r, o = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor", a = /^([\-+])=\s*(\d+\.?\d*)/, l = [ {
        ...
        f(c, function(t, e) {
            ...
            parse: function(s, o, a, l) {
                ...
                return o !== e && (s = [ s, o, a, l ], d = "array"), "string" === d ? this.parse(n(s) || r._default) : "array" === d ? (f(c.rgba.props, function(t, e) {
                    ...
                    f(n.props, function(t, e) {
                        ...
                        h[r][e.idx] = i(s[t], e, !0);
                    }), h[r] && 0 > t.inArray(null, h[r].slice(0, 3)) && (h[r][3] = 1, n.from && (h._rgba = n.from(h[r])));
                }), this) : e;
            },
            is: function(t) {
            ...
            transition: function(t, e) {
                var n = u(t), s = n._space(), r = c[s], o = 0 === this.alpha() ? u("transparent") : this, a = o[r.cache] || r.to(o._rgba), l = a.slice();
                return n = n[r.cache], f(r.props, function(t, s) {
                    var r = s.idx, o = a[r], u = n[r], c = h[s.type] || {};
                    null !== u && (null === o ? l[r] = u : (c.mod && (u - o > c.mod / 2 ? o += c.mod : o - u > c.mod / 2 && (o -= c.mod)), 
                    l[r] = i((u - o) * e + o, s)));
                }), this[s](l);
            },
            blend: function(e) {
            ...
            i = 0 === u ? 0 : .5 >= h ? u / c : u / (2 - c), [ Math.round(e) % 360, i, h, null == o ? 1 : o ];
        }, c.hsla.from = function(t) {
            if (null == t[0] || null == t[1] || null == t[2]) return [ null, null, null, t[3] ];
            var e = t[0] / 360, i = t[1], n = t[2], r = t[3], o = .5 >= n ? n * (1 + i) : n + i - n * i, a = 2 * n - o;
            return [ Math.round(255 * s(a, o, e + 1 / 3)), Math.round(255 * s(a, o, e)), Math.round(255 * s(a, o, e - 1 / 3)), r ];
        }, f(c, function(n, s) {
            var r = s.props, o = s.cache, l = s.to, c = s.from;
            u.fn[n] = function(n) {
                if (l && !this[o] && (this[o] = l(this._rgba)), n === e) return this[o].slice();
                var s, a = t.type(n), h = "array" === a || "object" === a ? n : arguments, d = this[o].slice();
                ...
                u.fn[e] || (u.fn[e] = function(s) {
                    var r, o = t.type(s), l = "alpha" === e ? this._hsla ? "hsla" : "rgba" : n, u = this[l](), c = u[i.idx];
                    return "undefined" === o ? c : ("function" === o && (s = s.call(this, c), o = t.type(s)), 
                    null == s && i.empty ? this : ("string" === o && (r = a.exec(s), r && (s = c + parseFloat(r[2]) * ("+" === r[1] ? 1 : -1))), 
                    u[i.idx] = s, this[l](u)));
                });
            });
        }), u.hook = function(e) {
        ...
        function e(e) {
            var i, n, s = e.ownerDocument.defaultView ? e.ownerDocument.defaultView.getComputedStyle(e, null) : e.currentStyle, r = {};
            if (s && s.length && s[0] && s[s[0]]) for (n = s.length; n--; ) i = s[n], "string" == typeof s[i] && (r[t.camelCase(i)] = s[i]); else for (i in s) "string" == typeof s[i] && (r[i] = s[i]);
            return r;
        }
        function i(e, i) {
            var n, r, o = {};
        ...
        t.each([ "borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle" ], function(e, i) {
            ...
            return this.queue(function() {
                var r, o = t(this), a = o.attr("class") || "", u = l.children ? o.find("*").addBack() : o;
                u = u.map(function() {
                    var i = t(this);
                    return {
                        el: i,
        ...
        t.extend(t.effects, {
            ...
            restore: function(t, e) {
                var i, n;
                for (n = 0; e.length > n; n++) null !== e[n] && (i = t.data(b + e[n]), void 0 === i && (i = ""), 
                t.css(e[n], i));
            },
            ...
            effect: function() {
                function i(e) {
                    ...
                    var s = t(this), r = n.complete, a = n.mode;
                    (s.is(":hidden") ? "hide" === a : "show" === a) ? (s[a](), i()) : o.call(s[0], n, i);
                }
                var n = e.apply(this, arguments), s = n.mode, r = n.queue, o = t.effects.effect[n.effect];
        ...
        var n, s, r, o = t(this), a = /up|down|vertical/, l = /up|left|vertical|horizontal/, u = [ "position", "top", "bottom", "left", "right", "height", "width" ], c = t.effects.setMode(o, e.mode || "hide"), h = e.direction || "up", d = a.test(h), p = d ? "height" : "width", f = d ? "top" : "left", m = l.test(h), g = {}, v = "show" === c;
        o.parent().is(".ui-effects-wrapper") ? t.effects.save(o.parent(), u) : t.effects.save(o, u), 
        o.show(), n = t.effects.createWrapper(o).css({
            overflow: "hidden"
            ...
            queue: !1,
            complete: function() {
                "hide" === c && o.hide(), t.effects.restore(o, u), t.effects.removeWrapper(o), i();
            }
        });
    }, t.effects.effect.bounce = function(e, i) {
        var n, s, r, o = t(this), a = [ "position", "top", "bottom", "left", "right", "height", "width" ], l = t.effects.setMode(o, e.mode || "effect"), u = "hide" === l, c = "show" === l, h = e.direction || "up", d = e.distance, p = e.times || 5, f = 2 * p + (c || u ? 1 : 0), m = e.duration / f, g = e.easing, v = "up" === h || "down" === h ? "top" : "left", b = "up" === h || "left" === h, y = o.queue(), _ = y.length;
        for ((c || u) && a.push("opacity"), t.effects.save(o, a), o.show(), t.effects.createWrapper(o), 
        d || (d = o["top" === v ? "outerHeight" : "outerWidth"]() / 3), c && (r = {
            opacity: 1
        }, r[v] = 0, o.css("opacity", 0).css(v, b ? 2 * -d : 2 * d).animate(r, m, g)), u && (d /= Math.pow(2, p - 1)), 
        r = {}, r[v] = 0, n = 0; p > n; n++) s = {}, s[v] = (b ? "-=" : "+=") + d, o.animate(s, m, g).animate(r, m, g), 
        d = u ? 2 * d : d / 2;
        u && (s = {
            opacity: 0
        }, s[v] = (b ? "-=" : "+=") + d, o.animate(s, m, g)), o.queue(function() {
        ...
        t.effects.save(o, a), o.show(), n = t.effects.createWrapper(o).css({
            overflow: "hidden"
        }), s = "IMG" === o[0].tagName ? n : o, r = s[d](), u && (s.css(d, 0), s.css(p, r / 2)), 
        f[d] = u ? r : 0, f[p] = u ? 0 : r / 2, s.animate(f, {
            queue: !1,
            duration: e.duration,
            easing: e.easing,
            complete: function() {
        ...
        var n, s = t(this), r = [ "position", "top", "bottom", "left", "right", "opacity", "height", "width" ], o = t.effects.setMode(s, e.mode || "hide"), a = "show" === o, l = e.direction || "left", u = "up" === l || "down" === l ? "top" : "left", c = "up" === l || "left" === l ? "pos" : "neg", h = {
            opacity: a ? 1 : 0
        };
        t.effects.save(s, r), s.show(), t.effects.createWrapper(s), n = e.distance || s["top" === u ? "outerHeight" : "outerWidth"](!0) / 2, 
        a && s.css("opacity", 0).css(u, "pos" === c ? -n : n), h[u] = (a ? "pos" === c ? "+=" : "-=" : "pos" === c ? "-=" : "+=") + n, 
        s.animate(h, {
            queue: !1,
            duration: e.duration,
            easing: e.easing,
        ...
        var r, o, a, l, u, c, h = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, d = h, p = t(this), f = t.effects.setMode(p, e.mode || "hide"), m = "show" === f, g = p.show().css("visibility", "hidden").offset(), v = Math.ceil(p.outerWidth() / d), b = Math.ceil(p.outerHeight() / h), y = [];
        for (r = 0; h > r; r++) for (l = g.top + r * b, c = r - (h - 1) / 2, o = 0; d > o; o++) a = g.left + o * v, 
        u = o - (d - 1) / 2, p.clone().appendTo("body").wrap("<div></div>").css({
            position: "absolute",
            visibility: "visible",
            left: -o * v,
            top: -r * b
        ...
        t.effects.save(r, o), r.show(), n = t.effects.createWrapper(r).css({
            overflow: "hidden"
        }), s = p ? [ n.width(), n.height() ] : [ n.height(), n.width() ], h && (c = parseInt(h[1], 10) / 100 * s[u ? 0 : 1]), 
        l && n.css(d ? {
            height: 0,
            width: c
        } : {
        ...
        var n = t(this), s = [ "backgroundImage", "backgroundColor", "opacity" ], r = t.effects.setMode(n, e.mode || "show"), o = {
        ...
        }, "toggle" === e.mode && "show" === p ? (o.from = e.to || y, o.to = e.from || n) : (o.from = e.from || ("show" === p ? y : n), 
        o.to = e.to || ("hide" === p ? y : n)), r = {
            from: {
        ...
        }, ("box" === m || "both" === m) && (r.from.y !== r.to.y && (b = b.concat(h), o.from = t.effects.setTransition(o, h, r.from.y, o.from), 
        o.to = t.effects.setTransition(o, h, r.to.y, o.to)), r.from.x !== r.to.x && (b = b.concat(d), 
        o.from = t.effects.setTransition(o, d, r.from.x, o.from), o.to = t.effects.setTransition(o, d, r.to.x, o.to))), 
        ("content" === m || "both" === m) && r.from.y !== r.to.y && (b = b.concat(c).concat(u), 
        o.from = t.effects.setTransition(o, c, r.from.y, o.from), o.to = t.effects.setTransition(o, c, r.to.y, o.to)), 
        t.effects.save(o, b), o.show(), t.effects.createWrapper(o), o.css("overflow", "hidden").css(o.from), 
        g && (s = t.effects.getBaseline(g, n), o.from.top = (n.outerHeight - o.outerHeight()) * s.y, 
        o.from.left = (n.outerWidth - o.outerWidth()) * s.x, o.to.top = (n.outerHeight - o.to.outerHeight) * s.y, 
        o.to.left = (n.outerWidth - o.to.outerWidth) * s.x), o.css(o.from), ("content" === m || "both" === m) && (h = h.concat([ "marginTop", "marginBottom" ]).concat(c), 
        d = d.concat([ "marginLeft", "marginRight" ]), u = a.concat(h).concat(d), o.find("*[width]").each(function() {
            var i = t(this), n = {
                height: i.height(),
                width: i.width(),
            ...
            }, r.from.y !== r.to.y && (i.from = t.effects.setTransition(i, h, r.from.y, i.from), 
            i.to = t.effects.setTransition(i, h, r.to.y, i.to)), r.from.x !== r.to.x && (i.from = t.effects.setTransition(i, d, r.from.x, i.from), 
            ...
            complete: function() {
                ...
                t.effects.restore(o, b), f || ("static" === v ? o.css({
                    position: "relative",
                    top: o.to.top,
                    left: o.to.left
        ...
        var n = t(this), s = t.extend(!0, {}, e), r = t.effects.setMode(n, e.mode || "effect"), o = parseInt(e.percent, 10) || (0 === parseInt(e.percent, 10) ? 0 : "hide" === r ? 0 : 100), a = e.direction || "both", l = e.origin, u = {
            height: n.height(),
            width: n.width(),
        ...
        s.restore = !0), s.from = e.from || ("show" === r ? {
            height: 0,
            width: 0,
            outerHeight: 0,
            outerWidth: 0
        ...
        var n = t(this), s = t.effects.setMode(n, e.mode || "hide"), r = "hide" === s, o = parseInt(e.percent, 10) || 150, a = o / 100, l = {
            height: n.height(),
            width: n.width(),
            outerHeight: n.outerHeight(),
            outerWidth: n.outerWidth()
        ...
        var n, s = t(this), r = [ "position", "top", "bottom", "left", "right", "height", "width" ], o = t.effects.setMode(s, e.mode || "effect"), a = e.direction || "left", l = e.distance || 20, u = e.times || 3, c = 2 * u + 1, h = Math.round(e.duration / c), d = "up" === a || "down" === a ? "top" : "left", p = "up" === a || "left" === a, f = {}, m = {}, g = {}, v = s.queue(), b = v.length;
        for (t.effects.save(s, r), s.show(), t.effects.createWrapper(s), f[d] = (p ? "-=" : "+=") + l, 
        m[d] = (p ? "+=" : "-=") + 2 * l, g[d] = (p ? "-=" : "+=") + 2 * l, s.animate(f, h, e.easing), 
        n = 1; u > n; n++) s.animate(m, h, e.easing).animate(g, h, e.easing);
        ...
        t.effects.save(s, r), s.show(), n = e.distance || s["top" === u ? "outerHeight" : "outerWidth"](!0), 
        t.effects.createWrapper(s).css({
            overflow: "hidden"
        }), a && s.css(u, c ? isNaN(n) ? "-" + n : -n : n), h[u] = (a ? c ? "+=" : "-=" : c ? "-=" : "+=") + n, 
        s.animate(h, {
            queue: !1,
            duration: e.duration,
            easing: e.easing,
        ...
        var n = t(this), s = t(e.to), r = "fixed" === s.css("position"), o = t("body"), a = r ? o.scrollTop() : 0, l = r ? o.scrollLeft() : 0, u = s.offset(), c = {
            top: u.top - a,
            left: u.left - l,
            height: s.innerHeight(),
            width: s.innerWidth()
        }, h = n.offset(), d = t("<div class='ui-effects-transfer'></div>").appendTo(document.body).addClass(e.className).css({
            top: h.top - a,
            left: h.left - l,
        ...
        _mouseDrag: function(e) {
            if (this.dragged = !0, !this.options.disabled) {
                ...
                return r > a && (i = a, a = r, r = i), o > l && (i = l, l = o, o = i), this.helper.css({
                    ...
                    i && i.element !== n.element[0] && ("touch" === s.tolerance ? u = !(i.left > a || r > i.right || i.top > l || o > i.bottom) : "fit" === s.tolerance && (u = i.left > r && a > i.right && i.top > o && l > i.bottom), 
                    u ? (i.selected && (i.$element.removeClass("ui-selected"), i.selected = !1), i.unselecting && (i.$element.removeClass("ui-unselecting"), 
        ...
        close: function(t) {
            this.isOpen && (this.isOpen = !1, this._toggleAttr(), this._off(this.document), 
        ...
        _move: function(t, e) {
            ...
            s += ":not(.ui-state-disabled)"), n = "first" === t || "last" === t ? i["first" === t ? "prevAll" : "nextAll"](s).eq(-1) : i[t + "All"](s).eq(0), 
        ...
        _createHandles: function() {
            var e, i, n = this.options, s = this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"), r = "<span class='ui-slider-handle ui-state-default ui-corner-all' tabindex='0'></span>", o = [];
            for (i = n.values && n.values.length || 1, s.length > i && (s.slice(i).remove(), 
            s = s.slice(0, i)), e = s.length; i > e; e++) o.push(r);
        ...
        _mouseCapture: function(e) {
            ...
            this.handles.each(function(e) {
                ...
                r = t(this), o = e);
            }), a = this._start(e, o), a === !1 ? !1 : (this._mouseSliding = !0, this._handleIndex = o, 
            r.addClass("ui-state-active").focus(), l = r.offset(), u = !t(e.target).parents().addBack().is(".ui-slider-handle"), 
            this._clickOffset = u ? {
                left: 0,
                top: 0
            } : {
            ...
            }, this.handles.hasClass("ui-state-hover") || this._slide(e, o, n), this._animateOff = !0, 
            !0));
        },
        _mouseStart: function() {
            return !0;
        ...
        _slide: function(t, e, i) {
            ...
            i !== this.values(e) && (s = this.values(), s[e] = i, r = this._trigger("slide", t, {
                handle: this.handles[e],
                value: i,
                values: s
        ...
        _refreshValue: function() {
            ...
            this.options.values && this.options.values.length ? this.handles.each(function(n) {
                i = 100 * ((l.values(n) - l._valueMin()) / (l._valueMax() - l._valueMin())), c["horizontal" === l.orientation ? "left" : "bottom"] = i + "%", 
                t(this).stop(1, 1)[u ? "animate" : "css"](c, a.animate), l.options.range === !0 && ("horizontal" === l.orientation ? (0 === n && l.range.stop(1, 1)[u ? "animate" : "css"]({
                    left: i + "%"
            ...
            }) : (n = this.value(), s = this._valueMin(), r = this._valueMax(), i = r !== s ? 100 * ((n - s) / (r - s)) : 0, 
            c["horizontal" === this.orientation ? "left" : "bottom"] = i + "%", this.handle.stop(1, 1)[u ? "animate" : "css"](c, a.animate), 
        ...
        _handleEvents: {
            keydown: function(e) {
                ...
                switch (r = this.options.step, n = s = this.options.values && this.options.values.length ? this.values(o) : this.value(), 
                e.keyCode) {
                  case t.ui.keyCode.HOME:
                    s = this._valueMin();
                    break;
        ...
        _mouseStart: function(e, i, n) {
            ...
            this.storedCursor = r.css("cursor"), r.css("cursor", o.cursor), this.storedStylesheet = t("<style>*{ cursor: " + o.cursor + " !important; }</style>").appendTo(r)), 
        ...
        _mouseDrag: function(e) {
            ...
            e.pageX - t(document).scrollLeft() < o.scrollSensitivity ? a = t(document).scrollLeft(t(document).scrollLeft() - o.scrollSpeed) : t(window).width() - (e.pageX - t(document).scrollLeft()) < o.scrollSensitivity && (a = t(document).scrollLeft(t(document).scrollLeft() + o.scrollSpeed))), 
            a !== !1 && t.ui.ddmanager && !o.dropBehaviour && t.ui.ddmanager.prepareOffsets(this, e)), 
            this.positionAbs = this._convertPositionTo("absolute"), this.options.axis && "y" === this.options.axis || (this.helper[0].style.left = this.position.left + "px"), 
            this.options.axis && "x" === this.options.axis || (this.helper[0].style.top = this.position.top + "px"), 
            i = this.items.length - 1; i >= 0; i--) if (n = this.items[i], s = n.item[0], r = this._intersectsWithPointer(n), 
            r && n.instance === this.currentContainer && s !== this.currentItem[0] && this.placeholder[1 === r ? "next" : "prev"]()[0] !== s && !t.contains(this.placeholder[0], s) && ("semi-dynamic" === this.options.type ? !t.contains(this.element[0], s) : !0)) {
        ...
        _intersectsWith: function(t) {
            var e = this.positionAbs.left, i = e + this.helperProportions.width, n = this.positionAbs.top, s = n + this.helperProportions.height, r = t.left, o = r + t.width, a = t.top, l = a + t.height, u = this.offset.click.top, c = this.offset.click.left, h = "x" === this.options.axis || n + u > a && l > n + u, d = "y" === this.options.axis || e + c > r && o > e + c, p = h && d;
        ...
        _intersectsWithPointer: function(t) {
            var e = "x" === this.options.axis || this._isOverAxis(this.positionAbs.top + this.offset.click.top, t.top, t.height), i = "y" === this.options.axis || this._isOverAxis(this.positionAbs.left + this.offset.click.left, t.left, t.width), n = e && i, s = this._getDragVerticalDirection(), r = this._getDragHorizontalDirection();
        ...
        _getItemsAsjQuery: function(e) {
            ...
            var n, s, r, o, a = [], l = [], u = this._connectWith();
            if (u && e) for (n = u.length - 1; n >= 0; n--) for (r = t(u[n]), s = r.length - 1; s >= 0; s--) o = t.data(r[s], this.widgetFullName), 
        ...
        _refreshItems: function(e) {
            ...
            var i, n, s, r, o, a, l, u, c = this.items, h = [ [ t.isFunction(this.options.items) ? this.options.items.call(this.element[0], e, {
                item: this.currentItem
            }) : t(this.options.items, this.element), this ] ], d = this._connectWith();
            if (d && this.ready) for (i = d.length - 1; i >= 0; i--) for (s = t(d[i]), n = s.length - 1; n >= 0; n--) r = t.data(s[n], this.widgetFullName), 
            r && r !== this && !r.options.disabled && (h.push([ t.isFunction(r.options.items) ? r.options.items.call(r.element[0], e, {
                item: this.currentItem
            }) : t(r.options.items, r.element), r ]), this.containers.push(r));
            for (i = h.length - 1; i >= 0; i--) for (o = h[i][1], a = h[i][0], n = 0, u = a.length; u > n; n++) l = t(a[n]), 
            l.data(this.widgetName + "-item", o), c.push({
                item: l,
                instance: o,
                width: 0,
                height: 0,
        ...
        refreshPositions: function(e) {
            ...
            e || (n.width = s.outerWidth(), n.height = s.outerHeight()), r = s.offset(), n.left = r.left, 
            n.top = r.top);
        ...
        _contactContainers: function(e) {
            var i, n, s, r, o, a, l, u, c, h, d = null, p = null;
            ...
            this.containers[p].containerCache.over = 1); else {
                for (s = 1e4, r = null, c = d.floating || this._isFloating(this.currentItem), o = c ? "left" : "top", 
                a = c ? "width" : "height", h = c ? "clientX" : "clientY", n = this.items.length - 1; n >= 0; n--) t.contains(this.containers[p].element[0], this.items[n].item[0]) && this.items[n].item[0] !== this.currentItem[0] && (l = this.items[n].item.offset()[o], 
                u = !1, e[h] - l > this.items[n][a] / 2 && (u = !0), s > Math.abs(e[h] - l) && (s = Math.abs(e[h] - l), 
                r = this.items[n], this.direction = u ? "up" : "down"));
                if (!r && !this.options.dropOnEmpty) return;
                if (this.currentContainer === this.containers[p]) return;
                r ? this._rearrange(e, r, null, !0) : this._rearrange(e, null, this.containers[p].element, !0), 
        ...
        _processTabs: function() {
            ...
            this.tablist = this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role", "tablist").delegate("> li", "mousedown" + this.eventNamespace, function(e) {
                ...
                var s, r, o, a = t(n).uniqueId().attr("id"), l = t(n).closest("li"), u = l.attr("aria-controls");
                e._isLocal(n) ? (s = n.hash, o = s.substring(1), r = e.element.find(e._sanitizeSelector(s))) : (o = l.attr("aria-controls") || t({}).uniqueId()[0].id, 
                s = "#" + o, r = e.element.find(s), r.length || (r = e._createPanel(o), r.insertAfter(e.panels[i - 1] || e.tablist)), 
                r.attr("aria-live", "polite")), r.length && (e.panels = e.panels.add(r)), u && l.data("ui-tabs-aria-controls", u), 
                l.attr({
                    "aria-controls": o,
                    "aria-labelledby": a
        ...
        _eventHandler: function(e) {
            var i = this.options, n = this.active, s = t(e.currentTarget), r = s.closest("li"), o = r[0] === n[0], a = o && i.collapsible, l = a ? t() : this._getPanelForTab(r), u = n.length ? this._getPanelForTab(n) : t(), c = {
                oldTab: n,
                oldPanel: u,
                newTab: a ? t() : r,
                newPanel: l
            };
            e.preventDefault(), r.hasClass("ui-state-disabled") || r.hasClass("ui-tabs-loading") || this.running || o && !i.collapsible || this._trigger("beforeActivate", e, c) === !1 || (i.active = a ? !1 : this.tabs.index(r), 
            this.active = o ? t() : r, this.xhr && this.xhr.abort(), u.length || l.length || t.error("jQuery UI Tabs: Mismatching fragment identifier."), 
            l.length && this.load(this.tabs.index(r), e), this._toggle(e, c));
        },
        _toggle: function(e, i) {
            ...
            s()), a.attr("aria-hidden", "true"), i.oldTab.attr({
                "aria-selected": "false",
                "aria-expanded": "false"
        ...
        load: function(e, i) {
            e = this._getIndex(e);
            var n = this, s = this.tabs.eq(e), r = s.find(".ui-tabs-anchor"), o = this._getPanelForTab(s), a = {
                tab: s,
                panel: o
            };
            this._isLocal(r[0]) || (this.xhr = t.ajax(this._ajaxSettings(r, i, a)), this.xhr && "canceled" !== this.xhr.statusText && (s.addClass("ui-tabs-loading"), 
            o.attr("aria-busy", "true"), this.xhr.success(function(t) {
                setTimeout(function() {
                    o.html(t), n._trigger("load", i, a);
                }, 1);
            }).complete(function(t, e) {
                setTimeout(function() {
                    "abort" === e && n.panels.stop(!1, !0), s.removeClass("ui-tabs-loading"), o.removeAttr("aria-busy"), 
        ...
        _removeDescribedBy: function(e) {
            ...
            -1 !== s && n.splice(s, 1), e.removeData("ui-tooltip-id"), n = t.trim(n.join(" ")), 
        ...
        _open: function(e, i, n) {
            ...
            var r, o, a, l, u = t.extend({}, this.options.position);
            if (n) {
                if (r = this._find(i), r.length) return void r.find(".ui-tooltip-content").html(n);
                i.is("[title]") && (e && "mouseover" === e.type ? i.attr("title", "") : i.removeAttr("title")), 
                r = this._tooltip(i), this._addDescribedBy(i, r.attr("id")), r.find(".ui-tooltip-content").html(n), 
                this.liveRegion.children().hide(), n.clone ? (l = n.clone(), l.removeAttr("id").find("[id]").removeAttr("id")) : l = n, 
                t("<div>").html(l).appendTo(this.liveRegion), this.options.track && e && /^mouse/.test(e.type) ? (this._on(this.document, {
                    mousemove: s
                }), s(e)) : r.position(t.extend({
                    of: i
                }, this.options.position)), this.hiding = !1, this.closing = !1, r.hide(), this._show(r, this.options.show), 
        ...
        close: function(e) {
            ...
            this.closing || (clearInterval(this.delayedShow), n.data("ui-tooltip-title") && !n.attr("title") && n.attr("title", n.data("ui-tooltip-title")), 
            this._removeDescribedBy(n), this.hiding = !0, s.stop(!0), this._hide(s, this.options.hide, function() {
        ...
        _destroy: function() {
            ...
            t.each(this.tooltips, function(i, n) {
                var s = t.Event("blur");
                s.target = s.currentTarget = n[0], e.close(s, !0), t("#" + i).remove(), n.data("ui-tooltip-title") && (n.attr("title") || n.attr("title", n.data("ui-tooltip-title")), 
                n.removeData("ui-tooltip-title"));
            }), this.liveRegion.remove();
        }
    });
}), function(t, e, i) {
    var n, s, r, o, a, l, u, c, h, d, p, f, m, g, v, b, y, _, w, x, k, C, T, S, N, D, E, M, P, A, I;
    T = {
        paneClass: "nano-pane",
        ...
        windowContext: null
    }, _ = "scrollbar", y = "scroll", h = "mousedown", d = "mouseenter", p = "mousemove", 
    m = "mousewheel", f = "mouseup", b = "resize", a = "drag", l = "enter", x = "up", 
    v = "panedown", r = "DOMMouseScroll", o = "down", k = "wheel", u = "keydown", c = "keyup", 
    w = "touchmove", n = "Microsoft Internet Explorer" === e.navigator.appName && /msie 7./i.test(e.navigator.appVersion) && e.ActiveXObject, 
    s = null, E = e.requestAnimationFrame, C = e.cancelAnimationFrame, P = i.createElement("div").style, 
    I = function() {
        var t, e, i, n, s, r;
        for (n = [ "t", "webkitT", "MozT", "msT", "OT" ], t = s = 0, r = n.length; r > s; t = ++s) if (i = n[t], 
        e = n[t] + "ransform", e in P) return n[t].substr(0, n[t].length - 1);
        return !1;
    }(), A = function(t) {
        return I === !1 ? !1 : "" === I ? t : I + t.charAt(0).toUpperCase() + t.substr(1);
    }, M = A("transform"), N = M !== !1, S = function() {
        var t, e, n;
        return t = i.createElement("div"), e = t.style, e.position = "absolute", e.width = "100px", 
        e.height = "100px", e.overflow = y, e.top = "-9999px", i.body.appendChild(t), n = t.offsetWidth - t.clientWidth, 
        i.body.removeChild(t), n;
    }, D = function() {
        var t, i, n;
        return i = e.navigator.userAgent, (t = /(?=.+Mac OS X)(?=.+Firefox)/.test(i)) ? (n = /Firefox\/\d{2}\./.exec(i), 
        n && (n = n[0].replace(/\D+/g, "")), t && +n > 23) : !1;
    }, g = function() {
        function u(n, r) {
            this.el = n, this.options = r, s || (s = S()), this.$el = t(this.el), this.doc = t(this.options.documentContext || i), 
            this.win = t(this.options.windowContext || e), this.body = this.doc.find("body"), 
            this.$content = this.$el.children("." + r.contentClass), this.$content.attr("tabindex", this.options.tabIndex || 0), 
        ...
        return u.prototype.preventScrolling = function(t, e) {
            if (this.isActive) if (t.type === r) (e === o && t.originalEvent.detail > 0 || e === x && t.originalEvent.detail < 0) && t.preventDefault(); else if (t.type === m) {
                if (!t.originalEvent || !t.originalEvent.wheelDelta) return;
                (e === o && t.originalEvent.wheelDelta < 0 || e === x && t.originalEvent.wheelDelta > 0) && t.preventDefault();
            }
            ...
            var t, e;
            t = this.content, this.maxScrollTop = t.scrollHeight - t.clientHeight, this.prevScrollTop = this.contentScrollTop || 0, 
            this.contentScrollTop = t.scrollTop, e = this.contentScrollTop > this.previousPosition ? "down" : this.contentScrollTop < this.previousPosition ? "up" : "same", 
            this.previousPosition = this.contentScrollTop, "same" !== e && this.$el.trigger("update", {
            ...
            var t;
            N ? (t = {}, t[M] = "translate(0, " + this.sliderTop + "px)") : t = {
                top: this.sliderTop
            }, E ? (C && this.scrollRAF && C(this.scrollRAF), this.scrollRAF = E(function(e) {
                return function() {
            ...
            this.events = {
                down: function(t) {
                    return function(e) {
                        return t.isBeingDragged = !0, t.offsetY = e.pageY - t.slider.offset().top, t.slider.is(e.target) || (t.offsetY = 0), 
                        t.pane.addClass("active"), t.doc.bind(p, t.events[a]).bind(f, t.events[x]), t.body.bind(d, t.events[l]), 
                        !1;
                    };
                }(this),
                drag: function(t) {
                    return function(e) {
                        ...
                        t.scroll(), t.contentScrollTop >= t.maxScrollTop && t.prevScrollTop !== t.maxScrollTop ? t.$el.trigger("scrollend") : 0 === t.contentScrollTop && 0 !== t.prevScrollTop && t.$el.trigger("scrolltop"), 
                        !1;
                    };
                }(this),
                up: function(t) {
                    return function() {
                        return t.isBeingDragged = !1, t.pane.removeClass("active"), t.doc.unbind(p, t.events[a]).unbind(f, t.events[x]), 
                        t.body.unbind(d, t.events[l]), !1;
                    };
                }(this),
                resize: function(t) {
                    return function() {
                ...
                panedown: function(t) {
                    return function(e) {
                        ...
                        t.scroll(), t.events.down(e), !1;
                    };
                }(this),
                scroll: function(t) {
                    return function(e) {
                        t.updateScrollValues(), t.isBeingDragged || (t.iOSNativeScrolling || (t.sliderY = t.sliderTop, 
                        t.setOnScrollStyles()), null != e && (t.contentScrollTop >= t.maxScrollTop ? (t.options.preventPageScrolling && t.preventScrolling(e, o), 
                        t.prevScrollTop !== t.maxScrollTop && t.$el.trigger("scrollend")) : 0 === t.contentScrollTop && (t.options.preventPageScrolling && t.preventScrolling(e, x), 
            ...
            var t;
            this.removeEvents(), t = this.events, this.options.disableResize || this.win.bind(b, t[b]), 
            this.iOSNativeScrolling || (this.slider.bind(h, t[o]), this.pane.bind(h, t[v]).bind("" + m + " " + r, t[k])), 
            this.$content.bind("" + y + " " + m + " " + r + " " + w, t[y]);
        }, u.prototype.removeEvents = function() {
            var t;
            t = this.events, this.win.unbind(b, t[b]), this.iOSNativeScrolling || (this.slider.unbind(), 
            this.pane.unbind()), this.$content.unbind("" + y + " " + m + " " + r + " " + w, t[y]);
        }, u.prototype.generate = function() {
            var t, i, n, r, o, a, l;
            return r = this.options, a = r.paneClass, l = r.sliderClass, t = r.contentClass, 
            (o = this.$el.children("." + a)).length || o.children("." + l).length || this.$el.append('<div class="' + a + '"><div class="' + l + '" /></div>'), 
            this.pane = this.$el.children("." + a), this.slider = this.pane.find("." + l), 0 === s && D() ? (n = e.getComputedStyle(this.content, null).getPropertyValue("padding-right").replace(/[^0-9.]+/g, ""), 
            i = {
                right: -14,
                paddingRight: +n + 14
            }) : s && (i = {
            ...
            this.stopped && this.restore(), t = this.content, r = t.style, o = r.overflowY, 
            n && this.$content.css({
                height: this.$content.height()
            }), e = t.scrollHeight + s, h = parseInt(this.$el.css("max-height"), 10), h > 0 && (this.$el.height(""), 
            this.$el.height(t.scrollHeight > h ? h : t.scrollHeight)), l = this.pane.outerHeight(!1), 
            c = parseInt(this.pane.css("top"), 10), a = parseInt(this.pane.css("bottom"), 10), 
            u = l + c + a, p = Math.round(u / e * u), p < this.options.sliderMinHeight ? p = this.options.sliderMinHeight : null != this.options.sliderMaxHeight && p > this.options.sliderMaxHeight && (p = this.options.sliderMaxHeight), 
            o === y && r.overflowX !== y && (p += s), this.maxSliderTop = u - p, this.contentHeight = e, 
            this.paneHeight = l, this.paneOuterHeight = u, this.sliderHeight = p, this.paneTop = c, 
            this.slider.height(p), this.events.scroll(), this.pane.show(), this.isActive = !0, 
            t.scrollHeight === t.clientHeight || this.pane.outerHeight(!0) >= t.scrollHeight && o !== y ? (this.pane.hide(), 
            this.isActive = !1) : this.el.clientHeight === t.scrollHeight && o === y ? this.slider.hide() : this.slider.show(), 
            this.pane.css({
                opacity: this.options.alwaysVisible ? 1 : "",
                visibility: this.options.alwaysVisible ? "visible" : ""
            }), i = this.$content.css("position"), ("static" === i || "relative" === i) && (d = parseInt(this.$content.css("right"), 10), 
            d && this.$content.css({
                right: "",
                marginRight: d
            })), this);
        ...
        }, u.prototype.scrollBottom = function(t) {
            return this.isActive ? (this.$content.scrollTop(this.contentHeight - this.$content.height() - t).trigger(m), 
            this.stop().restore(), this) : void 0;
        }, u.prototype.scrollTop = function(t) {
            return this.isActive ? (this.$content.scrollTop(+t).trigger(m), this.stop().restore(), 
            this) : void 0;
        }, u.prototype.scrollTo = function(t) {
            return this.isActive ? (this.scrollTop(this.$el.find(t).get(0).offsetTop), this) : void 0;
        }, u.prototype.stop = function() {
            return C && this.scrollRAF && (C(this.scrollRAF), this.scrollRAF = null), this.stopped = !0, 
            ...
            n && this.$content.height(""), this.$content.removeAttr("tabindex"), this.$el.hasClass("has-scrollbar") && (this.$el.removeClass("has-scrollbar"), 
            this.$content.css({
                right: ""
            })), this;
        ...
        return this.each(function() {
            var i, n;
            if ((n = this.nanoscroller) || (i = t.extend({}, T, e), this.nanoscroller = n = new g(this, i)), 
            e && "object" == typeof e) {
...
}(jQuery, window, document), define("nanoscroller", [ "jquery" ], function(t) {
    return function() {
        var e;
        return e || t.$;
    };
...
+function(t) {
    ...
    n.VERSION = "3.2.0", n.prototype.close = function(e) {
        ...
        var r = t(s);
        e && e.preventDefault(), r.length || (r = n.hasClass("alert") ? n : n.parent()), 
        r.trigger(e = t.Event("close.bs.alert")), e.isDefaultPrevented() || (r.removeClass("in"), 
        t.support.transition && r.hasClass("fade") ? r.one("bsTransitionEnd", i).emulateTransitionEnd(150) : i());
    };
    var s = t.fn.alert;
    ...
    i.VERSION = "3.2.0", i.DEFAULTS = {
        ...
        e += "Text", null == r.resetText && n.data("resetText", n[s]()), n[s](null == r[e] ? this.options[e] : r[e]), 
        setTimeout(t.proxy(function() {
            "loadingText" == e ? (this.isLoading = !0, n.addClass(i).attr(i, i)) : this.isLoading && (this.isLoading = !1, 
    ...
    function e(e) {
        return this.each(function() {
            var n = t(this), s = n.data("bs.carousel"), r = t.extend({}, i.DEFAULTS, n.data(), "object" == typeof e && e), o = "string" == typeof e ? e : r.slide;
    ...
    i.VERSION = "3.2.0", i.DEFAULTS = {
        ...
        var n = this.$element.find(".item.active"), s = i || n[e](), r = this.interval, o = "next" == e ? "left" : "right", a = "next" == e ? "first" : "last", l = this;
        if (!s.length) {
            if (!this.options.wrap) return;
            s = this.$element.find(".item")[a]();
        }
        if (s.hasClass("active")) return this.sliding = !1;
        var u = s[0], c = t.Event("slide.bs.carousel", {
            relatedTarget: u,
            direction: o
        });
        if (this.$element.trigger(c), !c.isDefaultPrevented()) {
            ...
            s[0].offsetWidth, n.addClass(o), s.addClass(o), n.one("bsTransitionEnd", function() {
                s.removeClass([ e, o ].join(" ")).addClass("active"), n.removeClass([ "active", o ].join(" ")), 
                l.sliding = !1, setTimeout(function() {
                    l.$element.trigger(d);
                }, 0);
            }).emulateTransitionEnd(1e3 * n.css("transition-duration").slice(0, -1))) : (n.removeClass("active"), 
            s.addClass("active"), this.sliding = !1, this.$element.trigger(d)), r && this.cycle(), 
            this;
        }
    };
    var n = t.fn.carousel;
    ...
    function e(e) {
        return this.each(function() {
            var n = t(this), s = n.data("bs.collapse"), r = t.extend({}, i.DEFAULTS, n.data(), "object" == typeof e && e);
            !s && r.toggle && "show" == e && (e = !e), s || n.data("bs.collapse", s = new i(this, r)), 
            "string" == typeof e && s[e]();
        });
    }
    var i = function(e, n) {
        this.$element = t(e), this.options = t.extend({}, i.DEFAULTS, n), this.transitioning = null, 
    ...
    i.VERSION = "3.2.0", i.DEFAULTS = {
        ...
        if (!this.transitioning && !this.$element.hasClass("in")) {
            ...
            if (this.$element.trigger(i), !i.isDefaultPrevented()) {
                ...
                this.$element.one("bsTransitionEnd", t.proxy(o, this)).emulateTransitionEnd(350)[r](this.$element[0][a]);
            }
        }
    ...
    t.fn.collapse = e, t.fn.collapse.Constructor = i, t.fn.collapse.noConflict = function() {
        ...
        var n, s = t(this), r = s.attr("data-target") || i.preventDefault() || (n = s.attr("href")) && n.replace(/.*(?=#[^\s]+$)/, ""), o = t(r), a = o.data("bs.collapse"), l = a ? "toggle" : s.data(), u = s.attr("data-parent"), c = u && t(u);
        a && a.transitioning || (c && c.find('[data-toggle="collapse"][data-parent="' + u + '"]').not(s).addClass("collapsed"), 
        s[o.hasClass("in") ? "addClass" : "removeClass"]("collapsed")), e.call(o, l);
    });
}(jQuery), +function(t) {
    function e(e) {
    ...
    o.VERSION = "3.2.0", o.prototype.toggle = function(n) {
        ...
        if (!s.is(".disabled, :disabled")) {
            ...
            if (e(), !o) {
                ...
                s.trigger("focus"), r.toggleClass("open").trigger("shown.bs.dropdown", a);
            }
            return !1;
        }
        ...
        if (/(38|40|27)/.test(e.keyCode)) {
            ...
            if (e.preventDefault(), e.stopPropagation(), !n.is(".disabled, :disabled")) {
                var s = i(n), o = s.hasClass("open");
                if (!o || o && 27 == e.keyCode) return 27 == e.which && s.find(r).trigger("focus"), 
                n.trigger("click");
                var a = " li:not(.divider):visible a", l = s.find('[role="menu"]' + a + ', [role="listbox"]' + a);
                if (l.length) {
                    var u = l.index(l.filter(":focus"));
                    38 == e.keyCode && u > 0 && u--, 40 == e.keyCode && u < l.length - 1 && u++, ~u || (u = 0), 
    ...
    i.VERSION = "3.2.0", i.DEFAULTS = {
        ...
        var i = this, n = t.Event("show.bs.modal", {
            relatedTarget: e
        });
    ...
    t.fn.modal = e, t.fn.modal.Constructor = i, t.fn.modal.noConflict = function() {
        ...
        var n = t(this), s = n.attr("href"), r = t(n.attr("data-target") || s && s.replace(/.*(?=#[^\s]+$)/, "")), o = r.data("bs.modal") ? "toggle" : t.extend({
            remote: !/#/.test(s) && s
        }, r.data(), n.data());
    ...
    function e(e) {
        return this.each(function() {
            ...
            (s || "destroy" != e) && (s || n.data("bs.tooltip", s = new i(this, r)), "string" == typeof e && s[e]());
        });
    }
    var i = function(t, e) {
    ...
    i.VERSION = "3.2.0", i.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var o = "function" == typeof this.options.placement ? this.options.placement.call(this, s[0], this.$element[0]) : this.options.placement, a = /\s?auto?\s?/i, l = a.test(o);
            l && (o = o.replace(a, "") || "top"), s.detach().css({
                top: 0,
                left: 0,
                display: "block"
            ...
            if (l) {
                var d = o, p = this.$element.parent(), f = this.getPosition(p);
                o = "bottom" == o && u.top + u.height + h - f.scroll > f.height ? "top" : "top" == o && u.top - f.scroll - h < 0 ? "bottom" : "right" == o && u.right + c > f.width ? "left" : "left" == o && u.left - c < f.left ? "right" : o, 
                s.removeClass(d).addClass(o);
            }
        ...
        var n = this.tip(), s = n[0].offsetWidth, r = n[0].offsetHeight, o = parseInt(n.css("margin-top"), 10), a = parseInt(n.css("margin-left"), 10);
        isNaN(o) && (o = 0), isNaN(a) && (a = 0), e.top = e.top + o, e.left = e.left + a, 
        ...
        var h = c.left ? 2 * c.left - s + l : 2 * c.top - r + u, d = c.left ? "left" : "top", p = c.left ? "offsetWidth" : "offsetHeight";
        ...
        return this.$element.removeAttr("aria-describedby"), this.$element.trigger(s), s.isDefaultPrevented() ? void 0 : (n.removeClass("in"), 
        ...
        if (/right|left/.test(t)) {
            ...
            u < o.left ? s.left = o.left - u : c > o.width && (s.left = o.left + o.width - c);
        }
        return s;
    ...
    function e(e) {
        return this.each(function() {
            ...
            (s || "destroy" != e) && (s || n.data("bs.popover", s = new i(this, r)), "string" == typeof e && s[e]());
        });
    }
    var i = function(t, e) {
    ...
    function e(i, n) {
        ...
        this.$body = t("body"), this.$scrollElement = t(t(i).is("body") ? window : i), this.options = t.extend({}, e.DEFAULTS, n), 
    ...
    e.VERSION = "3.2.0", e.DEFAULTS = {
        ...
        this.$body.find(this.selector).map(function() {
            var n = t(this), s = n.data("target") || n.attr("href"), r = /^#./.test(s) && t(s);
            return r && r.length && r.is(":visible") && [ [ r[e]().top + i, s ] ] || null;
        }).sort(function(t, e) {
            return t[0] - e[0];
        }).each(function() {
        ...
        var t, e = this.$scrollElement.scrollTop() + this.options.offset, i = this.getScrollHeight(), n = this.options.offset + i - this.$scrollElement.height(), s = this.offsets, r = this.targets, o = this.activeTarget;
    ...
    i.VERSION = "3.2.0", i.prototype.show = function() {
        ...
        if (n || (n = e.attr("href"), n = n && n.replace(/.*(?=#[^\s]*$)/, "")), !e.parent("li").hasClass("active")) {
            var s = i.find(".active:last a")[0], r = t.Event("show.bs.tab", {
                relatedTarget: s
            });
        ...
        o ? r.one("bsTransitionEnd", s).emulateTransitionEnd(150) : s(), r.removeClass("in");
    };
    var n = t.fn.tab;
    ...
    i.VERSION = "3.2.0", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            var e = t(document).height(), n = this.$target.scrollTop(), s = this.$element.offset(), r = this.options.offset, o = r.top, a = r.bottom;
            "object" != typeof r && (a = o = r), "function" == typeof o && (o = r.top(this.$element)), 
            "function" == typeof a && (a = r.bottom(this.$element));
            var l = null != this.unpin && n + this.unpin <= s.top ? !1 : null != a && s.top + this.$element.height() >= e - a ? "bottom" : null != o && o >= n ? "top" : !1;
            if (this.affixed !== l) {
                ...
                this.$element.removeClass(i.RESET).addClass(u).trigger(t.Event(u.replace("affix", "affixed"))), 
    ...
    t.fn.affix = e, t.fn.affix.Constructor = i, t.fn.affix.noConflict = function() {
        ...
        t('[data-spy="affix"]').each(function() {
            ...
            n.offsetTop && (n.offset.top = n.offsetTop), e.call(i, n);
        });
    });
}(jQuery), define("bootstrap", [ "jquery" ], function(t) {
    return function() {
        var e;
        return e || t.$;
    };
...
NS.UI = function(t) {
    return t.NotificationList = Backbone.View.extend({
        tagName: "ul",
        className: "notification-list",
        initialize: function() {
            $("body").append(this.el);
        }
    }), t.Notification = Backbone.View.extend({
        ...
        render: function() {
            var t = _.pick(this.options, "type", "title", "message"), e = $(_.template(this.templateSrc, t, {
                variable: "data"
            }));
            this.setElement(e), $("ul.notification-list").append(this.el), "number" == typeof this.options.delay && this.options.delay > 0 ? this.$el.slideDown().delay(1e3 * this.options.delay).slideUp(400, function() {
                $(this).remove();
            }) : this.$el.slideDown();
        }
    }), t;
}(NS.UI || {}), define("NS.UI.Notification", [ "jquery", "backbone", "bootstrap" ], function(t) {
    return function() {
        var e;
        return e || t.$;
    };
}(this)), define("views/main/panelView", [ "jquery", "underscore", "backbone", "text!../../../templates/main/panel.html", "models/fields", "i18n", "jqueryui", "nanoscroller", "NS.UI.Notification" ], function(t, e, i, n, s) {
    var r = i.View.extend({
        events: {
            "click .fields": "appendToDrop"
        },
        initialize: function(t) {
            this.template = e.template(n), this._collection = t, this.list = [], models = e.keys(s), 
            models.shift();
            for (var i in models) void 0 !== s[models[i]].type && (this.list[models[i]] = {
                i18n: models[i].replace("Field", "").toLowerCase()
            });
            e.bindAll(this, "appendToDrop");
        },
        appendToDrop: function(e) {
            var i = t(e.target).data("type");
            void 0 !== s[i] ? this.collection.addElement(i) : (console.log(err), new NS.UI.Notification({
                type: "error",
        ...
        render: function() {
            ...
            return t(this.el).html(e), t(this.el).nanoScroller(), t(".fields").disableSelection(), 
            this;
        }
    });
    return r;
}), define("text!views/../../templates/main/formView.html", [], function() {
    return '<div class="row notification-container">\r\n    <ul class="notification-list span12"></ul>\r\n</div>\r\n<div class="row">\r\n    <input type="text" id="protocolName" class="firstText col-md-12" value="<%= this.collection.name %>" />\r\n</div>\r\n<div class="row">\r\n    <h2 class="center" data-i18n="label.help">Cliquer sur champs pour l\\ajouter au protocole</h2>\r\n</div>\r\n<div class="row">\r\n    <div class="col-md-12 drop"></div>\r\n</div>\r\n';
}), define("views/main/formView", [ "jquery", "underscore", "backbone", "text!../../../templates/main/formView.html", "i18n", "jqueryui", "nanoscroller", "bootstrap" ], function(t, e, i, n) {
    var s = i.View.extend({
        events: {
            "change #protocolName": "changeFormName"
        },
        initialize: function() {
            this.template = e.template(n), e.bindAll(this, "render", "addElement", "changeFormName", "importXML", "updateView", "getModel", "getXML", "getSubView"), 
            this.collection.bind("newElement", this.addElement), this._view = [];
        },
        getSubView: function(t) {
            return this._view[t];
        },
        displayNotification: function(t, e, i) {
        ...
        updateView: function() {
            var e = this.template(this.collection.toJSON());
            t(this.el).html(e), t(this.el).find("#protocolName").val(this.collection.name);
        },
        addElement: function(i) {
            var n = i.constructor.type + "FieldView";
            require([ "views/fieldViews/" + n ], e.bind(function(e) {
                var n = "dropField" + this.collection.length;
                t(".drop").append('<div class="span12 dropField " id="' + n + '" ></div>');
                var s = new e({
                    el: "#" + n,
                    model: i
                });
                null !== s && (s.render(), this._view[n] = s), t(".actions").i18n();
            }, this), function() {
                new NS.UI.Notification({
                    type: "error",
                    title: "An error occured :",
        ...
        render: function() {
            ...
            return t(".drop").sortable({
                ...
                stop: function() {
                    for (var e in i) i[e].updateIndex(t("#" + e).index());
                }
            }), this;
        },
        getModel: function() {
        ...
        changeFormName: function() {
            this.collection.name = t("#protocolName").val();
        },
        getXML: function() {
        ...
        importXML: function() {
            require([ "text!../templates/modals.html", "app/formbuilder" ], e.bind(function(i, n) {
                var s = t(i).filter("#importProtocolModal");
                t(t(s)).modal({}).on("click", "#importProtocolFileText, #importProtocolFind", function() {
                    t("#importProtocolFile").trigger("click");
                }).on("change", "#importProtocolFile", function() {
                    t("#importProtocolFileText").val(t("#importProtocolFile").val());
                }).on("click", ".btn-primary", e.bind(function() {
                    if (t("#importProtocolFileText")["" === t("#importProtocolFile").val() ? "addClass" : "removeClass"]("error"), 
                    t("#importProtocolName")["" === t("#importProtocolName").val() ? "addClass" : "removeClass"]("error"), 
                    !t("#importProtocolFile").hasClass("error") && !t("#importProtocolName").hasClass("error")) {
                        var i = t("#importProtocolFile")[0].files[0];
                        if (i) if ("text/xml" === i.type) {
                            var n = new FileReader();
                            n.readAsText(i, "UTF-8"), n.onload = e.bind(function(e) {
                                try {
                                    var i = app.views.XMLValidation(e.target.result);
                                    i !== !0 ? (t("#importProtocolModal").modal("hide").removeData(), this.displayNotification("error", "An error occured :", "There is a error on the " + i.element + "<br />" + i.message + "<br />Please check your XML file")) : (this.collection.updateWithXml(e.target.result, t("#importProtocolName").val()), 
                                    t("#importProtocolModal").modal("hide").removeData(), this.displayNotification("success", "Porotocol imported :", "Your protocol was correctly imported"));
                                } catch (n) {
                                    t("#importProtocolModal").modal("hide").removeData(), this.displayNotification("error", "An error occured :", "Your XML File can't be validated.<br />The specific error is : " + n);
                                }
                            }, this), n.onerror = e.bind(function() {
                                t("#importProtocolModal").modal("hide").removeData(), this.displayNotification("error", "An error occured :", "An error was occure during reading file");
                            }, this);
                        } else t("#importProtocolModal").modal("hide").removeData(), this.displayNotification("error", "File type error :", "Your have to give an XML file."); else t("#importProtocolModal").modal("hide").removeData(), 
                    ...
                    source: function(e, i) {
                        return t.getJSON(n.URLOptions.protocolAutocomplete, {
                            query: e
                        }, function(t) {
                            return i(t.options);
                        });
        ...
        importJSON: function() {
            require([ "text!../templates/modals.html", "app/formbuilder" ], e.bind(function(i, n) {
                ...
                t(t(s)).modal({}).on("click", "#importProtocolFileText, #importProtocolFind", function() {
                    ...
                    !t("#importProtocolFile").hasClass("error") && !t("#importProtocolName").hasClass("error")) {
                        var i = t("#importProtocolFile")[0].files[0];
                        if (i) if (-1 !== i.name.indexOf("json", i.name.length - 4)) {
                            var n = new FileReader();
                            n.readAsText(i, "UTF-8"), n.onload = e.bind(function(e) {
                                var i = jQuery.parseJSON(e.target.result);
                                this.collection.updateWithJSON(i, t("#importProtocolName").val()), t("#importProtocolModal").modal("hide").removeData();
                            }, this), n.onerror = e.bind(function() {
                                t("#importProtocolModal").modal("hide").removeData(), this.displayNotification("error", "An error occured :", "An error was occured during reading file");
                            }, this);
                        } else t("#importProtocolModal").modal("hide").removeData(), this.displayNotification("error", "File type error :", "Your have to give an JSON file."); else t("#importProtocolModal").modal("hide").removeData(), 
                        this.displayNotification("error", "File type error :", "An error was occure during reading file.");
                    }
                }, this)).find("#importProtocolName").typeahead({
                    source: function(e, i) {
    ...
    return s;
}), define("views/main/mainView", [ "jquery", "underscore", "backbone", "views/main/panelView", "views/main/formView", "i18n" ], function(t, e, i, n, s) {
    var r = i.View.extend({
        initialize: function(i) {
            this.el = i.el, t(this.el).append('<div class="row content">   <div class="col-md-3 widgetsPanel nano"></div>   <div class="col-md-9 dropArea"></div>   <div class="col-md-5 settings"></div></div>'), 
            this.URLOptions = i.URLOptions, this.form = i.form || new app.views.Form({}, {
                name: "My form"
            }), this.panelView = new n({
                el: ".widgetsPanel",
                collection: this.form
            }), this.formView = new s({
                collection: this.form,
                el: t(".dropArea")
            }), this.panelView.render(), this.formView.render(), e.bindAll(this, "getFormXML", "downloadXML", "importXML", "getActions", "getSubView");
        },
        getSubView: function(t) {
            return this.formView.getSubView(t);
        },
        clear: function() {
            this.form.clearAll();
        },
        ...
        getActions: function() {
            return {
                save: new NS.UI.NavBar.Action({
                    title: t.t("nav.save.title"),
                    allowedRoles: [ "reader" ],
                    actions: {
                        repo: new NS.UI.NavBar.Action({
                            title: t.t("nav.save.cloud"),
                            allowedRoles: [ "reader" ],
                            url: "#save"
                        }),
                        "export": new NS.UI.NavBar.Action({
                            allowedRoles: [ "reader" ],
                            title: t.t("nav.save.export"),
                            url: "#export"
                        })
                    }
                }),
                "import": new NS.UI.NavBar.Action({
                    actions: {
                        "import.file": new NS.UI.NavBar.Action({
                            allowedRoles: [ "reader" ],
                            title: t.t("nav.import.import"),
                            utl: "#import"
                        }),
                        "import.load": new NS.UI.NavBar.Action({
                            title: t.t("nav.import.cloud"),
                            allowedRoles: [ "reader" ],
                            url: "#load"
                        })
                    },
                    title: t.t("nav.import.title"),
                    allowedRoles: [ "reader" ]
                }),
                ...
                show: new NS.UI.NavBar.Action({
                    url: "#show",
                    allowedRoles: [ "reader" ],
                    title: t.t("nav.compare")
                })
            };
        }
    });
    return r;
}), define("views/editViews", [ "backbone" ], function(t) {
    var e = {};
    return e.BaseEditView = t.View.extend({
        events: {
            "click h2 > span:not(.selected)": "displayOptions",
            "change .property": "updateModelAttribute"
        },
        initialize: function() {
            this.template = _.template(this.constructor.templateSrc), _.bindAll(this, "render", "updateModelAttribute", "changeModel"), 
            this.model.bind("change", this.render), this.subView = null;
        },
        displayOptions: function(t) {
            $(".settings h2 > span").toggleClass("selected"), "simple" === $(t.target).prop("id") ? $(".advanced").addClass("hide", 500) : $(".advanced").removeClass("hide", 500);
        },
        updateModelAttribute: function(t) {
            "checkbox" === $(t.target).prop("type") ? this.model.changePropertyValue($(t.target).data("attr"), $(t.target).is(":checked")) : this.model.changePropertyValue($(t.target).data("attr"), $(t.target).val());
        },
        render: function() {
            var t = this.template(this.model.toJSON());
            return $(this.el).html(t), this.subView = new e[this.model.constructor.type + "FieldEditView"]({
                el: $("#subView"),
                model: this.model
            }), this.subView.render(), $(this.el).i18n(), $(".dropArea").switchClass("span9", "span7", 500), 
            $(".widgetsPanel").switchClass("span3", "span0", 500), this;
        },
        changeModel: function(t) {
            $(this.el).unbind(), $(this.subView.el).unbind(), this.model = t, this.model.bind("change", this.render), 
        ...
        getActions: function() {
            return {
                save: new NS.UI.NavBar.Action({
                    handler: function() {
                        $(".dropArea").hasClass("span7") && ($(".dropArea").switchClass("span7", "span9", 100), 
                        $(".widgetsPanel").switchClass("span0", "span3", 200), window.location.hash = "#");
                    },
                    allowedRoles: [ "reader" ],
        ...
        templateSrc: '<div>   <h1 data-i18n="label.settings">Settings</h1>   <div>       <h2>           <span id="simple" class="selected" data-i18n="label.options.simple">Simple options</span> /            <span href="#" id="advanced" data-i18n="label.options.advanced" >Advanced options</span>       </h2>   <div class="hide advanced">       <div class="row-fluid">           <label class="span10 offset1">ID</label>       </div>       <div class="row-fluid">           <input class="span10 offset1 property" type="number" data-attr="id" placeholder="Id" value="<%= id %>" />       </div>   </div>    <div >       <div class="row-fluid">           <label class="span10 offset1">Label</label>       </div>       <div class="row-fluid">           <input class="span10 offset1 property" type="text" data-attr="label" placeholder="Label" value="<%= label %>" />       </div>   </div>    <div >       <div class="row-fluid">           <label class="span10 offset1">Name label</label>       </div>       <div class="row-fluid">           <input class="span10 offset1 property" type="text" data-attr="name[label][value]" placeholder="Name label" value="<%= name["label"]["value"] %>" />       </div>   </div>    <div >       <div class="row-fluid">           <label class="span10 offset1">Name label lang</label>       </div>       <div class="row-fluid">           <input class="span10 offset1 property" type="text" data-attr="name[label][lang]" placeholder="Name label lang" value="<%= name["label"]["lang"] %>" />       </div>   </div>    <div class="row-fluid">&nbsp;</div><div class="row-fluid">       <label class="span4 offset1">Required</label>           <input class="span2 property" data-attr="required" type="checkbox" <% if (required) { %> checked <% } %> />   </div>   <div class="row-fluid lastRow">&nbsp;</div><div class="row-fluid">       <label class="span4 offset1">Read only</label>           <input class="span2 property" data-attr="readOnly" type="checkbox" <% if (readOnly) { %> checked <% } %> />   </div>       <div id="subView"></div>       <div class="row-fluid">&nbsp;</div>   </div>   <div class="row-fluid">&nbsp;</div></div>'
    }), e.SimpleEditView = t.View.extend({
        events: {
            "click h2 > span:not(.selected)": "displayOptions",
            "change .property": "updateModelAttribute"
        },
        ...
        render: function() {
            var t = this.template(this.model.toJSON());
            return $(this.el).html(t), $(this.el).i18n(), $(".dropArea").switchClass("span9", "span7", 500), 
            $(".widgetsPanel").switchClass("span3", "span0", 500), this;
        },
        changeModel: function(t) {
            $(this.el).unbind(), $(this.subView.el).unbind(), this.model = t, this.model.bind("change", this.render), 
        ...
        getActions: function() {
            return e.BaseEditView.prototype.getActions.apply(this, arguments);
        }
    }), e.HiddenFieldEditView = e.SimpleEditView.extend({}, {
        templateSrc: '<div>   <h1 data-i18n="label.settings">Settings</h1>   <div>       <h2>           <span id="simple" class="selected" data-i18n="label.options.simple">Simple options</span> /            <span href="#" id="advanced" data-i18n="label.options.advanced" >Advanced options</span>       </h2>   <div class="hide advanced">       <div class="row-fluid">           <label class="span10 offset1">ID</label>       </div>       <div class="row-fluid">           <input class="span10 offset1 property" type="number" data-attr="id" placeholder="Id" value="<%= id %>" />       </div>   </div>    <div >       <div class="row-fluid">           <label class="span10 offset1">Value</label>       </div>       <div class="row-fluid">           <input class="span10 offset1 property" type="text" data-attr="value" placeholder="Value" value="<%= value %>" />       </div>   </div>    </div>   <div class="row-fluid">&nbsp;</div></div>'
    }), e.AutocompleteFieldEditView = t.View.extend({
        initialize: function() {
        ...
        templateSrc: '<% _.each(["defaultValue", "hint", "url"], function(el) { %>   <div >       <div class="row-fluid">           <label class="span10 offset1"><%= el %></label>       </div>       <div class="row-fluid">           <input class="span10 offset1 property" type="text" data-attr="<%= el %>" placeholder="<%= el %>" value="<%= eval(el) %>" />       </div>   </div> <% }) %>'
    }), e.TextFieldEditView = t.View.extend({
        initialize: function() {
            this.template = _.template(this.constructor.templateSrc);
        },
        render: function() {
        ...
        templateSrc: '<% _.each(["defaultValue", "hint", "size"], function(el) { %>   <div >       <div class="row-fluid">           <label class="span10 offset1"><%= el %></label>       </div>       <div class="row-fluid">           <input class="span10 offset1 property" type="text" data-attr="<%= el %>" placeholder="<%= el %>" value="<%= eval(el) %>" />       </div>   </div> <% }) %>'
    }), e.PatternFieldEditView = t.View.extend({
        initialize: function() {
            this.template = _.template(this.constructor.templateSrc);
        },
        render: function() {
        ...
        templateSrc: '   <div id="subTextView"></div>   <div >       <div class="row-fluid">           <label class="span10 offset1">Pattern</label>       </div>       <div class="row-fluid">           <input class="span10 offset1 property" type="text" data-attr="pattern" placeholder="Pattern" value="<%= pattern %>" />       </div>   </div>'
    }), e.FileFieldEditView = t.View.extend({
        initialize: function() {
            this.template = _.template(this.constructor.templateSrc);
        },
        render: function() {
        ...
        templateSrc: '   <% _.each(["defaultValue", "file", "mimeType"], function(el) {%>        <div >           <div class="row-fluid">               <label class="span10 offset1"><%= el %></label>           </div>           <div class="row-fluid">               <input class="span10 offset1 property" type="text" data-attr="<%= el %>" placeholder="<%= el %>" value="<%= eval(el) %>" />           </div>       </div>   <% }); %>       <div >           <div class="row-fluid">               <label class="span10 offset1">File max size</label>           </div>           <div class="row-fluid">               <input class="span10 offset1 property" type="number" data-attr="size" placeholder="Max file size" value="<%= size %>" />           </div>       </div>'
    }), e.NumericFieldEditView = t.View.extend({
        events: {
            "change select": "changed"
        },
        initialize: function() {
            this.template = _.template(this.constructor.templateSrc), _.bindAll(this, "render", "changed"), 
            this.model.bind("change", this.render);
        },
        render: function() {
            var t = this.template(this.model.toJSON());
            ...
            return i.render(), require([ "app/formbuilder" ], _.bind(function(t) {
                $.getJSON(t.URLOptions.unitURL, _.bind(function(t) {
                    var e = value = null;
                    for (var i in t.options) e = this.model.get("unity") == t.options[i] ? "selected" : "", 
                    value = t.options[i], $(this.el).find("select").append('<option value="' + value + '"' + e + ">" + value + "</option>");
                }, this));
            }, this)), this;
        },
        changed: function(t) {
            this.model.set("unity", $(t.target).val());
        }
    }, {
        templateSrc: '   <div id="subTextView"></div>   <% _.each(["minValue", "maxValue", "precision"], function(idx) { %>       <div >           <div class="row-fluid">               <label class="span10 offset1"><%= idx %></label>           </div>           <div class="row-fluid">               <input class="span10 offset1 property" type="text" data-attr="<%= idx %>" placeholder="<%= idx %>" value="<%= eval(idx) %>" />           </div>       </div>   <% }) %>       <div >           <div class="row-fluid">               <label class="span10 offset1">Unit</label>           </div>           <div class="row-fluid">               <select class="span10 offset1 property" type="text" data-attr="unity" placeholder="unit">               </select>           </div>       </div>'
    }), e.DateFieldEditView = t.View.extend({
        initialize: function() {
            this.template = _.template(this.constructor.templateSrc);
        },
        render: function() {
        ...
        templateSrc: '   <div id="subTextView"></div>   <div >       <div class="row-fluid">           <label class="span10 offset1">Format</label>       </div>       <div class="row-fluid">           <input class="span10 offset1 property" type="text" data-attr="format" placeholder="Date format" value="<%= format %>" />       </div>   </div>'
    }), e.LongTextFieldEditView = e.TextFieldEditView.extend({}), e.TreeViewFieldEditView = t.View.extend({
        initialize: function() {
            this.template = _.template(this.constructor.templateSrc);
        },
        render: function() {
        ...
        templateSrc: ""
    }), e.RadioFieldEditView = e.CheckBoxFieldEditView = e.SelectFieldEditView = t.View.extend({
        events: function() {
            return _.extend({}, e.BaseEditView.prototype.events, {
                "click .listEdit": "editList"
            });
        },
        initialize: function() {
            this.template = _.template(this.constructor.templateSrc), _.bindAll(this, "editList");
        },
        render: function() {
            var t = this.template(this.model.toJSON());
            return $(this.el).html(t), this;
        ...
        editList: function() {
            require([ "app/views/modal" ], _.bind(function(t) {
                var e = new t.EditListModal({
                    el: "#editListModal",
                    model: this.copyeItemList()
                });
                e.render(), e.bind("saved", _.bind(function() {
                    this.model.set("itemList", e.model), e.unbind(), delete e, this.model.trigger("change");
                }, this));
            }, this));
        }
    }, {
        templateSrc: '   <div class="row-fluid"><div class="block span10 offset1">       <table class=" table table-striped">           <caption><h2>               Item list / Default value : <b><%= itemList["defaultValue"] %>  <i class="fa fa-wrench listEdit"></i>           </h2></caption>           <thead>               <tr>                   <th>Id</th>                   <th>Label en</th>                   <th>Label fr</th>                   <th>Value</th>               </tr>           </thead>           <tbody>               <% _.each( itemList["items"], function(item, idx) { %>                   <tr>                       <td><%= item["id"] %></td>                       <td><%= item["en"] %></td>                       <td><%= item["fr"] %></td>                       <td><%= item["value"] %></td>                   </tr>               <% }); %>           </tbody>       </table>   </div></div>   <div class="row-fluid">       <label class="span10 offset1"></label>   </div>'
    }), e.TableFieldEditView = t.View.extend({
        events: {
            "change .positionOption": "optionChanged"
        },
        initialize: function() {
            this.template = _.template(this.constructor.templateSrc), _.bindAll(this, "optionChanged"), 
            this.model.bind("change", this.render), this.model.bind("done", _.bind(function() {
                this.render();
            }, this));
        },
        render: function() {
        ...
        optionChanged: function(t) {
            var e = $(t.target).data("index"), i = parseInt($(t.target).val());
            this.model.moveModel(e, i);
        }
    }, {
        templateSrc: ' 	<div class="row-fluid">           	<label class="span10 offset1">SubView position</label>       	</div>   <div class="row-fluid">		<div class="block span10 offset1">       	<div class="row-fluid">				<table class="table table-striped">					<thead>						<tr>							<th>Element</th>							<th>Type</th>							<th>Position</th>						</tr>					</thead>					<tbody>						<% _.each(fields, function(el, idx) {  if (fields[idx] != undefined) { %>						<tr>							<td><%= el.get("label") %></td>							<td><%= el.constructor.type %></td>							<td>								<select class="positionOption" data-index="<%=idx %>">									<option value="0" <% if (idx == 0) {%> selected <% } %> >Top left corner</option>									<option value="1" <% if (idx == 1) {%> selected <% } %> >Top right corner</option>									<option value="2" <% if (idx == 2) {%> selected <% } %> >Bottom left corner</option>									<option value="3" <% if (idx == 3) {%> selected <% } %> >Bottom right corner</option>								</select>							</td>						</tr>						<% } }); %>					</tbody>				</table>       	</div>   	</div>	</div>'
    }), e.SubformFieldEditView = e.SimpleEditView.extend({
        events: function() {
            return _.extend({}, e.SimpleEditView.prototype.events, {});
        }
    }, {
        templateSrc: '<div>   <h1 data-i18n="label.settings">Settings</h1>   <div>       <h2>           <span id="simple" class="selected" data-i18n="label.options.simple">Simple options</span> /            <span href="#" id="advanced" data-i18n="label.options.advanced" >Advanced options</span>       </h2>       <div class="hide advanced">           <div class="row-fluid">               <label class="span10 offset1">ID</label>           </div>           <div class="row-fluid">               <input class="span10 offset1 property" type="number" data-attr="id" placeholder="Id" value="<%= id %>" />           </div>       </div>        <div>           <div class="row-fluid">               <label class="span10 offset1">Legend</label>           </div>           <div class="row-fluid">               <input class="span10 offset1 property" type="text" data-attr="legend" placeholder="Fieldset legend" value="<%= legend %>" />           </div>       </div>    <div class="row-fluid">&nbsp;</div><div class="row-fluid">       <label class="span4 offset1">Multiple</label>           <input class="span2 property" data-attr="multiple" type="checkbox" <% if (multiple) { %> checked <% } %> />   </div>   </div>   <div class="row-fluid">&nbsp;</div></div>'
    }), e;
}), define("models/collection", [ "backbone", "models/fields" ], function(t, e) {
    var i = t.Collection.extend({
        model: e.BaseField,
        initialize: function(t, e) {
            this.name = e.name || "My form", this.count = 0, this.description = e.description || "", 
            this.keywords = e.keywords || [ "protocol" ], _.bindAll(this, "updateWithXml", "clearAll", "getSize", "tagNameToClassName", "addElement", "addTableElement", "getJSON", "getJSONFromModel");
        },
        ...
        clearAll: function() {
            for (;this.models.length > 0; ) {
                var t = this.at(this.models.length - 1);
                t.trigger("destroy", t);
            }
            this.count = 0;
        },
        getKeywords: function() {
            var t = "";
            return _.each(this.keywords, function(e) {
                t += "<keyword>" + e + "</keyword>";
            }), "<keywords>" + t + "</keywords>";
        },
        getXML: function() {
            var t = this.models.slice(1, this.models.length), e = $.parseXML('<?xml version="1.0" ?><form id="test attribute"   xmlns="http://www.w3schools.com" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.w3schools.com note.xsd"></form>'), i = $(e);
            return i.find("form").append("<name>" + this.name + "</name><description>" + this.description + "</description>" + this.getKeywords() + "<fields></fields>"), 
            this.sort(), _.each(t, function(t) {
                t.get("isDragged") !== !0 && i.find("fields").append("<" + t.constructor.xmlTag + ' id="' + t.get("id") + '" >' + t.getXML() + "</" + t.constructor.xmlTag + ">");
            }), new XMLSerializer().serializeToString(e);
        },
        getJSONFromModel: function(t) {
            var e = {
                validators: []
            };
            switch (t.constructor.type) {
              ...
              case "CheckBox":
              case "Select":
                e.options = $.map(t.get("itemList").items, function(t) {
                    return {
                        val: t.value,
                        label: t.en
                    };
                }), e.type = "CheckBox" === t.constructor.type ? "Checkboxes" : t.constructor.type;
                break;

              case "Table":
                ;
                e.subSchema = {}, $.map(t.get("fields"), _.bind(function(t) {
                    e.subSchema[t.get("label") + t.get("id")] = this.getJSONFromModel(t);
                }, this)), e.type = "Object";
                break;

              default:
                e.type = t.constructor.type;
            }
            return e.help = t.get("hint"), t.get("required") && e.validators.push("required"), 
            e;
        },
        getJSON: function() {
            var t = {}, e = null;
            return t.name = this.name, t.description = this.description, t.keywords = this.keywords, 
            t.schema = {}, this.map(_.bind(function(i) {
                void 0 == i.constructor.type || i.get("isDragged") || (e = this.getJSONFromModel(i), 
                void 0 !== t.schema[i.get("label")] && i.set("label", i.get("label") + i.get("id")), 
                t.schema[i.get("label")] = e);
            }, this)), t;
        },
        tagNameToClassName: function(t) {
            var e = t.split("_");
            return e[1] = e[1][0].toUpperCase() + e[1].slice(1), e[0] = e[0][0].toUpperCase() + e[0].slice(1), 
            e.reverse().join("");
        },
        addElement: function(t, i) {
            ...
            n.id = this.getSize();
            var s = new e[t](n);
            this.add(s), this.trigger("newElement", s);
        },
        addTableElement: function(t) {
            var i = properties || {};
            i.id = this.getSize();
            var n = new e[t](i);
            return this.add(n), n;
        },
        updateWithXml: function(t, e) {
            this.reset(), this.name = e;
            var i = $.parseXML(t), n = "", s = app.utilities.XmlToJson($(i).find("form"));
            _.each(s.fields, _.bind(function(t, e) {
                n = this.tagNameToClassName(e), t.length > 1 ? _.each(t, _.bind(function(t) {
                    this.addElement(t, n);
                }, this)) : this.addElement(t, n);
            }, this));
        },
        addTableFieldFromJSON: function(t) {
            var e = {}, i = null;
            _.each(t.subSchema, _.bind(function(t, n) {
                i = _.pick(t, "help"), t.validators.length > 0 && (i.required = void 0 !== t.validators.required, 
                i.readonly = void 0 !== t.validators.required), i.label = n, i.isDragged = !0, i.type = "TextArea" === t.type ? "LongText" : t.type, 
                e[n] = i;
            }, this)), this.addElement("TableField", {
                fields: e
            });
        },
        updateWithJSON: function(t, e) {
            this.name = e, this.description = t.description, this.keywords = t.keywords;
            var i = null;
            _.each(t.schema, _.bind(function(t, e) {
                "Object" === t.type ? this.addTableFieldFromJSON(t, e) : (i = _.pick(t, "help"), 
                i.label = e, void 0 !== t.validators && t.validators.length > 0 && (i.required = void 0 !== schema.validators.required, 
                i.readonly = void 0 !== schema.validators.required), this.addElement(("TextArea" === t.type ? "LongText" : t.type) + "Field", i));
            }, this));
        }
    });
    return i;
...
NS.UI = function(t) {
    var e = function(t, e) {
        var i, n, s = !1;
        if (t && e) for (i = 0; i < t.length; i++) for (n = 0; n < e.length; n++) if (e[n] === t[i]) {
            s = !0, i = t.length;
            break;
        }
        return s;
    }, i = function(t) {
        this.title = t.title, this.roles = t.allowedRoles ? t.allowedRoles : [], t.url && (this.url = t.url), 
        t.handler && (this.handler = t.handler), t.actions && (this.actions = t.actions), 
        this.divider = Boolean(t.divider);
    };
    return i.prototype.isGroup = function() {
        return "actions" in this;
    }, i.prototype.isLink = function() {
        return "url" in this;
    }, i.prototype.isButton = function() {
        return "handler" in this;
    }, i.prototype.allowedFor = function(t) {
        return e(this.roles, t);
    }, t.NavBar = Backbone.View.extend({
        tagName: "header",
        events: {
        ...
        initialize: function(t) {
            this.tiles = t.tiles || [], this.username = t.username, this.roles = t.roles, this.context = t.context || "", 
            this.appName = t.title, this.enableSearchBox = "enableSearchBox" in t ? Boolean(t.enableSearchBox) : !0, 
            Backbone.View.prototype.initialize.apply(this, arguments), this.templates = {
                navbar: _.template(this.constructor.templates.navbar, null, {
                    variable: "data"
                }),
                userbox: _.template(this.constructor.templates.userbox, null, {
                    variable: "data"
                }),
                breadcrumbs: _.template(this.constructor.templates.breadcrumbs, null, {
                    variable: "data"
                }),
                tileItem: _.template(this.constructor.templates.tileItem, null, {
                    variable: "data"
                }),
                actionItem: _.template(this.constructor.templates.actionItem, null, {
                    variable: "data"
                }),
                actionHeader: _.template(this.constructor.templates.actionHeader, null, {
                    variable: "data"
                }),
                actionDivider: _.template(this.constructor.templates.actionDivider, null, {
                    variable: "data"
                }),
                actionGroup: _.template(this.constructor.templates.actionGroup, null, {
                    variable: "data"
                })
            };
        },
        ...
        render: function() {
            ...
            })), this.$actions = this.$el.find(".navbar-actions"), this.renderActions(), this.$breadcrumbs = this.$el.find(".navbar-context"), 
            this.renderBreadcrumbs(), this.$contextSwitcherTiles = this.$el.find(".navbar-tiles ul"), 
            this.$contextSwitcherWrapper = this.$el.find(".navbar-tiles .tile-wrapper"), this.renderContextSwitcher(), 
            this.$userbox = this.$el.find(".navbar-user"), this.renderUserDetails(), this.setupSearchBox();
        },
        renderActions: function() {
            this.$actions && (this.$actions.empty(), _.each(this.actions, function(t, i) {
                if (e(t.roles, this.roles)) {
                    var n, s = this.renderAction(t, i);
                    t.isGroup() && (s.addClass("dropdown"), s.find("a").attr("data-toggle", "dropdown").addClass("dropdown-toggle"), 
                    n = $(this.templates.actionGroup()), _.each(t.actions, function(t, i) {
                        e(t.roles, this.roles) && (t.isGroup() ? (n.append($(this.templates.actionHeader({
                            title: t.title
                        }))), _.each(t.actions, function(t, i) {
                            e(t.roles, this.roles) && n.append(this.renderAction(t, i));
                        }, this)) : n.append(this.renderAction(t, i)));
                    }, this), s.append(n)), this.$actions.append(s);
                }
            }, this));
        },
        renderAction: function(t, e) {
            if (t.divider) return $(this.templates.actionDivider());
            var i = {
                key: e,
                title: t.title
            };
            return t.isLink() && (i.url = t.url), $(this.templates.actionItem(i));
        },
        renderBreadcrumbs: function() {
            this.$breadcrumbs && this.$breadcrumbs.html(this.templates.breadcrumbs({
        ...
        renderContextSwitcher: function() {
            if (this.$contextSwitcherTiles) {
                ...
                for (var t, i = 0; i < this.tiles.length; i++) t = this.tiles[i], e(t.allowedRoles, this.roles) && this.$contextSwitcherTiles.append($(this.templates.tileItem({
                    title: t.title,
                    tileClass: t.tileClass + (this.context === t.title ? " active" : ""),
                    url: t.url
                })));
            }
        },
        renderUserDetails: function() {
            this.$userbox && this.$userbox.html(this.username ? this.templates.userbox({
        ...
        clickOnAction: function(t) {
            var e, i, n = $(t.target).data("key");
            n.indexOf(".") >= 0 ? (i = n.split("."), e = 3 === i.length ? this.actions[i[0]].actions[i[1]].actions[n] : this.actions[i[0]].actions[n]) : e = this.actions[n], 
            e.isButton() && (t.preventDefault(), e.handler());
        },
        clickOnContextSwitcher: function(t) {
            t.preventDefault(), t.stopPropagation(), this.showContextSwitcher();
        },
        hideContextSwitcher: function() {
            this.$contextSwitcherWrapper.hide(), this.$contextSwitcherTiles.hide();
        },
        showContextSwitcher: function() {
            this.$contextSwitcherWrapper.show(), this.$contextSwitcherTiles.slideDown(800);
        },
        clickOnTile: function(t) {
            t.stopPropagation(), this.hideContextSwitcher();
        },
        clickCancelNav: function(t) {
            t.stopPropagation(), t.preventDefault(), this.hideContextSwitcher();
        },
        onSearch: function(t) {
            t.preventDefault(), this.trigger("search", $(t.target).find(".search-query").val());
        },
        setRoles: function(t) {
            this.roles = t, this.renderActions(), this.renderContextSwitcher();
        },
        setUsername: function(t) {
            this.username = t, this.renderUserDetails();
        },
        setActions: function(t) {
            this.actions = t || {}, this.renderActions();
        },
        setContext: function(t) {
            this.context = t, this.renderBreadcrumbs(), this.renderContextSwitcher();
        }
    }, {
        Action: i,
        setupSearchBox: function() {},
...
}(NS.UI || {}), define("NS.UI.Navbar", [ "jquery", "backbone", "bootstrap" ], function(t) {
    return function() {
        var e;
        return e || t.$;
    };
}(this)), NS.UI.NavBar.className = "navbar navbar-default", NS.UI.NavBar.templates = {
    navbar: '<div class="container-fluid">    <div class="navbar-logo navbar-text navbar-left"></div>    <ul class="nav navbar-nav navbar-context"></ul>    <ul class="nav navbar-nav navbar-switcher"><li><a href="#" title="Go to..."></a></li></ul>    <ul class="nav navbar-nav navbar-actions"></ul>    <form class="navbar-form navbar-right" action="#"><% if (data.enableSearchBox) { %>        <div class="form-group"><input type="text" class="form-control" placeholder="Search..."></div>    <% } %></form>    <div class="navbar-text navbar-user navbar-right"></div></div><div class="navbar-tiles"><div class="tile-wrapper"><ul class="tiles"></ul></div></div>',
    userbox: '<span class="username"><%= data.username %></span>',
    breadcrumbs: '<li><a href="#"><%= data.appName %></a></li><li><div class="navbar-text"><%= data.context %></div></li>',
    tileItem: '<li class="tile <%= data.tileClass %>"><a href="<%= data.url %>"><i class="icon"></i><h2><%= data.title %></h2></a></li>',
    actionItem: '<li>    <a href="<% if (data.url) { %><%= data.url %><% } else { %>#<% } %>" data-key="<%= data.key %>">        <%= data.title %>    </a></li>',
    actionHeader: '<li class="nav-header"><%= data.title %></li>',
    actionDivider: '<li class="divider"></li>',
    actionGroup: '<ul class="dropdown-menu"></ul>'
}, define("NS.UI.NavbarTheme", [ "NS.UI.Navbar" ], function(t) {
    return function() {
        var e;
        return e || t.NS;
    };
}(this)), define("router", [ "jquery", "underscore", "backbone", "views/main/mainView", "views/editViews", "models/collection", "NS.UI.Navbar", "NS.UI.NavbarTheme" ], function(t, e, i, n, s, r) {
    var o = i.Router.extend({
        routes: {
            "": "home",
        ...
        initialize: function(e) {
            i18n.init({
                resGetPath: "ressources/locales/__lng__/__ns__.json",
                getAsync: !1
            }), window.location.hash = "#", this.formbuilderInstanceRef = e, this.formbuilderInstanceRef.currentCollection = new r({}, {
                name: "My protocol"
            }), this.formbuilderInstanceRef.mainView = new n({
                el: "#formBuilder",
                form: this.formbuilderInstanceRef.currentCollection,
                URLOptions: e.URLOptions
            ...
            this.formbuilderInstanceRef.navbar = new NS.UI.NavBar({
                roles: i.gaston.roles,
                username: i.gaston.nickname,
                title: "Form Builder"
            }), this.formbuilderInstanceRef.navbar.$el.prependTo("body"), this.formbuilderInstanceRef.navbar.render(), 
            t("body").i18n();
        },
        home: function() {
            this.formbuilderInstanceRef.navbar.setActions(this.formbuilderInstanceRef.mainView.getActions());
        },
        modelSetting: function(n) {
            require([ "backbone-forms", "backbone-forms-list", "modalAdapter" ], e.bind(function() {
                var s = this.formbuilderInstanceRef.currentCollection.models[n], r = new i.Form({
                    model: s
                }).render();
                t(".settings").append(r.el), t(".dropArea").switchClass("col-md-9", "col-md-7", 500), 
                t(".widgetsPanel").switchClass("col-md-3", "hide", 500), this.formbuilderInstanceRef.navbar.setActions({
                    save: new NS.UI.NavBar.Action({
                        title: "Save changes",
                        allowedRoles: [ "reader" ],
                        handler: e.bind(function() {
                            t(".dropArea").switchClass("col-md-7", "col-md-9", 500), t(".widgetsPanel").switchClass("hide", "col-md-3", 500), 
                            window.location.hash = "#", s.set(r.getValue()), r.remove();
                        }, this)
                    })
                });
            }, this));
        ...
        saveOnRepo: function() {
            require([ "views/modals/saveProtocol" ], e.bind(function(i) {
                var n = new i({
                    el: "#saveModal",
                ...
                n.render(), t("#saveModal").i18n(), t("#saveModal").on("hidden.bs.modal", e.bind(function() {
                    var e = n.getData();
                    e.content = this.formbuilderInstanceRef.currentCollection.getJSON(), t.ajax({
                        data: e,
                        type: "POST",
                        url: "/protocols",
                        contentType: "application/json",
                        success: function() {
                            t("#saveModal").modal("hide").removeData(), new NS.UI.Notification({
                                type: "success",
        ...
        "export": function() {
            require([ "views/modals/exportProtocol" ], e.bind(function(i) {
                var n = new i({
                    el: "#exportModal",
                    model: this.formbuilderInstanceRef.currentCollection
                });
                n.render(), t("#exportModal").i18n(), t("#exportModal").on("hidden.bs.modal", e.bind(function() {
                    var i = n.getData();
                    this.formbuilderInstanceRef.currentCollection.description = i.description, this.formbuilderInstanceRef.currentCollection.keywords = i.keywords, 
                    this.formbuilderInstanceRef.currentCollection.name = i.name, this.formbuilderInstanceRef.currentCollection.comments = i.comments, 
                    require([ "blobjs", "filesaver" ], e.bind(function() {
                        try {
                            if ("json" === i.mode) {
                                var e = this.formbuilderInstanceRef.currentCollection.getJSON(), n = (!!new Blob(), 
                                new Blob([ JSON.stringify(e, null, 2) ], {
                                    type: "application/json;charset=utf-8"
                                }));
                                saveAs(n, t("#exportProtocolFileName").val() + ".json");
                            } else if ("xml" === i.mode) {
                                var n = (!!new Blob(), new Blob([ this.formbuilderInstanceRef.currentCollection.getXML() ], {
                                    type: "application/xml;charset=utf-8"
                                }));
                                saveAs(n, t("#exportProtocolFileName").val() + ".xml");
                            }
                            t("#exportModal").modal("hide").removeData(), new NS.UI.Notification({
                                type: "success",
        ...
        clear: function() {
            this.formbuilderInstanceRef.mainView.clear(), window.location.hash = "#";
        },
        importJSON: function() {
            require([ "app/formbuilder" ], function(t) {
                t.mainView.importJSON();
            });
        },
        importXML: function() {
            require([ "app/formbuilder" ], function(t) {
                t.mainView.importXML();
            });
        },
        load: function() {
        ...
        show: function() {
            t("#compareModal").modal("show").on("click", "#findSource, #findUpdate", function() {
                t("#" + t(this).prop("id").replace("find", "").toLowerCase() + "Hide").trigger("click");
            }).on("change", 'input[type="file"]', function() {
                var e = t(this).prop("id").replace("Hide", ""), i = t(this).val().split("\\");
                t("#" + e).val(i[i.length - 1]);
            }).on("click", ".btn-primary", function() {
                t("#compareModal").modal("hide");
                var e = t("#compareModal").find("#sourceHide")[0].files[0], i = t("#compareModal").find("#updateHide")[0].files[0], n = e.name, s = i.name, r = null;
                null !== e && null !== i ? "text/xml" === e.type && "text/xml" === i.type ? (r = new FileReader(), 
                r.readAsText(e, "UTF-8"), r.onload = function(o) {
                    try {
                        formBuilder.XMLValidation(o.target.result) !== !0 ? new NS.UI.Notification({
                            title: result.error,
                            type: "error",
                            message: "Your XML don't matches with XML Schema"
                        }) : (e = o.target.result, r = new FileReader(), r.readAsText(i, "UTF-8"), r.onload = function(r) {
                            formBuilder.XMLValidation(r.target.result) === !0 && (i = r.target.result, t(".widgetsPanel").switchClass("span3", "span0", 250, function() {
                                t(".dropArea").append(formBuilder.GetXMLDiff(e, i, n, s)).switchClass("span9", "span12", 250).find(".diff").addClass("span11");
                                var r = {
                                    quit: new NS.UI.NavBar.Action({
                                        handler: function() {
                                            t(".widgetsPanel").switchClass("span0", "span3", 250, function() {
                                                t(".dropArea").switchClass("span2", "span9", 250).find("table").remove(), navbar.setActions(actions), 
                                                addIcon();
                                            });
                                        },
                                        allowedRoles: [ "reader" ],
    ...
    return o;
}), define("formbuilder", [ "backbone", "router" ], function(t, e) {
    var i = {
        initialize: function(i) {
            this.URLOptions = i, this.router = new e(this), t.history.start();
        }
    };
    return i;
}), define("text!views/../../templates/modals/exportProtocolJSON.html", [], function() {
    return '<div class="modal-dialog">\r\n    <div class="modal-content">\r\n\r\n        <div class="modal-header">\r\n            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>\r\n            <h3 data-i18n="modal.export.title">\r\n                Export protocol\r\n            </h3>\r\n        </div>\r\n\r\n        <div class="modal-body">\r\n            <div class="form-group">\r\n                <label data-i18n="protocol.name">\r\n                    Protocol name\r\n                </label>\r\n                <input type="text" id="exportProtocolName" class="form-control" data-provide="typeahead" />\r\n            </div>\r\n\r\n            <div class="form-group paddingTop5">\r\n                <label data-i18n="protocol.description">\r\n                    Protocol description\r\n                </label>\r\n                <textarea id="exportProtocolDescription" class="form-control"></textarea>\r\n            </div>\r\n\r\n            <div class="form-group paddingTop5">\r\n                <label data-i18n="protocol.keywords">\r\n                    Keywords <i>(Taped enter for validate)</i>\r\n                </label>\r\n                <input type="text" id="exportProtocolKeywords" class="form-control" data-provider="typeahead" />\r\n                <ul class="row-fluid" id="exportProtocolKeywordsList">\r\n                </ul>\r\n            </div>\r\n\r\n            <div class="form-group">\r\n                <label data-i18n="modal.filename">\r\n                    JSON file name\r\n                </label>\r\n                <input type="text" id="exportProtocolFileName" class="form-control" />\r\n            </div>\r\n\r\n            <input type="text" id="exportmode" class="hide" />\r\n        </di>\r\n        <div class="modal-footer paddingBottom10 paddingRight0">\r\n            <a href="#" class="btn btn-primary" data-i18n="modal.export.json">\r\n                Export protocol as JSON file\r\n            </a>\r\n            <a href="#" class="btn btn-info" data-i18n="modal.export.xml">\r\n                Export protocol as XML file\r\n            </a>\r\n        </div>\r\n\r\n    </div>\r\n</div>';
}), !function(t) {
    var e = function(e, i) {
        ...
        this.source = this.options.source, this.$menu = t(this.options.menu), this.shown = !1, 
    ...
    e.prototype = {
        ...
        lookup: function(e) {
            var i;
            return this.query = "undefined" != typeof e && null != e ? e : this.$element.val() || "", 
            this.query.length < this.options.minLength ? this.shown ? this.hide() : this : (i = t.isFunction(this.source) ? this.source(this.query, t.proxy(this.process, this)) : this.source, 
        ...
        focus: function() {
            console.log("focus"), this.focused || (this.focused = !0, (0 == this.options.minLength && !this.$element.val() || this.options.showHintOnFocus) && this.lookup());
        },
        blur: function() {
    ...
    t.fn.typeahead = function(i) {
        var n = arguments;
        return this.each(function() {
            var s = t(this), r = s.data("typeahead"), o = "object" == typeof i && i;
            r || s.data("typeahead", r = new e(this, o)), "string" == typeof i && (n.length > 1 ? r[i].apply(r, Array.prototype.slice.call(n, 1)) : r[i]());
        });
...
}(window.jQuery), define("typeahead", [ "jquery", "bootstrap" ], function(t) {
    return function() {
        var e;
        return e || t.$;
    };
}(this)), define("views/modals/exportProtocol", [ "underscore", "backbone", "text!../../../templates/modals/exportProtocolJSON.html", "bootstrap", "typeahead" ], function(_, Backbone, exportJSONTemplate) {
    var ExportJSONProtocolModalView = Backbone.View.extend({
        ...
        initialize: function(t) {
            this.template = _.template(exportJSONTemplate), _.bindAll(this, "render", "validateProtocolValue", "removeKeyword", "appendKeywordValue"), 
            this.keywordList = [], this.protocolAutocomplete = t.protocolAutocomplete, this.keywordAutocomplete = t.keywordAutocomplete;
        },
        render: function() {
            var t = this.template();
            return $(this.el).html(t), $(this.el).modal({
                show: !0
            }), $(this.el).find("#exportProtocolName").typeahead({
                source: _.bind(function(t, e) {
                    return $.getJSON(this.protocolAutocomplete, {
                        query: t
                    }, function(t) {
                        return e(t.options);
                    });
                ...
                source: _.bind(function(t, e) {
                    return $.getJSON(this.keywordAutocomplete, {
                        query: t
                    }, function(t) {
                        return e(t.options);
                    });
                }, this),
                updater: _.bind(function(t) {
                    this.appendKeywordValue(t);
                }, this)
            }), this;
        },
        validateProtocolValue: function(t) {
            13 === t.keyCode && this.appendKeywordValue($(t.target).val());
        },
        appendKeywordValue: function(t) {
            this.keywordList.indexOf(t) > -1 ? ($('li[data-value="' + t + '"]').css("background", "red"), 
            setTimeout(function() {
                $('li[data-value="' + t + '"]').css("background", "#0ac");
            }, 1500)) : ($(this.el).find("#exportProtocolKeywordsList").append('<li data-value="' + t + '" >' + t + '<button class="close">x</button></li>'), 
            this.keywordList.push(t), $("#exportProtocolKeywords").val(""));
        },
        removeKeyword: function(t) {
            this.keywordList.splice($(t.target).parent("li").index(), 1), $(t.target).parent("li").remove();
        },
        validateProtocolSave: function(e) {
            var exportProtocolName = "" === $("#exportProtocolName").val(), exportProtocolComment = "" === $("#exportProtocolFileName").val(), exportProtocolDescription = "" === $("#exportProtocolDescription").val(), exportProtocolKeywords = 0 === $("#exportProtocolKeywordsList").children("li").length;
            $("#exportProtocolDescription, #exportProtocolKeywords, #exportProtocolFileName, #exportProtocolName").each(function() {
                $(this)[eval($(this).prop("id")) === !0 ? "addClass" : "removeClass"]("error");
            }), exportProtocolName || exportProtocolDescription || exportProtocolKeywords || exportProtocolComment || ($("#exportmode").val($(e.target).data("i18n").indexOf("json") > 0 ? "json" : "xml"), 
